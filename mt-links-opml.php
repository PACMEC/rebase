 ...
 * another. Links aren't exported by the paCMec export, so this file handles
 * that.
 *
 * This file is not added by default to paCMec theme pages when outputting
...
foreach ( (array) $cats as $cat ) :
	/** This filter is documented in mt-includes/bookmark-template.php */
