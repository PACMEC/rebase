...
if ( ! current_user_can( 'install_themes' ) ) {
	mt_die( __( 'Sorry, you are not allowed to install themes on this site.' ) );
}

if ( is_multisite() && ! is_network_admin() ) {
	mt_redirect( network_admin_url( 'theme-install.php' ) );
	exit;
}
...
$help_overview =
	...
	'<p>' . sprintf(
		/* translators: %s: /mt-content/themes */
...
<div class="wrap">
	...
	<div class="mt-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on paCMec.org, you can browse them here.' ); ?></p>

			<p>
				<label for="mtorg-username-input"><?php _e( 'Your paCMec.org username:' ); ?></label>
				<input type="hidden" id="mtorg-username-nonce" name="_mtnonce" value="<?php echo esc_attr( mt_create_nonce( $action ) ); ?>" />
				<input type="search" id="mtorg-username-input" value="<?php echo esc_attr( $user ); ?>" />
	...
	<div class="theme-install-overlay mt-full-overlay expanded"></div>
...
<script id="tmpl-theme" type="text/template">
	...
	<# if ( ! data.compatible_mt || ! data.compatible_php ) { #>
