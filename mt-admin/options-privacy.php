...
if ( ! current_user_can( 'manage_privacy_options' ) ) {
	mt_die( __( 'Sorry, you are not allowed to manage privacy options on this site.' ) );
}
...
if ( ! empty( $action ) ) {
	...
	if ( 'set-privacy-page' === $action ) {
		...
		update_option( 'mt_page_for_privacy_policy', $privacy_policy_page_id );
		...
		if ( $privacy_policy_page_id ) {
			 ...
			 * - `MT_Customize_Nav_Menus::__construct()` checks the user's capabilities.
		...
		$privacy_policy_page_content = MT_Privacy_Policy_Content::get_default_content();
		$privacy_policy_page_id      = mt_insert_post(
			array(
		...
		if ( is_mt_error( $privacy_policy_page_id ) ) {
			add_settings_error(
			...
			mt_redirect( admin_url( 'post.php?post=' . $privacy_policy_page_id . '&action=edit' ) );
			exit;
		}
	}
}
...
if ( ! empty( $privacy_policy_page_id ) ) {
	...
	if ( ! $privacy_policy_page instanceof MT_Post ) {
		add_settings_error(
			'page_for_privacy_policy',
			'page_for_privacy_policy',
...
<div class="privacy-settings-body hide-if-no-js">
	...
	<table class="form-table tools-privacy-policy-page" role="presentation">
		<tr>
			...
			<td>
				<form class="mt-create-privacy-page" method="post" action="">
					<input type="hidden" name="action" value="create-privacy-page" />
					<?php
					mt_nonce_field( 'create-privacy-page' );
		...
		<tr>
			...
			<td>
				<form method="post" action="">
					...
					mt_nonce_field( 'set-privacy-page' );
