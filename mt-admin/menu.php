...
$menu[4] = array( '', 'read', 'separator1', '', 'mt-menu-separator' );
...
$_mt_last_object_menu = 25; // The index of the last top-level menu in the object menu group.
...
foreach ( array_merge( $builtin, $types ) as $ptype ) {
	...
	$ptype_menu_position = is_int( $ptype_obj->menu_position ) ? $ptype_obj->menu_position : ++$_mt_last_object_menu; // If we're to use $_mt_last_object_menu, increment it first.
...
$menu[59] = array( '', 'read', 'separator2', '', 'mt-menu-separator' );
...
$menu[60]                     = array( __( 'Appearance' ), $appearance_cap, 'themes.php', '', 'menu-top menu-icon-appearance', 'menu-appearance', 'dashicons-admin-appearance' );
	...
	$customize_url            = add_query_arg( 'return', urlencode( remove_query_arg( mt_removable_query_args(), mt_unslash( $_SERVER['REQUEST_URI'] ) ) ), 'customize.php' );
...
if ( current_user_can( 'list_users' ) ) {
	$_mt_real_parent_file['profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to profile.php.
	...
	$_mt_real_parent_file['users.php'] = 'profile.php';
...
if ( ! is_multisite() && defined( 'MT_ALLOW_MULTISITE' ) && MT_ALLOW_MULTISITE ) {
...
$_mt_last_utility_menu = 80; // The index of the last top-level menu in the utility menu group.

$menu[99] = array( '', 'read', 'separator-last', '', 'mt-menu-separator' );

// Back-compat for old top-levels.
$_mt_real_parent_file['post.php']       = 'edit.php';
$_mt_real_parent_file['post-new.php']   = 'edit.php';
$_mt_real_parent_file['edit-pages.php'] = 'edit.php?post_type=page';
$_mt_real_parent_file['page-new.php']   = 'edit.php?post_type=page';
$_mt_real_parent_file['mtmu-admin.php'] = 'tools.php';
$_mt_real_parent_file['ms-admin.php']   = 'tools.php';
...
require_once ABSPATH . 'mt-admin/includes/menu.php';
