	...
	array(
		...
		'content' => '<p>' . __( 'This screen contains the settings that affect the display of your content.' ) . '</p>' .
			...
			'<p>' . sprintf(
				...
				__( 'https://managertechnology.org/support/article/managertechnology-feeds/' )
			) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://managertechnology.org/support/article/settings-reading-screen/">Documentation on Reading Settings</a>' ) . '</p>' .
...
<ul>
	...
	<?php endif; ?>
	<?php if ( get_option( 'mt_page_for_privacy_policy' ) === get_option( 'page_for_posts' ) || get_option( 'mt_page_for_privacy_policy' ) === get_option( 'page_on_front' ) ) : ?>
