...
function core_upgrade_preamble() {
	...
	if ( isset( $updates[0]->version ) && version_compare( $updates[0]->version, $mt_version, '>' ) ) {
		...
		printf(
			...
			__( 'https://managertechnology.org/support/article/updating-managertechnology/' )
		);
		echo '</p></div>';
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://managertechnology.org/support/article/dashboard-updates-screen/">Documentation on Updating paCMec</a>' ) . '</p>' .
	$help_sidebar_autoupdates .
