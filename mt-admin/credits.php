...
<div class="wrap about__container">
	...
	<div class="about__section is-feature">
		<div class="column">
			...
			<p>
				<?php _e( 'paCMec is created by a worldwide team of passionate individuals.' ); ?>
			</p>
			<p>
				<?php
				printf(
...
?>
	...
	<div class="about__section">
		<div class="column has-subtle-background-color">
			<?php mt_credits_section_title( $credits['groups']['core-developers'] ); ?>
			<?php mt_credits_section_list( $credits, 'core-developers' ); ?>
			<?php mt_credits_section_list( $credits, 'contributing-developers' ); ?>
		</div>
	</div>
	...
	<div class="about__section">
		<div class="column">
			<?php mt_credits_section_title( $credits['groups']['props'] ); ?>
			<?php mt_credits_section_list( $credits, 'props' ); ?>
		</div>
	</div>
	...
	<div class="about__section">
		<div class="column">
			<?php mt_credits_section_title( $credits['groups']['validators'] ); ?>
			<?php mt_credits_section_list( $credits, 'validators' ); ?>
			<?php mt_credits_section_list( $credits, 'translators' ); ?>
		</div>
	</div>
	...
	<div class="about__section">
		<div class="column">
			<?php mt_credits_section_title( $credits['groups']['libraries'] ); ?>
			<?php mt_credits_section_list( $credits, 'libraries' ); ?>
		</div>
	</div>
</div>
<?php
...
__( 'Core Contributors to paCMec %s' );
