...
?>
	<div class="wrap about__container">
		...
		<div class="about__header">
			...
			<nav class="about__header-navigation nav-tab-wrapper mt-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu' ); ?>">
		...
		<div class="about__section is-feature">
			<h1 class="aligncenter">
				<?php
				printf(
					/* translators: %s: The current paCMec version number. */
					__( 'Welcome to paCMec %s.' ),
					$display_version
				);
				?>
			</h1>
			<p>
				...
				printf(
					/* translators: %s: The current paCMec version number. */
					__( 'paCMec %s brings you countless ways to set your ideas free and bring them to life. With a brand-new default theme as your canvas, it supports an ever-growing collection of blocks as your brushes. Paint with words. Pictures. Sound. Or rich embedded media.' ),
					$display_version
				);
				?>
			</p>
		...
		<div class="about__section has-3-columns has-gutters">
			<div class="column has-border" style="background-color:#eeeadd;background-color:var(--global--color-yellow)">
				...
				<p><?php _e( 'For years, only developers have been able to update paCMec automatically. But now, you have that option, right in your dashboard. If this is your first site, you have auto-updates ready to go, right now! Upgrading an existing site? No problem! Everything is the same as it was before.' ); ?></p>
			</div>
