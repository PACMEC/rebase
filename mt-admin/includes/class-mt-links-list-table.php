<?php
/**
 * List Table API: MT_Links_List_Table class
 *
 * @package paCMec
 ...
 * @see MT_List_Table
 */
class MT_Links_List_Table extends MT_List_Table {
	...
	public function prepare_items() {
		...
		mt_reset_vars( array( 'action', 'cat_id', 'link_id', 'orderby', 'order', 's' ) );
	...
	public function display_rows() {
		foreach ( $this->items as $link ) {
			...
			$link->link_category = mt_get_link_cats( $link->link_id );
			?>
