<?php
/**
 * paCMec Filesystem Class for implementing SSH2
 *
 ...
 *
 * Note: As of paCMec 2.8, this utilises the PHP5+ function `stream_get_contents()`.
 *
 * @since 2.7.0
 *
 * @package paCMec
 ...
 */
class MT_Filesystem_SSH2 extends MT_Filesystem_Base {
