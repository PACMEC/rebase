...
class Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		$_mt_nav_menu_max_depth = $depth > $_mt_nav_menu_max_depth ? $depth : $_mt_nav_menu_max_depth;
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-settings mt-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				 ...
				 */
				do_action( 'mt_nav_menu_item_custom_fields', $item_id, $item, $depth, $args, $id );
				?>
