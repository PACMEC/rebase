<?php
/**
 * List Table API: MT_Privacy_Data_Export_Requests_List_Table class
 *
 * @package paCMec
...
/**
 * MT_Privacy_Data_Export_Requests_Table class.
 *
 * @since 4.9.6
 */
class MT_Privacy_Data_Export_Requests_List_Table extends MT_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		$status          = $item->status;
		$request_id      = $item->ID;
		$nonce           = mt_create_nonce( 'mt-privacy-export-personal-data-' . $request_id );
