<?php
/**
 * paCMec Administration Meta Boxes API.
 *
 * @package paCMec
	...
	<div id="minor-publishing-actions">
		...
		if ( is_post_type_viewable( $post_type_object ) ) :
			...
			<div id="preview-action">
				...
				?>
				<a class="preview button" href="<?php echo $preview_link; ?>" target="mt-preview-<?php echo $post_id; ?>" id="post-preview"><?php echo $preview_button; ?></a>
				<input type="hidden" name="mt-preview" id="mt-preview" value="" />
			</div>
			<?php
		endif;
		 ...
		 * @since 4.4.0
		 *
		 * @param MT_Post $post MT_Post object for the current post.
		 */
...
<div id="major-publishing-actions">
	 ...
	 *
	 * @param MT_Post|null $post MT_Post object for the current post on Edit Post screen,
...
<div class="tagsdiv" id="<?php echo $tax_name; ?>">
	...
	<div class="ajaxtag hide-if-no-js">
		...
		<input data-mt-taxonomy="<?php echo $tax_name; ?>" type="text" id="new-tag-<?php echo $tax_name; ?>" name="newtag[<?php echo $tax_name; ?>]" class="newtag form-input-tip" size="16" autocomplete="off" aria-describedby="new-tag-<?php echo $tax_name; ?>-desc" value="" />
...
function post_categories_meta_box( $post, $box ) {
	...
	<div id="taxonomy-<?php echo $tax_name; ?>" class="categorydiv">
		...
		<div id="<?php echo $tax_name; ?>-pop" class="tabs-panel" style="display: none;">
			<ul id="<?php echo $tax_name; ?>checklist-pop" class="categorychecklist form-no-clear" >
				<?php $popular_ids = mt_popular_terms_checklist( $tax_name ); ?>
			</ul>
		</div>
		...
		<div id="<?php echo $tax_name; ?>-all" class="tabs-panel">
			...
			?>
			<ul id="<?php echo $tax_name; ?>checklist" data-mt-lists="list:<?php echo $tax_name; ?>" class="categorychecklist form-no-clear">
				<?php
				mt_terms_checklist(
					$post->ID,
					array(
	...
	<?php if ( current_user_can( $taxonomy->cap->edit_terms ) ) : ?>
			<div id="<?php echo $tax_name; ?>-adder" class="mt-hidden-children">
				...
				<p id="<?php echo $tax_name; ?>-add" class="category-add mt-hidden-child">
					...
					mt_dropdown_categories( $parent_dropdown_args );
					?>
					<input type="button" id="<?php echo $tax_name; ?>-add-submit" data-mt-lists="add:<?php echo $tax_name; ?>checklist:<?php echo $tax_name; ?>-add" class="button category-add-submit" value="<?php echo esc_attr( $taxonomy->labels->add_new_item ); ?>" />
					<?php mt_nonce_field( 'add-' . $tax_name, '_ajax_nonce-add-' . $tax_name, false ); ?>
...
<p class="meta-options">
	 ...
	 * @since 3.1.0
	 *
	 * @param MT_Post $post MT_Post object of the current post.
	 */
	do_action( 'post_comment_status_meta_box-options', $post ); // phpcs:ignore paCMec.NamingConventions.ValidHookName.UseUnderscores
	?>
</p>
	<?php
}
...
function post_comment_meta_box( $post ) {
	mt_nonce_field( 'get-comments', 'add_comment_nonce', false );
	?>
...
function page_attributes_meta_box( $post ) {
	if ( is_post_type_hierarchical( $post->post_type ) ) :
		 ...
		 * @since 3.3.0
		 *
		 * @see mt_dropdown_pages()
		 *
		 * @param array   $dropdown_args Array of arguments used to generate the pages drop-down.
		 * @param MT_Post $post          The current post.
		 */
		$dropdown_args = apply_filters( 'page_attributes_dropdown_pages_args', $dropdown_args, $post );
		$pages         = mt_dropdown_pages( $dropdown_args );
		if ( ! empty( $pages ) ) :
			?>
...
<div id="delete-action">
	...
	if ( ! empty( $_GET['action'] ) && 'edit' === $_GET['action'] && current_user_can( 'manage_links' ) ) {
		printf(
			...
			mt_nonce_url( "link.php?action=delete&amp;link_id=$link->link_id", 'delete-bookmark_' . $link->link_id ),
...
<div id="taxonomy-linkcategory" class="categorydiv">
	...
	<div id="categories-all" class="tabs-panel">
		<ul id="categorychecklist" data-mt-lists="list:category" class="categorychecklist form-no-clear">
			<?php
			if ( isset( $link->link_id ) ) {
				mt_link_category_checklist( $link->link_id );
			} else {
				mt_link_category_checklist();
			}
			?>
		</ul>
	</div>
	...
	<div id="categories-pop" class="tabs-panel" style="display: none;">
		<ul id="categorychecklist-pop" class="categorychecklist form-no-clear">
			<?php mt_popular_terms_checklist( 'link_category' ); ?>
		</ul>
	</div>

	<div id="category-adder" class="mt-hidden-children">
		<a id="category-add-toggle" href="#category-add" class="taxonomy-add-new"><?php _e( '+ Add New Category' ); ?></a>
		<p id="link-category-add" class="mt-hidden-child">
			<label class="screen-reader-text" for="newcat"><?php _e( '+ Add New Category' ); ?></label>
			<input type="text" name="newcat" id="newcat" class="form-required form-input-tip" value="<?php esc_attr_e( 'New category name' ); ?>" aria-required="true" />
			<input type="button" id="link-category-add-submit" data-mt-lists="add:categorychecklist:link-category-add" class="button" value="<?php esc_attr_e( 'Add' ); ?>" />
			<?php mt_nonce_field( 'add-link-category', '_ajax_nonce', false ); ?>
...
function post_thumbnail_meta_box( $post ) {
	...
	echo _mt_post_thumbnail_html( $thumbnail_id, $post->ID );
}
 ...
 * @since 5.0.0
 *
 * @param MT_Post $post The post object that these meta boxes are being generated for.
 */
function register_and_do_post_meta_boxes( $post ) {
	 ...
	 * @param MT_Post|object|string $post      Post object on Edit Post screen, link object on Edit Link screen,
