<?php
/**
 * List Table API: MT_Privacy_Data_Removal_Requests_List_Table class
 *
 * @package paCMec
...
if ( ! class_exists( 'MT_Privacy_Requests_Table' ) ) {
	require_once ABSPATH . 'mt-admin/includes/class-mt-privacy-requests-table.php';
}

/**
 * MT_Privacy_Data_Removal_Requests_List_Table class.
 *
 * @since 4.9.6
 */
class MT_Privacy_Data_Removal_Requests_List_Table extends MT_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		if ( 'request-confirmed' !== $status ) {
			...
			$nonce         = mt_create_nonce( 'mt-privacy-erase-personal-data-' . $request_id );
