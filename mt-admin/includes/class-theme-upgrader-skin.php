...
/**
 * Theme Upgrader Skin for paCMec Theme Upgrades.
 *
 * @since 2.8.0
 ...
 */
class Theme_Upgrader_Skin extends MT_Upgrader_Skin {
	...
	public function after() {
		...
		if ( $theme_info ) {
			...
			if ( ! $this->result || is_mt_error( $this->result ) || is_network_admin() ) {
