...
if ( 'category' === $taxonomy ) {
	 ...
	 *
	 * @param MT_Term $tag Current category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {@see '{$taxonomy}_pre_edit_form'} instead.
	 *
	 * @param MT_Term $tag Current link category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {@see '{$taxonomy}_pre_edit_form'} instead.
	 *
	 * @param MT_Term $tag Current tag term object.
	 */
...
$mt_http_referer = remove_query_arg( array( 'action', 'message', 'tag_ID' ), $mt_http_referer );
 ...
 * @since 3.0.0
 *
 * @param MT_Term $tag      Current taxonomy term object.
...
<div id="message" class="notice notice-<?php echo $class; ?>">
	...
	<p><a href="<?php echo esc_url( mt_validate_redirect( esc_url_raw( $mt_http_referer ), admin_url( 'term.php?taxonomy=' . $taxonomy ) ) ); ?>">
...
mt_nonce_field( 'update-tag_' . $tag_ID );
...
<?php if ( ! global_terms_enabled() ) { ?>
		<tr class="form-field term-slug-wrap">
			 ...
			 * @param MT_Term|MT_Post $tag  Term or post object.
			 */
...
<?php if ( is_taxonomy_hierarchical( $taxonomy ) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in mt-admin/edit-tags.php */
...
// Back compat hooks.
if ( 'category' === $taxonomy ) {
	/** This action is documented in mt-admin/edit-tags.php */
...
<div class="edit-tag-actions">
	...
	<?php if ( current_user_can( 'delete_term', $tag->term_id ) ) : ?>
		<span id="delete-link">
			<a class="delete" href="<?php echo admin_url( mt_nonce_url( "edit-tags.php?action=delete&taxonomy=$taxonomy&tag_ID=$tag->term_id", 'delete-tag_' . $tag->term_id ) ); ?>"><?php _e( 'Delete' ); ?></a>
		</span>
	<?php endif; ?>
