...
if ( ! is_multisite() && ( get_option( 'upload_url_path' ) || ( get_option( 'upload_path' ) != 'mt-content/uploads' && get_option( 'upload_path' ) ) ) ) {
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://managertechnology.com.co/pacmec/support/article/settings-media-screen/">Documentation on Media Settings</a>' ) . '</p>' .
...
<?php
/**
 * @global array $mt_settings
 */
if ( isset( $GLOBALS['mt_settings']['media']['embeds'] ) ) :
	?>
...
<p class="description">
		<?php
		/* translators: %s: mt-content/uploads */
		printf( __( 'Default is %s' ), '<code>mt-content/uploads</code>' );
		?>
</p>
</td>
</tr>
