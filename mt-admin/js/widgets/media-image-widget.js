/**
 * @output mt-admin/js/widgets/media-image-widget.js
 */
...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See MT_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @class    mt.mediaWidgets.modelConstructors.media_image
	 ...
	 */
	ImageWidgetControl = component.MediaWidgetControl.extend(/** @lends mt.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = mt.template( 'mt-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = mt.template( 'mt-media-widget-image-fields' );
