/**
 * @output mt-admin/js/widgets/custom-html-widgets.js
 */
...
/**
 * @namespace mt.customHtmlWidget
 * @memberOf mt
 */
mt.customHtmlWidgets = ( function( $ ) {
	'use strict';
	...
	component.CustomHtmlWidgetControl = Backbone.View.extend(/** @lends mt.customHtmlWidgets.CustomHtmlWidgetControl.prototype */{
		 ...
		 * Text widget control.
		 *
		 * @constructs mt.customHtmlWidgets.CustomHtmlWidgetControl
		...
		initialize: function initialize( options ) {
			...
			control.$el.html( mt.template( 'widget-custom-html-control-fields' )( { codeEditorDisabled: component.codeEditorSettings.disabled } ) );
		...
		updateErrorNotice: function( errorAnnotations ) {
			...
			if ( mt.customize && mt.customize.has( control.customizeSettingId ) ) {
				customizeSetting = mt.customize( control.customizeSettingId );
				customizeSetting.notifications.remove( 'htmlhint_error' );
				if ( 0 !== errorAnnotations.length ) {
					customizeSetting.notifications.add( 'htmlhint_error', new mt.customize.Notification( 'htmlhint_error', {
						message: message,
						type: 'error'
					} ) );
				}
		...
		initializeEditor: function initializeEditor() {
			...
			control.editor = mt.codeEditor.initialize( control.fields.content, settings );
	 ...
	 *
	 * @alias mt.customHtmlWidgets.widgetControls
	 *
	 * @type {Object.<string, mt.textWidgets.CustomHtmlWidgetControl>}
	 */
	 ...
	 *
	 * @alias mt.customHtmlWidgets.handleWidgetAdded
	 *
	 ...
	 *
	 * @alias mt.customHtmlWidgets.setupAccessibleMode
	 *
	 * @return {void}
	 */
	 ...
	 *
	 * @alias mt.customHtmlWidgets.handleWidgetUpdated
	 *
	 * @param {jQuery.Event} event - Event.
	 * @param {jQuery}       widgetContainer - Widget container element.
	 * @return {void}
	 ...
	 *
	 * @alias mt.customHtmlWidgets.init
	 *
