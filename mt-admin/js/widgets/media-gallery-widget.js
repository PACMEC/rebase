/**
 * @output mt-admin/js/widgets/media-gallery-widget.js
 */
...
(function( component ) {
	 ...
	 *
	 * @since 4.9.0
	 * @class    mt.mediaWidgets~GalleryDetailsMediaFrame
	 * @augments mt.media.view.MediaFrame.Post
	 */
	GalleryDetailsMediaFrame = mt.media.view.MediaFrame.Post.extend(/** @lends mt.mediaWidgets~GalleryDetailsMediaFrame.prototype */{
	 ...
	 *
	 * See MT_Widget_Gallery::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @since 4.9.0
	 *
	 * @class    mt.mediaWidgets.modelConstructors.media_gallery
	 * @augments mt.mediaWidgets.MediaWidgetModel
	 */
	GalleryWidgetModel = component.MediaWidgetModel.extend(/** @lends mt.mediaWidgets.modelConstructors.media_gallery.prototype */{} );

	GalleryWidgetControl = component.MediaWidgetControl.extend(/** @lends mt.mediaWidgets.controlConstructors.media_gallery.prototype */{
		 ...
		 * See MT_Widget_Gallery::enqueue_admin_scripts() for amending prototype from PHP exports.
		 *
		 * @constructs mt.mediaWidgets.controlConstructors.media_gallery
		 * @augments   mt.mediaWidgets.MediaWidgetControl
		 *
		 * @since 4.9.0
		...
		initialize: function initialize( options ) {
			...
			control.selectedAttachments = new mt.media.model.Attachments();
			 ...
			 */
			if ( mt.customize && mt.customize.previewer ) {
				control.selectedAttachments.on( 'change', function() {
					mt.customize.previewer.send( 'refresh-widget-partial', control.model.get( 'widget_id' ) );
				} );
			}
		},
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = mt.template( 'mt-media-widget-gallery-preview' );
		...
		editMedia: function editMedia() {
			...
			selection = new mt.media.model.Selection( control.selectedAttachments.models, {
				multiple: true
			});
		 ...
		 *
		 * @since 4.9.0
		 * @param {mt.media.models.Attachment} attachment - Attachment.
		 * @return {void}
		 */
