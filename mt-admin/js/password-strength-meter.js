/**
 * @output mt-admin/js/password-strength-meter.js
 */
...
(function($){
		...
		userInputBlacklist : function() {
			window.console.log(
				sprintf(
					...
					'mt.passwordStrength.userInputBlacklist()',
					'5.5.0',
					'mt.passwordStrength.userInputDisallowedList()'
				)
			);

			return mt.passwordStrength.userInputDisallowedList();
		},
	 ...
	 *
	 * @since 2.5.0
	 * @deprecated 3.7.0 Use mt.passwordStrength.meter instead.
	 *
	 * @global
	 *
	 * @type {mt.passwordStrength.meter}
	 */
	window.passwordStrength = mt.passwordStrength.meter;
})(jQuery);
