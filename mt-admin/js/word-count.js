 ...
 *
 * @since 2.6.0
 * @output mt-admin/js/word-count.js
 */
...
( function() {
	 ...
	 *
	 * @namespace mt.utils.wordcounter
	 * @memberof  mt.utils
	 *
	 * @class
	 *
	...
	// Add the WordCounter to the MT Utils.
	window.mt = window.mt || {};
	window.mt.utils = window.mt.utils || {};
	window.mt.utils.WordCounter = WordCounter;
} )();
