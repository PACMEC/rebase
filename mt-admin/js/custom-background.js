/**
 * @output mt-admin/js/custom-background.js
 */
...
(function($) {
	$(document).ready(function() {
		...
		/**
		 * Instantiates the paCMec color picker and binds the change and clear events.
		 *
		 * @since 3.5.0
		 *
		 * @return {void}
		 */
		$('#background-color').mtColorPicker({
		...
		/**
		 * Binds the event for opening the MT Media dialog.
		 *
		 * @since 3.5.0
		 *
		 * @return {void}
		...
		$('#choose-from-library-link').click( function( event ) {
			...
			frame = mt.media.frames.customBackground = mt.media({
