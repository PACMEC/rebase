 ...
 * https://developer.managertechnology.com.co/pacmec/themes/basics/the-loop/ to understand it and
 * https://developer.managertechnology.com.co/pacmec/themes/basics/template-tags/ to understand
 * the tags used in it.
 *
...
if ( have_posts() ) {
	while ( have_posts() ) :
		...
		if ( mt_attachment_is_image() ) :
			...
			?>
						<p class="attachment"><a href="<?php echo esc_url( $next_attachment_url ); ?>" title="<?php the_title_attribute(); ?>" rel="attachment">
							...
							echo mt_get_attachment_image( $post->ID, array( $attachment_width, $attachment_height ) );
							?>
							</a></p>
		...
		<?php else : ?>
						<a href="<?php echo esc_url( mt_get_attachment_url() ); ?>" title="<?php the_title_attribute(); ?>" rel="attachment"><?php echo esc_html( mt_basename( get_permalink() ) ); ?></a>
	<?php endif; ?>
