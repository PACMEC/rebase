 ...
 * @uses twentytwelve_admin_header_style() to style mt-admin form.
 * @uses twentytwelve_admin_header_image() to add custom markup to mt-admin form.
 *
 * @since Twenty Twelve 1.0
 */
function twentytwelve_custom_header_setup() {
	$args = array(
		...
		'mt-head-callback'       => 'twentytwelve_header_style',
