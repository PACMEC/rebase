			...
			'front' => array(
				...
				'post_content' => implode(
					...
					array(
						...
						'<div class="mt-block-button is-style-outline"><a class="mt-block-button__link" href="https://make.managertechnology.com.co/pacmec/core/2019/09/27/block-editor-theme-related-updates-in-managertechnology-5-3/">' . __( 'Read More', 'twentytwenty' ) . '</a></div>',
						'<!-- /mt:button --></div></div>',
						'<!-- /mt:group -->',
						'<!-- mt:group -->',
						'<div class="mt-block-group"><div class="mt-block-group__inner-container">',
						...
						'<div class="mt-block-button aligncenter"><a class="mt-block-button__link" href="https://make.managertechnology.com.co/pacmec/core/2019/09/27/block-editor-theme-related-updates-in-managertechnology-5-3/">' . __( 'Join the Club', 'twentytwenty' ) . '</a></div>',
						'<!-- /mt:button --></div></div>',
						'<!-- /mt:group --></div></div>',
						'<!-- /mt:group -->',
