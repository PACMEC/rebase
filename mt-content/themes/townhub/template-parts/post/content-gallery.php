        ...
        foreach ( (array) $slider_images as $img_id => $img_url ) {
            ...
            <div class="cthiso-item">
                <div class="grid-item-holder">
                    <?php echo mt_get_attachment_image( $img_id, 'townhub-folio-one'); ?>
                    <a href="<?php echo esc_url( mt_get_attachment_url( $img_id ) );?>" class="popup-image slider-zoom"><i class="fal fa-search"></i></a>
                </div>
            </div>
        <?php
        }
