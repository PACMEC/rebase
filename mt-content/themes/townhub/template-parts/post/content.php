                    ...
                    <div class="swiper-wrapper lightgallery">
		                ...
		                foreach ( (array) $slider_images as $img_id => $img_url ) {
					        echo '<div class="swiper-slide hov_zoom">';
					        	echo mt_get_attachment_image($img_id, 'townhub-featured-image','',array('class'=>'respimg no-lazy') );
					        	echo '<a href="' . esc_url( mt_get_attachment_url( $img_id ) ) . '" class="box-media-zoom popup-image"><i class="fal fa-search"></i></a>';
					        echo '</div>';
					    }
						?>
                    </div>
