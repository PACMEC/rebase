 ...
 *
 * @link https://codex.pacmec.org/Template_Hierarchy
 *
 */
...
<div class="list-single-main-item fl-wrap block_box" id="post-comments">
	...
	<div class="comments-nav">
		<ul class="pager clearfix">
			<li class="previous"><?php previous_comments_link( mt_kses(__( '<i class="fa fa-angle-left"></i> Previous Comments', 'townhub' ), array('i'=>array('class'=>array())) ) ); ?></li>
			<li class="next"><?php next_comments_link( mt_kses(__( 'Next Comments <i class="fa fa-angle-right"></i>', 'townhub' ), array('i'=>array('class'=>array())) ) ); ?></li>
		</ul>
	</div>
...
<div class="list-single-main-item fl-wrap block_box" id="post-respond">
    <div id="add-review" class="add-review-box">
        <?php
			...
			'must_log_in'=> '<p class="not-empty">' . __( 'You must be <a class="comment-log-popup logreg-modal-open" href="#">logged in</a> to post a comment.' ,'townhub') /*  sprintf( mt_kses(__( 'You must be <a href="%s">logged in</a> to post a comment.' ,'townhub'),array('a'=>array('href'=>array(),'title'=>array(),'target'=>array())) ), mt_login_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) */ . '</p>',
			'logged_in_as' => '<p class="not-empty">' . sprintf( mt_kses(__( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>','townhub' ),array('a'=>array('href'=>array(),'title'=>array(),'target'=>array())) ), ( method_exists('Esb_Class_Dashboard', 'screen_url') ? Esb_Class_Dashboard::screen_url() : admin_url( 'profile.php' ) ), $user_identity, mt_logout_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) . '</p>',
