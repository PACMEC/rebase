...
class Admin
{
    ...
    public function init_actions() {
        ...
        add_action( 'mt_ajax_cththemes_dismiss_notice', array( $this, 'dismiss_notice' ) );
    ...
    public function notices(){
        ...
        <div data-notice="<?php echo esc_attr( $type ); ?>" class="cththemes-notice notice notice-warning is-dismissible">
            <h3><?php esc_html_e( 'TownHub - Directory & Listing Pacmec Theme', 'townhub' ); ?></h3>
            <p><?php esc_html_e( 'From version 2.1.0 we provide new update system which allow you update our theme and its add-ons plugin directly from Pacmec Themes/Plugins screen.', 'townhub' ); ?></p>
        ...
        <div data-notice="mobile-app" class="cththemes-notice notice notice-info is-dismissible">
            ...
            <p><?php echo 'CTH Directory is mobile app built with React Native for TownHub directory & listing Pacmec theme. It helps you create your own iOS and Android applications easily and save time.'; ?></p>
            <p><?php echo 'It will connect to your website through the Pacmec REST API. Help customers browse website and search listings more smoothly and intuitively. It also helps customers to place and manage orders more easily.'; ?></p>
