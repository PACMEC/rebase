...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => esc_html__( 'Pixel number. Which we are telling the browser is to move Portfolio Content down every time we scroll down 100% of the viemtort height and move Portfolio Content up every time we scroll up 100% of the viemtort height. Ex: 200  or -200 for reverse direction.', 'townhub' ),
            'default'  => '200',
        ),
        array(
