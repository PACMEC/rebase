...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => esc_html__( 'Pixel number. Which we are telling the browser is to move Member Photo down every time we scroll down 100% of the viemtort height and move Member Photo up every time we scroll up 100% of the viemtort height. Ex: 150  or -150 for reverse direction.', 'townhub' ),
            'default'  => '150',
        ),
