...
if (!class_exists('ReduxFramework_cthimage')) {
    class ReduxFramework_cthimage
    {
        ...
        public function render()
        {
            ...
            $this->value = mt_parse_args( $this->value, $defaults );
        ...
        {
            mt_enqueue_media();
            mt_enqueue_script('cth-redux-fields', get_template_directory_uri() . '/includes/redux_add_fields/cth-redux-fields.js', array('jquery'), null, true);

            mt_enqueue_style('redux-add-fields', get_template_directory_uri() . '/includes/redux_add_fields/redux-add-fields.css');
