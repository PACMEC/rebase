...
/**
 * Sets up the paCMec core custom header and custom background features.
 *
 * @since Twenty Sixteen 1.0
 *
...
function twentysixteen_custom_header_and_background() {
	...
	add_theme_support(
		 ...
		 *     @type callable $mt-head-callback   Callback function used to style the header image and text
		...
		apply_filters(
			...
			array(
				...
				'height'             => 280,
				'flex-height'        => true,
				'mt-head-callback'   => 'twentysixteen_header_style',
			)
		)
	);
}
 ...
 * @since Twenty Sixteen 1.0
 *
 * @param MT_Customize_Manager $mt_customize The Customizer object.
 */
function twentysixteen_customize_register( $mt_customize ) {
	$color_scheme = twentysixteen_get_color_scheme();
	...
	$mt_customize->remove_control( 'header_textcolor' );
...
function twentysixteen_color_scheme_css() {
	...
	mt_add_inline_style( 'twentysixteen-style', $color_scheme_css );
}
add_action( 'mt_enqueue_scripts', 'twentysixteen_color_scheme_css' );
...
function twentysixteen_customize_control_js() {
	mt_enqueue_script( 'color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', array( 'customize-controls', 'iris', 'underscore', 'mt-util' ), '20170530', true );
	mt_localize_script( 'color-scheme-control', 'colorScheme', twentysixteen_get_color_schemes() );
}
...
function twentysixteen_customize_preview_js() {
	mt_enqueue_script( 'twentysixteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20170530', true );
}
...
function twentysixteen_page_background_color_css() {
	...
	mt_add_inline_style( 'twentysixteen-style', sprintf( $css, $page_background_color ) );
}
add_action( 'mt_enqueue_scripts', 'twentysixteen_page_background_color_css', 11 );
...
function twentysixteen_link_color_css() {
	...
	mt_add_inline_style( 'twentysixteen-style', sprintf( $css, $link_color ) );
}
add_action( 'mt_enqueue_scripts', 'twentysixteen_link_color_css', 11 );
...
function twentysixteen_main_text_color_css() {
	...
	mt_add_inline_style( 'twentysixteen-style', sprintf( $css, $main_text_color, $border_color ) );
}
add_action( 'mt_enqueue_scripts', 'twentysixteen_main_text_color_css', 11 );
...
function twentysixteen_secondary_text_color_css() {
	...
	mt_add_inline_style( 'twentysixteen-style', sprintf( $css, $secondary_text_color ) );
}
add_action( 'mt_enqueue_scripts', 'twentysixteen_secondary_text_color_css', 11 );
