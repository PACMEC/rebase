	...
	add_theme_support(
		...
		apply_filters(
			...
			array(
				...
				'width'              => 954,
				'height'             => 1300,
				'mt-head-callback'   => 'twentyfifteen_header_style',
			)
		)
	);
}
...
if ( ! function_exists( 'twentyfifteen_header_style' ) ) :
	...
	function twentyfifteen_header_style() {
		...
		.site-header {
			 ...
			 * @see https://core.trac.managertechnology.com.co/pacmec/ticket/31460
			 */
...
function twentyfifteen_header_background_color_css() {
	...
	mt_add_inline_style( 'twentyfifteen-style', sprintf( $css, $header_background_color ) );
}
add_action( 'mt_enqueue_scripts', 'twentyfifteen_header_background_color_css', 11 );
...
function twentyfifteen_sidebar_text_color_css() {
	...
	mt_add_inline_style( 'twentyfifteen-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'mt_enqueue_scripts', 'twentyfifteen_sidebar_text_color_css', 11 );
