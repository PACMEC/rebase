 ...
 */
function twentyfifteen_customize_register( $mt_customize ) {
	...
	$mt_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'twentyfifteen' );
}
...
function twentyfifteen_color_scheme_css() {
	...
	mt_add_inline_style( 'twentyfifteen-style', $color_scheme_css );
}
add_action( 'mt_enqueue_scripts', 'twentyfifteen_color_scheme_css' );
...
function twentyfifteen_customize_control_js() {
	mt_enqueue_script( 'color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', array( 'customize-controls', 'iris', 'underscore', 'mt-util' ), '20141216', true );
	mt_localize_script( 'color-scheme-control', 'colorScheme', twentyfifteen_get_color_schemes() );
}
...
function twentyfifteen_customize_preview_js() {
	mt_enqueue_script( 'twentyfifteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
