...
( function( api ) {
	var cssTemplate = mt.template( 'twentyfifteen-color-scheme' ),
		colorSchemeKeys = [
			'background_color',
			...
			if ( 'color_scheme' === this.id ) {
				this.setting.bind( 'change', function( value ) {
					...
					api.control( 'background_color' ).container.find( '.color-picker-hex' )
						...
						.mtColorPicker( 'defaultColor', colorScheme[value].colors[0] );
					...
					api.control( 'header_background_color' ).container.find( '.color-picker-hex' )
						...
						.mtColorPicker( 'defaultColor', colorScheme[value].colors[1] );
					...
					api.control( 'sidebar_textcolor' ).container.find( '.color-picker-hex' )
						...
						.mtColorPicker( 'defaultColor', colorScheme[value].colors[4] );
				} );
			}
		}
	} );
