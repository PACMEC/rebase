...
(function( $ ) {
	...
	mt.customize.bind( 'preview-ready', function() {

		// Initially hide the theme option placeholders on load.
		$( '.panel-placeholder' ).hide();

		mt.customize.preview.bind( 'section-highlight', function( data ) {
	...
	// Color scheme.
	mt.customize( 'colorscheme', function( value ) {
		value.bind( function( to ) {
	...
	// Custom color hue.
	mt.customize( 'colorscheme_hue', function( value ) {
		value.bind( function( to ) {
	...
	// Page layouts.
	mt.customize( 'page_layout', function( value ) {
		value.bind( function( to ) {
			if ( 'one-column' === to ) {
	...
	function hasHeaderImage() {
		var image = mt.customize( 'header_image' )();
		return '' !== image && 'remove-header' !== image;
	}

	// Whether a header video is available.
	function hasHeaderVideo() {
		var externalVideo = mt.customize( 'external_header_video' )(),
			video = mt.customize( 'header_video' )();
	...
	$.each( [ 'external_header_video', 'header_image', 'header_video' ], function( index, settingId ) {
		mt.customize( settingId, function( setting ) {
