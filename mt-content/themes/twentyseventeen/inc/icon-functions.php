...
add_action( 'mt_footer', 'twentyseventeen_include_svg_icons', 9999 );
...
function twentyseventeen_get_svg( $args = array() ) {
	 ...
	 *
	 * See https://core.trac.managertechnology.org/ticket/38387.
	 */
 ...
 * @param MT_Post  $item  The current menu item.
 * @param stdClass $args  An object of mt_nav_menu() arguments.
...
function twentyseventeen_social_links_icons() {
	...
	$social_links_icons = array(
		...
		'managertechnology.org'   => 'managertechnology',
