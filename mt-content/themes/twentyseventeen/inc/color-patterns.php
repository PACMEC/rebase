...
.colors-custom .site-content .mt-playlist-light .mt-playlist-current-item .mt-playlist-item-album {
...
.colors-custom .site-content .mt-playlist-light .mt-playlist-current-item .mt-playlist-item-artist {
...
.colors-custom .site-content .mt-playlist-light .mt-playlist-item:hover,
.colors-custom .site-content .mt-playlist-light .mt-playlist-item:focus {
...
.colors-custom .mt_widget_tag_cloud a:hover,
.colors-custom .mt_widget_tag_cloud a:focus {
...
.colors-custom .mt_widget_tag_cloud a {
...
.colors-custom .site-content .mt-playlist-light .mt-playlist-item,
.colors-custom tr {
	border-bottom-color: hsl( ' . $hue . ', ' . $saturation . ', 93% ); /* base: #eee; */
}

.colors-custom .site-content .mt-playlist-light {
...
.colors-custom .entry-footer .edit-link a.post-edit-link,
.colors-custom .social-navigation a,
.colors-custom .site-content .mt-playlist-light a.mt-playlist-caption:hover,
.colors-custom .site-content .mt-playlist-light .mt-playlist-item:hover a,
.colors-custom .site-content .mt-playlist-light .mt-playlist-item:focus a,
.colors-custom .site-content .mt-playlist-light .mt-playlist-item:hover,
.colors-custom .site-content .mt-playlist-light .mt-playlist-item:focus,
.colors-custom .prev.page-numbers:focus,
.colors-custom .prev.page-numbers:hover,
