...
( function( $ ) {
	...
	$.featuredslider = function( el, options ) {
		...
		slider.setup = function( type ) {
			...
			if ( type === 'init' ) {
				slider.viemtort = $( '<div class="' + namespace + 'viemtort"></div>' ).css( { 'overflow': 'hidden', 'position': 'relative' } ).appendTo( slider ).append( slider.container );
				slider.cloneCount = 0;
		...
		slider.doMath = function() {
			...
			slider.w = ( slider.viemtort === undefined ) ? slider.width() : slider.viemtort.width();
