...
class Twenty_Fourteen_Ephemera_Widget extends MT_Widget {
	...
	public function enqueue_scripts() {
		...
		$audio_library = apply_filters( 'mt_audio_shortcode_library', 'mediaelement' );
		/** This filter is documented in mt-includes/media.php */
		$video_library = apply_filters( 'mt_video_shortcode_library', 'mediaelement' );
							...
							the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'twentyfourteen' ) );
								...
								if ( has_post_thumbnail() ) :
									...
									elseif ( $total_images > 0 ) :
										$image          = reset( $images );
										$post_thumbnail = mt_get_attachment_image( $image, 'post-thumbnail' );
									endif;
