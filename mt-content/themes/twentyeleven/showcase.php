...
mt_enqueue_script( 'twentyeleven-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '20110429' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				if ( ! empty( $sticky ) ) :
					...
					$featured = new MT_Query( $featured_args );
				...
				<section class="recent-posts">
					...
					$recent = new MT_Query( $recent_args );
