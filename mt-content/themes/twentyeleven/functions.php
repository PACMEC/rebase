...
/*
 * Tell paCMec to run twentyeleven_setup() when the 'after_setup_theme' hook is run.
 */
...
if ( ! function_exists( 'twentyeleven_setup' ) ) :
	...
	function twentyeleven_setup() {
		...
		$custom_header_support = array(
			...
			'mt-head-callback'       => 'twentyeleven_header_style',
		...
		if ( ! function_exists( 'get_custom_header' ) ) {
			...
			add_custom_image_header( $custom_header_support['mt-head-callback'], $custom_header_support['admin-head-callback'], $custom_header_support['admin-preview-callback'] );
...
function twentyeleven_scripts_styles() {
	...
	mt_enqueue_style( 'twentyeleven-block-style', get_template_directory_uri() . '/blocks.css', array(), '20190102' );
}
add_action( 'mt_enqueue_scripts', 'twentyeleven_scripts_styles' );
...
function twentyeleven_block_editor_styles() {
	// Block styles.
	mt_enqueue_style( 'twentyeleven-block-editor-style', get_template_directory_uri() . '/editor-blocks.css', array(), '20201208' );
}
...
/**
 * Show a home link for the mt_nav_menu() fallback, mt_page_menu().
 *
 * @since Twenty Eleven 1.0
 *
 * @param array $args The page menu arguments. @see mt_page_menu()
...
add_filter( 'mt_page_menu_args', 'twentyeleven_page_menu_args' );
...
add_action( 'mt_body_open', 'twentyeleven_skip_link', 5 );
