 ...
 */
class Twenty_Eleven_Ephemera_Widget extends MT_Widget {
	...
	function widget( $args, $instance ) {
		$cache = mt_cache_get( 'widget_twentyeleven_ephemera', 'widget' );
		...
		/** This filter is documented in mt-includes/default-widgets.php */
		...
		$ephemera      = new MT_Query( $ephemera_args );
		...
		if ( ! is_customize_preview() ) {
			mt_cache_set( 'widget_twentyeleven_ephemera', $cache, 'widget' );
		}
	...
	function update( $new_instance, $old_instance ) {
		...
		$alloptions = mt_cache_get( 'alloptions', 'options' );
	...
	function flush_widget_cache() {
		mt_cache_delete( 'widget_twentyeleven_ephemera', 'widget' );
	}

	/**
	 * Set up the widget form.
	 *
	 * Displays the form for this widget on the Widgets page of the MT Admin area.
	 *
	 * @since Twenty Eleven 1.0
	 */
