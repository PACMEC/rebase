...
function twentyeleven_admin_enqueue_scripts( $hook_suffix ) {
	mt_enqueue_style( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.css', false, '20110602' );
	mt_enqueue_script( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.js', array( 'farbtastic' ), '20110610' );
	mt_enqueue_style( 'farbtastic' );
}
...
function twentyeleven_theme_options_help() {
	...
	$sidebar = '<p><strong>' . __( 'For more information:', 'twentyeleven' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://managertechnology.com.co/pacmec/support/article/appearance-customize-screen/" target="_blank">Documentation on Theme Options</a>', 'twentyeleven' ) . '</p>' .
		'<p>' . __( '<a href="https://managertechnology.com.co/pacmec/support/" target="_blank">Support</a>', 'twentyeleven' ) . '</p>';
...
function twentyeleven_theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<?php $theme_name = function_exists( 'mt_get_theme' ) ? mt_get_theme() : get_current_theme(); ?>
		<h2>
		<?php
...
function twentyeleven_enqueue_color_scheme() {
	...
	if ( 'dark' === $color_scheme ) {
		mt_enqueue_style( 'dark', get_template_directory_uri() . '/colors/dark.css', array(), '20190404' );
	}
...
add_action( 'mt_enqueue_scripts', 'twentyeleven_enqueue_color_scheme' );

/**
 * Add a style block to the theme for the current link color.
 *
 * This function is attached to the mt_head action hook.
 *
 * @since Twenty Eleven 1.0
 */
...
add_action( 'mt_head', 'twentyeleven_print_link_color_style' );
 ...
 */
function twentyeleven_customize_register( $mt_customize ) {
...
function twentyeleven_customize_preview_js() {
	mt_enqueue_script( 'twentyeleven-customizer', get_template_directory_uri() . '/inc/theme-customizer.js', array( 'customize-preview' ), '20150401', true );
}
