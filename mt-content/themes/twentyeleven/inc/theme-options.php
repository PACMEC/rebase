...
function twentyeleven_theme_options_help() {
	...
	$sidebar = '<p><strong>' . __( 'For more information:', 'twentyeleven' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://managertechnology.org/support/article/appearance-customize-screen/" target="_blank">Documentation on Theme Options</a>', 'twentyeleven' ) . '</p>' .
		'<p>' . __( '<a href="https://managertechnology.org/support/" target="_blank">Support</a>', 'twentyeleven' ) . '</p>';
