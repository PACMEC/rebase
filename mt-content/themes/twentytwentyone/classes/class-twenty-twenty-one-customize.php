...
if ( ! class_exists( 'Twenty_Twenty_One_Customize' ) ) {
	...
	class Twenty_Twenty_One_Customize {
		 ...
		 * @return void
		 */
		public function register( $mt_customize ) {

			// Change site-title & description to postMessage.
			$mt_customize->get_setting( 'blogname' )->transport        = 'postMessage'; // @phpstan-ignore-line. Assume that this setting exists.
			$mt_customize->get_setting( 'blogdescription' )->transport = 'postMessage'; // @phpstan-ignore-line. Assume that this setting exists.
			...
			include_once get_theme_file_path( 'classes/class-twenty-twenty-one-customize-color-control.php' ); // phpcs:ignore MTThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$mt_customize->register_control_type( 'Twenty_Twenty_One_Customize_Color_Control' );
