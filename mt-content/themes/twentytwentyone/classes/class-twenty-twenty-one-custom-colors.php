...
class Twenty_Twenty_One_Custom_Colors {
	...
	public function __construct() {
		...
		add_action( 'mt_enqueue_scripts', array( $this, 'custom_color_variables' ) );
	...
	public function custom_color_variables() {
		if ( 'd1e4dd' !== strtolower( get_theme_mod( 'background_color', 'D1E4DD' ) ) ) {
			mt_add_inline_style( 'twenty-twenty-one-style', $this->generate_custom_color_variables() );
		}
	}
	...
	public function editor_custom_color_variables() {
		...
		$background_color = get_theme_mod( 'background_color', 'D1E4DD' );
		if ( 'd1e4dd' !== strtolower( $background_color ) ) {
			mt_add_inline_style( 'twenty-twenty-one-custom-color-overrides', $this->generate_custom_color_variables( 'editor' ) );
		}
	}
