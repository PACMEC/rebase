...
/**
 * Twenty Thirteen only works in paCMec 3.6 or later.
 */
if ( version_compare( $GLOBALS['mt_version'], '3.6-alpha', '<' ) ) {
 ...
 *
 * Sets up theme defaults and registers the various paCMec features that
...
function twentythirteen_setup() {
	...
	// This theme uses mt_nav_menu() in one location.
...
function twentythirteen_scripts_styles() {
	...
	mt_enqueue_script( 'twentythirteen-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20171218', true );

	// Add Source Sans Pro and Bitter fonts, used in the main stylesheet.
	mt_enqueue_style( 'twentythirteen-fonts', twentythirteen_fonts_url(), array(), null );

	// Add Genericons font, used in the main stylesheet.
	mt_enqueue_style( 'genericons', get_template_directory_uri() . '/genericons/genericons.css', array(), '3.0.3' );

	// Loads our main stylesheet.
	mt_enqueue_style( 'twentythirteen-style', get_stylesheet_uri(), array(), '20201208' );

	// Theme block stylesheet.
	mt_enqueue_style( 'twentythirteen-block-style', get_template_directory_uri() . '/css/blocks.css', array( 'twentythirteen-style' ), '20190102' );

	// Loads the Internet Explorer specific stylesheet.
	mt_enqueue_style( 'twentythirteen-ie', get_template_directory_uri() . '/css/ie.css', array( 'twentythirteen-style' ), '20150214' );
	mt_style_add_data( 'twentythirteen-ie', 'conditional', 'lt IE 9' );
}
add_action( 'mt_enqueue_scripts', 'twentythirteen_scripts_styles' );
...
function twentythirteen_resource_hints( $urls, $relation_type ) {
	if ( mt_style_is( 'twentythirteen-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
...
add_filter( 'mt_resource_hints', 'twentythirteen_resource_hints', 10, 2 );
...
function twentythirteen_block_editor_styles() {
	// Block styles.
	mt_enqueue_style( 'twentythirteen-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', array(), '20201208' );
	// Add custom fonts.
	mt_enqueue_style( 'twentythirteen-fonts', twentythirteen_fonts_url(), array(), null );
}
 ...
 */
function twentythirteen_mt_title( $title, $sep ) {
	global $paged, $page;
...
add_filter( 'mt_title', 'twentythirteen_mt_title', 10, 2 );
...
if ( ! function_exists( 'twentythirteen_entry_meta' ) ) :
	...
	function twentythirteen_entry_meta() {
		...
		if ( $tags_list && ! is_mt_error( $tags_list ) ) {
 ...
 * @since Twenty Thirteen 1.0
 *
 * @param MT_Customize_Manager $mt_customize Customizer object.
 */
function twentythirteen_customize_register( $mt_customize ) {
	$mt_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$mt_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$mt_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';

	if ( isset( $mt_customize->selective_refresh ) ) {
		$mt_customize->selective_refresh->add_partial(
			'blogname',
			array(
				'selector'            => '.site-title',
...
function twentythirteen_customize_preview_js() {
	mt_enqueue_script( 'twentythirteen-customizer', get_template_directory_uri() . '/js/theme-customizer.js', array( 'customize-preview' ), '20141120', true );
}
...
if ( ! function_exists( 'mt_body_open' ) ) :
	 ...
	 *
	 * Added for backward compatibility to support pre-5.2.0 paCMec versions.
	 *
