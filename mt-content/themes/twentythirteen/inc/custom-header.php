...
/**
 * Set up the paCMec core custom header arguments and settings.
 *
 * @uses add_theme_support() to register support for 3.4 and up.
 * @uses twentythirteen_header_style() to style front end.
 * @uses twentythirteen_admin_header_style() to style mt-admin form.
 * @uses twentythirteen_admin_header_image() to add custom markup to mt-admin form.
...
function twentythirteen_custom_header_setup() {
	$args = array(
		...
		'mt-head-callback'       => 'twentythirteen_header_style',
