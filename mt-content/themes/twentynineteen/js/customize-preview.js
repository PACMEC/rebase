...
(function( $ ) {
	...
	// Primary color.
	mt.customize( 'primary_color', function( value ) {
		value.bind( function( to ) {
			...
			if( 'custom' === to ){
				...
				color = mt.customize.get().primary_color_hue;
			} else {
	...
	// Primary color hue.
	mt.customize( 'primary_color_hue', function( value ) {
		value.bind( function( to ) {
	...
	// Image filter.
	mt.customize( 'image_filter', function( value ) {
		value.bind( function( to ) {
			if ( to ) {
