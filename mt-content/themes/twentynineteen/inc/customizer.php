 ...
 */
function twentynineteen_customize_register( $mt_customize ) {
...
function twentynineteen_customize_preview_js() {
	mt_enqueue_script( 'twentynineteen-customize-preview', get_theme_file_uri( '/js/customize-preview.js' ), array( 'customize-preview' ), '20181214', true );
}
...
function twentynineteen_panels_js() {
	mt_enqueue_script( 'twentynineteen-customize-controls', get_theme_file_uri( '/js/customize-controls.js' ), array(), '20181214', true );
}
