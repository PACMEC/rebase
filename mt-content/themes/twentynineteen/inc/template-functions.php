...
add_action( 'mt_head', 'twentynineteen_pingback_header' );
...
add_filter( 'mt_get_attachment_image_attributes', 'twentynineteen_post_thumbnail_sizes_attr', 10, 1 );
...
add_filter( 'mt_nav_menu', 'twentynineteen_add_ellipses_to_nav', 10, 2 );
...
add_filter( 'mt_nav_menu_objects', 'twentynineteen_add_mobile_parent_nav_menu_items', 10, 2 );
