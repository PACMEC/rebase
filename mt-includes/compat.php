 ...
 */
function _mt_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore paCMec.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
...
if ( ! function_exists( 'random_int' ) ) {
	require ABSPATH . MTINC . '/random_compat/random.php';
}
// sodium_crypto_box() was introduced in PHP 7.2.
if ( ! function_exists( 'sodium_crypto_box' ) ) {
	require ABSPATH . MTINC . '/sodium_compat/autoload.php';
}
