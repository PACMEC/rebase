...
function render_block_core_block( $attributes ) {
	...
	if ( ! $reusable_block || 'mt_block' !== $reusable_block->post_type ) {
		return '';
	}
	...
	if ( isset( $seen_refs[ $attributes['ref'] ] ) ) {
		...
		// MT_DEBUG_DISPLAY must only be honored when MT_DEBUG. This precedent
		// is set in `mt_debug_mode()`.
		$is_debug = defined( 'MT_DEBUG' ) && MT_DEBUG &&
			defined( 'MT_DEBUG_DISPLAY' ) && MT_DEBUG_DISPLAY;
