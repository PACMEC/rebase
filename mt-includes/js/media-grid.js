...
/**
 * @output mt-includes/js/media-grid.js
 */
...
/**
 * mt.media.controller.EditAttachmentMetadata
 *
 ...
 */
EditAttachmentMetadata = mt.media.controller.State.extend(/** @lends mt.media.controller.EditAttachmentMetadata.prototype */{
	defaults: {
		id:      'edit-attachment',
...
/**
 * mt.media.view.MediaFrame.Manage
 *
 ...
 */
Manage = MediaFrame.extend(/** @lends mt.media.view.MediaFrame.Manage.prototype */{
	/**
	 * @constructs
	 */
	initialize: function() {
		...
		this.$window = $( window );
		this.$adminBar = $( '#mtadminbar' );
		// Store the Add New button for later reuse in mt.media.view.UploaderInline.
		...
		this.gridRouter = new mt.media.view.MediaFrame.Manage.Router();
	...
	openEditAttachmentModal: function( model ) {
		...
		if ( mt.media.frames.edit ) {
			mt.media.frames.edit.open().trigger( 'refresh', model );
		} else {
			mt.media.frames.edit = mt.media( {
	...
	browseContent: function( contentRegion ) {
		...
		this.browserView = contentRegion.view = new mt.media.view.AttachmentsBrowser({
			controller: this,
	...
	startHistory: function() {
		...
		if ( window.history && window.history.pushState ) {
			...
			Backbone.history.start( {
				root: window._mtMediaGridSettings.adminUrl,
				pushState: true
			} );
		}
	}
...
var Details = mt.media.view.Attachment.Details,
	TwoColumn;

/**
 * mt.media.view.Attachment.Details.TwoColumn
 *
 * A similar view to media.view.Attachment.Details
 * for use in the Edit Attachment modal.
 *
 * @memberOf mt.media.view.Attachment.Details
 *
 * @class
 * @augments mt.media.view.Attachment.Details
 * @augments mt.media.view.Attachment
 * @augments mt.media.View
 * @augments mt.Backbone.View
 * @augments Backbone.View
 */
TwoColumn = Details.extend(/** @lends mt.media.view.Attachment.Details.TowColumn.prototype */{
	template: mt.template( 'attachment-details-two-column' ),
...
/**
 * mt.media.view.MediaFrame.Manage.Router
 *
 * A router for handling the browser history and application state.
 *
 * @memberOf mt.media.view.MediaFrame.Manage
 *
 * @class
 * @augments Backbone.Router
 */
var Router = Backbone.Router.extend(/** @lends mt.media.view.MediaFrame.Manage.Router.prototype */{
	routes: {
	...
	reset: function() {
		var frame = mt.media.frames.edit;
	...
	editItem: function( query ) {
		this.showItem( query );
		mt.media.frames.edit.content.mode( 'edit-details' );
	}
});
...
var View = mt.media.View,
	EditImage = mt.media.view.EditImage,
	Details;

/**
 * mt.media.view.EditImage.Details
 *
 * @memberOf mt.media.view.EditImage
 *
 * @class
 * @augments mt.media.view.EditImage
 * @augments mt.media.View
 * @augments mt.Backbone.View
 * @augments Backbone.View
 */
Details = EditImage.extend(/** @lends mt.media.view.EditImage.Details.prototype */{
...
var Frame = mt.media.view.Frame,
	MediaFrame = mt.media.view.MediaFrame,

	$ = jQuery,
	EditAttachments;

/**
 * mt.media.view.MediaFrame.EditAttachments
 *
 ...
 * @mixes mt.media.controller.StateMachine
 */
EditAttachments = MediaFrame.extend(/** @lends mt.media.view.MediaFrame.EditAttachments.prototype */{

	className: 'edit-attachment-frame',
	template:  mt.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new mt.media.controller.EditAttachmentMetadata({
				model:   this.model,
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new mt.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new mt.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new mt.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new mt.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
...
var Button = mt.media.view.Button,
	l10n = mt.media.view.l10n,
	SelectModeToggle;

/**
 * mt.media.view.SelectModeToggleButton
 *
 * @memberOf mt.media.view
 *
 * @class
 * @augments mt.media.view.Button
 * @augments mt.media.View
 * @augments mt.Backbone.View
 * @augments Backbone.View
 */
SelectModeToggle = Button.extend(/** @lends mt.media.view.SelectModeToggle.prototype */{
	initialize: function() {
		_.defaults( this.options, {
			size : ''
		} );
...
/**
 * mt.media.view.DeleteSelectedButton
 *
 ...
 * @augments Backbone.View
 */
DeleteSelected = Button.extend(/** @lends mt.media.view.DeleteSelectedButton.prototype */{
	initialize: function() {
		Button.prototype.initialize.apply( this, arguments );
	...
	filterChange: function( model ) {
		...
		} else if ( mt.media.view.settings.mediaTrash ) {
...
var Button = mt.media.view.Button,
	DeleteSelected = mt.media.view.DeleteSelectedButton,
	DeleteSelectedPermanently;

/**
 * mt.media.view.DeleteSelectedPermanentlyButton
 *
 ...
 *
 * @class
 * @augments mt.media.view.DeleteSelectedButton
 * @augments mt.media.view.Button
 * @augments mt.media.View
 * @augments mt.Backbone.View
 * @augments Backbone.View
 */
DeleteSelectedPermanently = DeleteSelected.extend(/** @lends mt.media.view.DeleteSelectedPermanentlyButton.prototype */{
	initialize: function() {
