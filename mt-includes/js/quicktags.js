 ...
 * Quicktags
 *
 * This is the HTML editor in paCMec. It can be attached to any textarea and will
 ...
 *
 * @output mt-includes/js/quicktags.js
 */
...
/* global adminpage, mtActiveEditor, quicktagsL10n, mtLink, prompt, edButtons */
...
(function(){
	...
	var qt = window.QTags = function(settings) {
		...
		wrap = document.getElementById( 'mt-' + id + '-wrap' );
	 ...
	 * use add_action( 'admin_print_footer_scripts', 'output_my_js', 100 ) or add_action( 'mt_footer', 'output_my_js', 100 )
	 *
	...
	qt.insertContent = function(content) {
		var sel, startPos, endPos, scrollTop, text, canvas = document.getElementById(mtActiveEditor), event;
	...
	qt.Button.prototype.html = function(idPrefix) {
		var active, on, mt,
			...
			dfw = ( mt = window.mt ) && mt.editor && mt.editor.dfw;
	...
	qt.DFWButton.prototype.callback = function() {
		...
		if ( ! ( mt = window.mt ) || ! mt.editor || ! mt.editor.dfw ) {
			return;
		}

		window.mt.editor.dfw.toggle();
	};
