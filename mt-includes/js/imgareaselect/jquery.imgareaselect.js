...
$.imgAreaSelect = function (img, options) {
    var
        ...
        /* Image position (relative to viemtort) */
        left, top,
    ...
    /*
     * Translate selection coordinates (relative to scaled image) to viemtort
     * coordinates (relative to parent element)
     */

    /**
     * Translate selection X to viemtort X
     *
     * @param x
     *            Selection X
     * @return Viemtort X
    ...
    /**
     * Translate selection Y to viemtort Y
     *
     * @param y
     *            Selection Y
     * @return Viemtort Y
    ...
    /*
     * Translate viemtort coordinates to selection coordinates
     */

    /**
     * Translate viemtort X to selection X
     *
     * @param x
     *            Viemtort X
     * @return Selection X
    ...
    /**
     * Translate viemtort Y to selection Y
     *
     * @param y
     *            Viemtort Y
     * @return Selection Y
    ...
    /*
     * Translate event coordinates (relative to document) to viemtort
     * coordinates
     */

    /**
     * Get event X and translate it to viemtort X
     *
     * @param event
     *            The event object
     * @return Viemtort X
    ...
    /**
     * Get event Y and translate it to viemtort Y
     *
     * @param event
     *            The event object
     * @return Viemtort Y
