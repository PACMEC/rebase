this["mt"] = this["mt"] || {}; this["mt"]["blockSerializationDefaultParser"] =
...
var tokenizer = /<!--\s+(\/)?mt:([a-z][a-z0-9_-]*\/)?([a-z][a-z0-9_-]*)\s+({(?:(?=([^}]+|}+(?=})|(?!}\s+\/?-->)[^])*)\5|[^]*?)}\s+)?(\/)?-->/g;
 ...
 * Input post:
 * ```html
 * <!-- mt:columns {"columns":3} -->
 * <div class="mt-block-columns has-3-columns"><!-- mt:column -->
 ...
 *             }
 *         ],
 *         innerHTML: '\n<div class="mt-block-columns has-3-columns">\n\n\n\n</div>\n'
 *     }
 * ];
 * ```
