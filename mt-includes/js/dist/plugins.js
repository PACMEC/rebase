this["mt"] = this["mt"] || {}; this["mt"]["plugins"] =
...
var _createContext = Object(external_mt_element_["createContext"])({
  name: null,
  icon: null
}),
 ...
 *
 * @return {MTComponent} Enhanced component with injected context as props.
 */

var plugin_context_withPluginContext = function withPluginContext(mapContextToProps) {
  return Object(external_mt_compose_["createHigherOrderComponent"])(function (OriginalComponent) {
    return function (props) {
      return Object(external_mt_element_["createElement"])(Consumer, null, function (context) {
        return Object(external_mt_element_["createElement"])(OriginalComponent, Object(esm_extends["a" /* default */])({}, props, mapContextToProps(context, props)));
      });
    };
  }, 'withPluginContext');
};
...
var plugins = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
 ...
 *
 * @typedef {Object} MTPlugin
 *
 * @property {string}                    name   A string identifying the plugin. Must be
 *                                              unique across all registered plugins.
 *                                              unique across all registered plugins.
 * @property {string|MTElement|Function} icon   An icon to be shown in the UI. It can
 ...
 *                            unique across all registered plugins.
 * @param {MTPlugin} settings The settings for this plugin.
 *
 * @example
 * <caption>ES5</caption>
 * ```js
 ...
 * var Fragment = mt.element.Fragment;
 ...
 * ```
 *
 * @return {MTPlugin} The final plugin settings object.
 */
...
function registerPlugin(name, settings) {
  ...
  settings = Object(external_mt_hooks_["applyFilters"])('plugins.registerPlugin', settings, name);
  ...
  Object(external_mt_hooks_["doAction"])('plugins.pluginRegistered', settings, name);
  return settings;
}
/**
 ...
 * ```js
 * // Using ES5 syntax
 * var unregisterPlugin = mt.plugins.unregisterPlugin;
 *
 ...
 * ```
 *
 * @return {?MTPlugin} The previous plugin settings object, if it has been
...
function unregisterPlugin(name) {
  ...
  Object(external_mt_hooks_["doAction"])('plugins.pluginUnregistered', oldPlugin, name);
  return oldPlugin;
}
/**
 ...
 * @param {string} name Plugin name.
 *
 * @return {?MTPlugin} Plugin setting.
 */
 ...
 *
 * @return {MTPlugin[]} Plugin settings.
 */
 ...
 * // Using ES5 syntax
 * var el = mt.element.createElement;
 * var PluginArea = mt.plugins.PluginArea;
 *
 * function Layout() {
 * 	return el(
 * 		'div',
...
var plugin_area_PluginArea = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(PluginArea, [{
    ...
    value: function componentDidMount() {
      Object(external_mt_hooks_["addAction"])('plugins.pluginRegistered', 'core/plugins/plugin-area/plugins-registered', this.setPlugins);
      Object(external_mt_hooks_["addAction"])('plugins.pluginUnregistered', 'core/plugins/plugin-area/plugins-unregistered', this.setPlugins);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      Object(external_mt_hooks_["removeAction"])('plugins.pluginRegistered', 'core/plugins/plugin-area/plugins-registered');
      Object(external_mt_hooks_["removeAction"])('plugins.pluginUnregistered', 'core/plugins/plugin-area/plugins-unregistered');
    }
  }, {
    key: "setPlugins",
    ...
    value: function render() {
      return Object(external_mt_element_["createElement"])("div", {
        ...
        return Object(external_mt_element_["createElement"])(Provider, {
          key: context.name,
          value: context
        }, Object(external_mt_element_["createElement"])(Plugin, null));
      }));
    }
  }]);
