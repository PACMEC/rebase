this["mt"] = this["mt"] || {}; this["mt"]["serverSideRender"] =
...
function rendererPath(block) {
  ...
  return Object(external_mt_url_["addQueryArgs"])("/mt/v2/block-renderer/".concat(block), _objectSpread(_objectSpread({
    context: 'edit'
  }, null !== attributes ? {
...
var server_side_render_ServerSideRender = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(ServerSideRender, [{
    ...
    value: function fetch(props) {
      ...
      var fetchRequest = this.currentFetchRequest = external_mt_apiFetch_default()({
        path: path,
        data: data,
    ...
    value: function render() {
      ...
      if (response === '') {
        return Object(external_mt_element_["createElement"])(EmptyResponsePlaceholder, Object(esm_extends["a" /* default */])({
          response: response
        }, this.props));
      } else if (!response) {
        return Object(external_mt_element_["createElement"])(LoadingResponsePlaceholder, Object(esm_extends["a" /* default */])({
          response: response
        }, this.props));
      } else if (response.error) {
        return Object(external_mt_element_["createElement"])(ErrorResponsePlaceholder, Object(esm_extends["a" /* default */])({
          response: response
        }, this.props));
      }

      return Object(external_mt_element_["createElement"])(external_mt_element_["RawHTML"], {
        key: "html",
        className: className
      }, response);
    }
...
server_side_render_ServerSideRender.defaultProps = {
  EmptyResponsePlaceholder: function EmptyResponsePlaceholder(_ref) {
    ...
    return Object(external_mt_element_["createElement"])(external_mt_components_["Placeholder"], {
      className: className
    }, Object(external_mt_i18n_["__"])('Block rendered as empty.'));
  },
  ErrorResponsePlaceholder: function ErrorResponsePlaceholder(_ref2) {
    var response = _ref2.response,
        className = _ref2.className;
    var errorMessage = Object(external_mt_i18n_["sprintf"])( // translators: %s: error message describing the problem
    Object(external_mt_i18n_["__"])('Error loading block: %s'), response.errorMsg);
    return Object(external_mt_element_["createElement"])(external_mt_components_["Placeholder"], {
      className: className
    }, errorMessage);
  },
...
var EMPTY_OBJECT = {};
var ExportedServerSideRender = Object(external_mt_data_["withSelect"])(function (select) {
  ...
  var newUrlQueryArgs = Object(external_mt_element_["useMemo"])(function () {
    if (!currentPostId) {
      return urlQueryArgs;
    }
  ...
  return Object(external_mt_element_["createElement"])(server_side_render, Object(esm_extends["a" /* default */])({
    urlQueryArgs: newUrlQueryArgs
  }, props));
});

if (window && window.mt && window.mt.components) {
  window.mt.components.ServerSideRender = Object(external_mt_element_["forwardRef"])(function (props, ref) {
    external_mt_deprecated_default()('mt.components.ServerSideRender', {
      alternative: 'mt.serverSideRender'
    });
    return Object(external_mt_element_["createElement"])(ExportedServerSideRender, Object(esm_extends["a" /* default */])({}, props, {
      ref: ref
    }));
  });
}
