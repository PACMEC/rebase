this["mt"] = this["mt"] || {}; this["mt"]["editPost"] =
...
(function() { module.exports = window["mt"]["element"]; }());
...
(function() { module.exports = window["mt"]["i18n"]; }());
...
(function() { module.exports = window["mt"]["warning"]; }());
...
(function() { module.exports = window["mt"]["viemtort"]; }());
...
var VIEW_AS_LINK_SELECTOR = '#mt-admin-bar-view a';
/**
...
var VIEW_AS_PREVIEW_LINK_SELECTOR = '#mt-admin-bar-preview a';
...
(function() { module.exports = window["mt"]["compose"]; }());
...
(function() { module.exports = window["mt"]["mediaUtils"]; }());
...
(function() { module.exports = window["mt"]["keycodes"]; }());
 ...
 * ```js
 * // Using ES5 syntax
 * var el = mt.element.createElement;
 * var __ = mt.i18n.__;
 * var registerPlugin = mt.plugins.registerPlugin;
 * var PluginDocumentSettingPanel = mt.editPost.PluginDocumentSettingPanel;
 *
 ...
 * ```
 *
 * @return {MTComponent} The component to be rendered.
 */
...
// EXTERNAL MODULE: external ["mt","dataControls"]
var external_mt_dataControls_ = __webpack_require__(49);
...
var preferences = Object(external_lodash_["flow"])([external_mt_data_["combineReducers"], createWithInitialState(PREFERENCES_DEFAULTS)])({
...
var metaBoxes = Object(external_mt_data_["combineReducers"])({
  isSaving: isSavingMetaBoxes,
  locations: metaBoxLocations
});
/* harmony default export */ var reducer = (Object(external_mt_data_["combineReducers"])({
  ...
  return external_regeneratorRuntime_default.a.wrap(function openGeneralSidebar$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return external_mt_data_["controls"].dispatch(build_module["g" /* store */].name, 'enableComplementaryArea', store.name, name);
  ...
  return external_regeneratorRuntime_default.a.wrap(function closeGeneralSidebar$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return external_mt_data_["controls"].dispatch(build_module["g" /* store */].name, 'disableComplementaryArea', store.name);
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          _context3.next = 5;
          return external_mt_data_["controls"].dispatch('core/block-editor', 'clearSelectedBlock');

        case 5:
          message = mode === 'visual' ? Object(external_mt_i18n_["__"])('Visual editor selected') : Object(external_mt_i18n_["__"])('Code editor selected');
          Object(external_mt_a11y_["speak"])(message, 'assertive');
  ...
  return external_regeneratorRuntime_default.a.wrap(function setAvailableMetaBoxesPerLocation$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          _context4.next = 4;
          return external_mt_data_["controls"].select('core/editor', 'getCurrentPostType');
        ...
        case 4:
          ...
          _context4.next = 8;
          return external_mt_data_["controls"].select('core/editor', 'isSavingPost');

        case 8:
          wasSavingPost = _context4.sent;
          _context4.next = 11;
          return external_mt_data_["controls"].select('core/editor', 'isAutosavingPost');

        case 11:
          wasAutosavingPost = _context4.sent;
          _context4.next = 14;
          return external_mt_data_["controls"].select(store.name, 'hasMetaBoxes');
        ...
        case 14:
          ...
          saveMetaboxUnsubscribe = Object(external_mt_data_["subscribe"])(function () {
            var isSavingPost = Object(external_mt_data_["select"])('core/editor').isSavingPost();
            var isAutosavingPost = Object(external_mt_data_["select"])('core/editor').isAutosavingPost(); // Save metaboxes on save completion, except for autosaves that are not a post preview.
            ...
            if (shouldTriggerMetaboxesSave) {
              Object(external_mt_data_["dispatch"])(store.name).requestMetaBoxUpdates();
            }
          });
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return external_mt_data_["controls"].select('core/editor', 'getCurrentPost');
        ...
        case 5:
          ...
          _context5.next = 10;
          return external_mt_data_["controls"].select(store.name, 'getActiveMetaBoxLocations');
        ...
        case 10:
          ...
          _context5.next = 16;
          return Object(external_mt_dataControls_["apiFetch"])({
            url: window._mtMetaBoxUrl,
            method: 'POST',
            body: formData,
            parse: false
          });
        ...
        case 16:
          _context5.next = 18;
          return external_mt_data_["controls"].dispatch(store.name, 'metaBoxUpdatesSuccess');
...
var isEditorSidebarOpened = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function () {
...
var isPluginSidebarOpened = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function () {
    var activeGeneralSidebar = select(build_module["g" /* store */]).getActiveComplementaryArea('core/edit-post');
...
var getActiveGeneralSidebarName = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function () {
...
var isPluginItemPinned = Object(external_mt_data_["createRegistrySelector"])(function (select) {
...
var storeConfig = {
  ...
  controls: external_mt_dataControls_["controls"],
  persist: ['preferences']
};
/**
 * Store definition for the edit post namespace.
 *
 * @see https://github.com/paCMec/gutenberg/blob/HEAD/packages/data/README.md#createReduxStore
 *
 * @type {Object}
 */

var store = Object(external_mt_data_["createReduxStore"])(constants["a" /* STORE_NAME */], storeConfig); // Ideally we use register instead of register store.

Object(external_mt_data_["registerStore"])(constants["a" /* STORE_NAME */], storeConfig);
...
(function() { module.exports = window["mt"]["blockLibrary"]; }());
...
(function() { module.exports = window["mt"]["components"]; }());
...
(function() { module.exports = window["mt"]["url"]; }());
...
(function() { module.exports = window["mt"]["hooks"]; }());
...
(function() { module.exports = window["mt"]["editor"]; }());
...
(function() { module.exports = window["mt"]["data"]; }());
...
// EXTERNAL MODULE: external ["mt","coreData"]
var external_mt_coreData_ = __webpack_require__(57);

// EXTERNAL MODULE: external ["mt","blockEditor"]
var external_mt_blockEditor_ = __webpack_require__(6);

// EXTERNAL MODULE: external ["mt","editor"]
var external_mt_editor_ = __webpack_require__(34);

// EXTERNAL MODULE: external ["mt","blockLibrary"]
var external_mt_blockLibrary_ = __webpack_require__(293);
...
var components_replaceMediaUpload = function replaceMediaUpload() {
  return external_mt_mediaUtils_["MediaUpload"];
};

Object(external_mt_hooks_["addFilter"])('editor.MediaUpload', 'core/edit-post/replace-media-upload', components_replaceMediaUpload);
...
var enhance = Object(external_mt_compose_["compose"])(
/**
 ...
 *
 * @param {MTComponent} WrappedBlockEdit A filtered BlockEdit instance.
 *
 * @return {MTComponent} Enhanced component with merged state data props.
 */
Object(external_mt_data_["withSelect"])(function (select, block) {
  var multiple = Object(external_mt_blocks_["hasBlockSupport"])(block.name, 'multiple', true); // For block types with `multiple` support, there is no "original
...
}), Object(external_mt_data_["withDispatch"])(function (dispatch, _ref2) {
...
var withMultipleValidation = Object(external_mt_compose_["createHigherOrderComponent"])(function (BlockEdit) {
  return enhance(function (_ref3) {
    ...
    if (!originalBlockClientId) {
      return Object(external_mt_element_["createElement"])(BlockEdit, props);
    }

    var blockType = Object(external_mt_blocks_["getBlockType"])(props.name);
    var outboundType = getOutboundType(props.name);
    return [Object(external_mt_element_["createElement"])("div", {
      key: "invalid-preview",
      style: {
        minHeight: '60px'
      }
    }, Object(external_mt_element_["createElement"])(BlockEdit, Object(esm_extends["a" /* default */])({
      key: "block-edit"
    }, props))), Object(external_mt_element_["createElement"])(external_mt_blockEditor_["Warning"], {
      key: "multiple-use-warning",
      actions: [Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        key: "find-original",
        isSecondary: true,
        onClick: selectFirst
      }, Object(external_mt_i18n_["__"])('Find original')), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        key: "remove",
        isSecondary: true,
        onClick: function onClick() {
          return props.onReplace([]);
        }
      }, Object(external_mt_i18n_["__"])('Remove')), outboundType && Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        key: "transform",
        isSecondary: true,
        onClick: function onClick() {
          return props.onReplace(Object(external_mt_blocks_["createBlock"])(outboundType.name, props.attributes));
        }
      }, Object(external_mt_i18n_["__"])('Transform into:'), " ", outboundType.title)]
    }, Object(external_mt_element_["createElement"])("strong", null, blockType.title, ": "), Object(external_mt_i18n_["__"])('This block can only be used once.'))];
  });
...
function getOutboundType(blockName) {
  ...
  var transform = Object(external_mt_blocks_["findTransform"])(Object(external_mt_blocks_["getBlockTransforms"])('to', blockName), function (_ref4) {
    var type = _ref4.type,
        blocks = _ref4.blocks;
  ...
  return Object(external_mt_blocks_["getBlockType"])(transform.blocks[0]);
}
...
function CopyContentMenuItem(_ref) {
  ...
  var ref = Object(external_mt_element_["useRef"])();
  var hasCopied = Object(external_mt_compose_["useCopyOnClick"])(ref, editedPostContent);
  Object(external_mt_element_["useEffect"])(function () {
    if (!hasCopied) {
      return;
    }

    createNotice('info', Object(external_mt_i18n_["__"])('All content copied.'), {
      isDismissible: true,
      type: 'snackbar'
    });
  }, [hasCopied]);
  return Object(external_mt_element_["createElement"])(external_mt_components_["MenuItem"], {
    ref: ref
  }, hasCopied ? Object(external_mt_i18n_["__"])('Copied!') : Object(external_mt_i18n_["__"])('Copy all content'));
}

/* harmony default export */ var copy_content_menu_item = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  return {
    editedPostContent: select('core/editor').getEditedPostAttribute('content')
  };
}), Object(external_mt_data_["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch(external_mt_notices_["store"]),
      createNotice = _dispatch.createNotice;

  return {
    createNotice: createNotice
  };
}), Object(external_mt_compose_["ifCondition"])(function (_ref2) {
...
function ManageBlocksMenuItem(_ref) {
  ...
  }, Object(external_mt_i18n_["__"])('Block Manager'));
}
/* harmony default export */ var manage_blocks_menu_item = (Object(external_mt_data_["withDispatch"])(function (dispatch) {
...
function KeyboardShortcutsHelpMenuItem(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["MenuItem"], {
    ...
    shortcut: external_mt_keycodes_["displayShortcut"].access('h')
  }, Object(external_mt_i18n_["__"])('Keyboard shortcuts'));
}
/* harmony default export */ var keyboard_shortcuts_help_menu_item = (Object(external_mt_data_["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch(store["a" /* store */]),
      openModal = _dispatch.openModal;
...
var _createSlotFill = Object(external_mt_components_["createSlotFill"])('ToolsMoreMenuGroup'),
...
ToolsMoreMenuGroup.Slot = function (_ref) {
  ...
  return Object(external_mt_element_["createElement"])(tools_more_menu_group_Slot, {
    fillProps: fillProps
  }, function (fills) {
    return !Object(external_lodash_["isEmpty"])(fills) && Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], {
      label: Object(external_mt_i18n_["__"])('Tools')
    }, fills);
  });
};
...
function WelcomeGuideMenuItem() {
  var _useDispatch = Object(external_mt_data_["useDispatch"])(store["a" /* store */]),
...
Object(external_mt_plugins_["registerPlugin"])('edit-post', {
  render: function render() {
    return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(tools_more_menu_group, null, function (_ref) {
      var onClose = _ref.onClose;
      return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(manage_blocks_menu_item, {
        onSelect: onClose
      }), Object(external_mt_element_["createElement"])(external_mt_components_["MenuItem"], {
        role: "menuitem",
        href: Object(external_mt_url_["addQueryArgs"])('edit.php', {
          post_type: 'mt_block'
        })
      }, Object(external_mt_i18n_["__"])('Manage all reusable blocks')), Object(external_mt_element_["createElement"])(keyboard_shortcuts_help_menu_item, {
        onSelect: onClose
      ...
      Object(external_mt_i18n_["__"])('(opens in a new tab)'))));
    }));
  }
});
...
/* harmony default export */ var prevent_event_discovery = ({
  't a l e s o f g u t e n b e r g': function tALESOFGUTENBERG(event) {
    ...
    window.mt.data.dispatch('core/block-editor').insertBlock(window.mt.blocks.createBlock('core/paragraph', {
      content: '🐡🐢🦀🐤🦋🐘🐧🐹🦁🦄🦍🐼🐿🎃🐴🐝🐆🦕🦔🌱🍇π🍌🐉💧🥨🌌🍂🍠🥦🥚🥝🎟🥥🥒🛵🥖🍒🍯🎾🎲🐺🐚🐮⌛️'
    }));
  }
});
...
function TextEditor(_ref) {
  ...
  }, isRichEditingEnabled && Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-text-editor__toolbar"
  }, Object(external_mt_element_["createElement"])("h2", null, Object(external_mt_i18n_["__"])('Editing code')), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    isTertiary: true,
    onClick: onExit,
    shortcut: external_mt_keycodes_["displayShortcut"].secondary('m')
  }, Object(external_mt_i18n_["__"])('Exit code editor')), Object(external_mt_element_["createElement"])(external_mt_editor_["TextEditorGlobalKeyboardShortcuts"], null)), Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-text-editor__body"
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostTitle"], null), Object(external_mt_element_["createElement"])(external_mt_editor_["PostTextEditor"], null)));
}

/* harmony default export */ var text_editor = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
function BlockInspectorButton(_ref) {
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    return {
      shortcut: select(external_mt_keyboardShortcuts_["store"]).getShortcutRepresentation('core/edit-post/toggle-sidebar'),
  ...
  var speakMessage = function speakMessage() {
    if (areAdvancedSettingsOpened) {
      Object(external_mt_a11y_["speak"])(Object(external_mt_i18n_["__"])('Block settings closed'));
    } else {
      Object(external_mt_a11y_["speak"])(Object(external_mt_i18n_["__"])('Additional settings are now available in the Editor block settings sidebar'));
    }
  };

  var label = areAdvancedSettingsOpened ? Object(external_mt_i18n_["__"])('Hide more settings') : Object(external_mt_i18n_["__"])('Show more settings');
  return Object(external_mt_element_["createElement"])(external_mt_components_["MenuItem"], {
    onClick: function onClick() {
      if (areAdvancedSettingsOpened) {
        closeGeneralSidebar();
...
function VisualEditor(_ref) {
  ...
  var hasMetaBoxes = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  var resizedCanvasStyles = Object(external_mt_blockEditor_["__experimentalUseResizeCanvas"])(deviceType);
  Object(external_mt_blockEditor_["__unstableUseScrollMultiSelectionIntoView"])(ref);
  Object(external_mt_blockEditor_["__unstableUseBlockSelectionClearer"])(ref);
  Object(external_mt_blockEditor_["__unstableUseTypewriter"])(ref);
  Object(external_mt_blockEditor_["__unstableUseClipboardHandler"])(ref);
  Object(external_mt_blockEditor_["__unstableUseTypingObserver"])(ref);
  Object(external_mt_blockEditor_["__unstableUseCanvasClickRedirect"])(ref);
  var editorStylesRef = Object(external_mt_blockEditor_["__unstableUseEditorStyles"])(styles);
  var mergedRefs = Object(external_mt_element_["useCallback"])(Object(react_merge_refs_esm["a" /* default */])([ref, editorStylesRef]), [ref, editorStylesRef]);
  return Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-visual-editor"
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["VisualEditorGlobalKeyboardShortcuts"], null), Object(external_mt_element_["createElement"])(external_mt_components_["Popover"].Slot, {
    name: "block-toolbar"
  }), Object(external_mt_element_["createElement"])("div", {
    ref: mergedRefs,
    className: "editor-styles-wrapper",
    style: resizedCanvasStyles || desktopCanvasStyles
  }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["WritingFlow"], null, !isTemplateMode && Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-visual-editor__post-title-wrapper"
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostTitle"], null)), Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockList"], null))), Object(external_mt_element_["createElement"])(external_mt_blockEditor_["__experimentalBlockSettingsMenuFirstItem"], null, function (_ref2) {
    var onClose = _ref2.onClose;
    return Object(external_mt_element_["createElement"])(block_inspector_button, {
      onClick: onClose
    });
  }));
}
...
function KeyboardShortcuts() {
  ...
  var _useDispatch2 = Object(external_mt_data_["useDispatch"])(external_mt_keyboardShortcuts_["store"]),
  ...
  Object(external_mt_element_["useEffect"])(function () {
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Switch between visual editor and code editor.'),
      keyCombination: {
        modifier: 'secondary',
        character: 'm'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Toggle fullscreen mode.'),
      keyCombination: {
        modifier: 'secondary',
        character: 'f'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Open the block list view.'),
      keyCombination: {
        modifier: 'access',
        character: 'o'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Show or hide the settings sidebar.'),
      keyCombination: {
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Navigate to the next part of the editor.'),
      keyCombination: {
        modifier: 'ctrl',
        character: '`'
      },
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Navigate to the previous part of the editor.'),
      keyCombination: {
        modifier: 'ctrlShift',
        character: '`'
      },
    ...
    registerShortcut({
      ...
      category: 'main',
      description: Object(external_mt_i18n_["__"])('Display these keyboard shortcuts.'),
      keyCombination: {
        modifier: 'access',
        character: 'h'
      }
  ...
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/edit-post/toggle-mode', function () {
    switchEditorMode(getEditorMode() === 'visual' ? 'text' : 'visual');
  }, {
    bindGlobal: true,
    isDisabled: !richEditingEnabled || !codeEditingEnabled
  });
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/edit-post/toggle-fullscreen', function () {
    toggleFeature('fullscreenMode');
  }, {
    bindGlobal: true
  });
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/edit-post/toggle-sidebar', function (event) {
...
var textFormattingShortcuts = [{
  ...
  description: Object(external_mt_i18n_["__"])('Make the selected text bold.')
}, {
  keyCombination: {
    modifier: 'primary',
    character: 'i'
  },
  description: Object(external_mt_i18n_["__"])('Make the selected text italic.')
}, {
  keyCombination: {
    modifier: 'primary',
    character: 'k'
  },
  description: Object(external_mt_i18n_["__"])('Convert the selected text into a link.')
}, {
  keyCombination: {
    modifier: 'primaryShift',
    character: 'k'
  },
  description: Object(external_mt_i18n_["__"])('Remove a link.')
}, {
  keyCombination: {
    modifier: 'primary',
    character: 'u'
...
function KeyCombination(_ref) {
  ...
  var shortcut = keyCombination.modifier ? external_mt_keycodes_["displayShortcutList"][keyCombination.modifier](keyCombination.character) : keyCombination.character;
  var ariaLabel = keyCombination.modifier ? external_mt_keycodes_["shortcutAriaLabel"][keyCombination.modifier](keyCombination.character) : keyCombination.character;
  return Object(external_mt_element_["createElement"])("kbd", {
    className: "edit-post-keyboard-shortcut-help-modal__shortcut-key-combination",
    "aria-label": forceAriaLabel || ariaLabel
  }, Object(external_lodash_["castArray"])(shortcut).map(function (character, index) {
    if (character === '+') {
      return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], {
        key: index
      }, character);
    }
...
function Shortcut(_ref2) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-keyboard-shortcut-help-modal__shortcut-description"
  }, description), Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-keyboard-shortcut-help-modal__shortcut-term"
  }, Object(external_mt_element_["createElement"])(KeyCombination, {
    keyCombination: keyCombination,
    forceAriaLabel: ariaLabel
  }), aliases.map(function (alias, index) {
    return Object(external_mt_element_["createElement"])(KeyCombination, {
...
function DynamicShortcut(_ref) {
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    var _select = select(external_mt_keyboardShortcuts_["store"]),
  ...
  return Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_shortcut, {
    keyCombination: keyCombination,
...
var keyboard_shortcut_help_modal_ShortcutList = function ShortcutList(_ref) {
  ...
  return (
    ...
    Object(external_mt_element_["createElement"])("ul", {
      className: "edit-post-keyboard-shortcut-help-modal__shortcut-list",
      role: "list"
    }, shortcuts.map(function (shortcut, index) {
      return Object(external_mt_element_["createElement"])("li", {
        className: "edit-post-keyboard-shortcut-help-modal__shortcut",
        key: index
      }, Object(external_lodash_["isString"])(shortcut) ? Object(external_mt_element_["createElement"])(dynamic_shortcut, {
        name: shortcut
      }) : Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_shortcut, shortcut));
    }))
...
var keyboard_shortcut_help_modal_ShortcutSection = function ShortcutSection(_ref2) {
  ...
  return Object(external_mt_element_["createElement"])("section", {
    className: classnames_default()('edit-post-keyboard-shortcut-help-modal__section', className)
  }, !!title && Object(external_mt_element_["createElement"])("h2", {
    className: "edit-post-keyboard-shortcut-help-modal__section-title"
  }, title), Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutList, {
    shortcuts: shortcuts
  }));
};
...
var keyboard_shortcut_help_modal_ShortcutCategorySection = function ShortcutCategorySection(_ref3) {
  ...
  var categoryShortcuts = Object(external_mt_data_["useSelect"])(function (select) {
    return select(external_mt_keyboardShortcuts_["store"]).getCategoryShortcuts(categoryName);
  }, [categoryName]);
  return Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutSection, {
    title: title,
...
function KeyboardShortcutHelpModal(_ref4) {
  ...
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/edit-post/keyboard-shortcuts', toggleModal, {
    bindGlobal: true
  });
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Modal"], {
    className: "edit-post-keyboard-shortcut-help-modal",
    title: Object(external_mt_i18n_["__"])('Keyboard shortcuts'),
    closeLabel: Object(external_mt_i18n_["__"])('Close'),
    onRequestClose: toggleModal
  }, Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutSection, {
    className: "edit-post-keyboard-shortcut-help-modal__main-shortcuts",
    shortcuts: ['core/edit-post/keyboard-shortcuts']
  }), Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutCategorySection, {
    title: Object(external_mt_i18n_["__"])('Global shortcuts'),
    categoryName: "global"
  }), Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutCategorySection, {
    title: Object(external_mt_i18n_["__"])('Selection shortcuts'),
    categoryName: "selection"
  }), Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutCategorySection, {
    title: Object(external_mt_i18n_["__"])('Block shortcuts'),
    categoryName: "block",
    additionalShortcuts: [{
      keyCombination: {
        character: '/'
      },
      description: Object(external_mt_i18n_["__"])('Change the block type after adding a new paragraph.'),

      /* translators: The forward-slash character. e.g. '/'. */
      ariaLabel: Object(external_mt_i18n_["__"])('Forward-slash')
    }]
  }), Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal_ShortcutSection, {
    title: Object(external_mt_i18n_["__"])('Text formatting'),
    shortcuts: textFormattingShortcuts
  }));
}
/* harmony default export */ var keyboard_shortcut_help_modal = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
    isModalActive: select(store["a" /* store */]).isModalActive(MODAL_NAME)
  };
}), Object(external_mt_data_["withDispatch"])(function (dispatch, _ref5) {
...
function BlockTypesChecklist(_ref) {
  ...
  return Object(external_mt_element_["createElement"])("ul", {
    ...
    }, Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
      label: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, blockType.title, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockIcon"], {
        icon: blockType.icon
      })),
...
function BlockManagerCategory(_ref) {
  ...
  var settings = Object(external_mt_element_["useContext"])(edit_post_settings);
  var allowedBlockTypes = settings.allowedBlockTypes;
  var filteredBlockTypes = Object(external_mt_element_["useMemo"])(function () {
  ...
  return Object(external_mt_element_["createElement"])("div", {
    ...
    label: Object(external_mt_element_["createElement"])("span", {
      id: titleId
    }, title)
  }), Object(external_mt_element_["createElement"])(checklist, {
...
/* harmony default export */ var manage_blocks_modal_category = (Object(external_mt_compose_["compose"])([external_mt_compose_["withInstanceId"], Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select(store["a" /* store */]),
...
}), Object(external_mt_data_["withDispatch"])(function (dispatch, ownProps) {
  var _dispatch = dispatch(store["a" /* store */]),
...
function BlockManager(_ref) {
  ...
  }, Object(external_mt_element_["createElement"])(external_mt_components_["TextControl"], {
    type: "search",
    label: Object(external_mt_i18n_["__"])('Search for a block'),
    value: search,
  ...
  }), !!numberOfHiddenBlocks && Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-manage-blocks-modal__disabled-blocks-count"
  }, Object(external_mt_i18n_["sprintf"])(
  /* translators: %d: number of blocks. */
  Object(external_mt_i18n_["_n"])('%d block is disabled.', '%d blocks are disabled.', numberOfHiddenBlocks), numberOfHiddenBlocks)), Object(external_mt_element_["createElement"])("div", {
    tabIndex: "0",
    role: "region",
    "aria-label": Object(external_mt_i18n_["__"])('Available block types'),
    className: "edit-post-manage-blocks-modal__results"
  }, blockTypes.length === 0 && Object(external_mt_element_["createElement"])("p", {
    className: "edit-post-manage-blocks-modal__no-results"
  }, Object(external_mt_i18n_["__"])('No blocks found.')), categories.map(function (category) {
    return Object(external_mt_element_["createElement"])(manage_blocks_modal_category, {
      key: category.slug,
  ...
  }), Object(external_mt_element_["createElement"])(manage_blocks_modal_category, {
    title: Object(external_mt_i18n_["__"])('Uncategorized'),
...
/* harmony default export */ var manager = (Object(external_mt_compose_["compose"])([Object(external_mt_compose_["withState"])({
  search: ''
}), Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select(external_mt_blocks_["store"]),
...
function ManageBlocksModal(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Modal"], {
    ...
    title: Object(external_mt_i18n_["__"])('Block Manager'),
    closeLabel: Object(external_mt_i18n_["__"])('Close'),
    onRequestClose: closeModal
  }, Object(external_mt_element_["createElement"])(manager, null));
}
/* harmony default export */ var manage_blocks_modal = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select(store["a" /* store */]),
...
var section_Section = function Section(_ref) {
  ...
  }, Object(external_mt_element_["createElement"])("h2", {
    className: "edit-post-preferences-modal__section-title"
  }, title), description && Object(external_mt_element_["createElement"])("p", {
...
function MetaBoxesSection(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(preferences_modal_section, sectionProps, areCustomFieldsRegistered && Object(external_mt_element_["createElement"])(options["a" /* EnableCustomFieldsOption */], {
    label: Object(external_mt_i18n_["__"])('Custom fields')
  }), Object(external_lodash_["map"])(thirdPartyMetaBoxes, function (_ref3) {
    var id = _ref3.id,
        title = _ref3.title;
    return Object(external_mt_element_["createElement"])(options["c" /* EnablePanelOption */], {
      key: id,
      label: title,
...
/* harmony default export */ var meta_boxes_section = (Object(external_mt_data_["withSelect"])(function (select) {
...
function PreferencesModal() {
  var isLargeViemtort = Object(external_mt_compose_["useViemtortMatch"])('medium');

  var _useDispatch = Object(external_mt_data_["useDispatch"])(store["a" /* store */]),
      closeModal = _useDispatch.closeModal;

  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    var _select = select(external_mt_editor_["store"]),
        getEditedPostAttribute = _select.getEditedPostAttribute;

    var _select2 = select(external_mt_coreData_["store"]),
  ...
  var showBlockBreadcrumbsOption = Object(external_mt_data_["useSelect"])(function (select) {
    var _select3 = select(external_mt_editor_["store"]),
    ...
    return !hasReducedUI && isLargeViemtort && isRichEditingEnabled && mode === 'visual';
  }, [isLargeViemtort]);
  var sections = Object(external_mt_element_["useMemo"])(function () {
    return [{
      name: 'general',
      tabLabel: Object(external_mt_i18n_["__"])('General'),
      content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, isLargeViemtort && Object(external_mt_element_["createElement"])(preferences_modal_section, {
        title: Object(external_mt_i18n_["__"])('Choose your own experience')
      }, Object(external_mt_element_["createElement"])(options["e" /* EnablePublishSidebarOption */], {
        help: Object(external_mt_i18n_["__"])('Review settings such as categories and tags.'),
        label: Object(external_mt_i18n_["__"])('Include pre-publish checklist')
      })), Object(external_mt_element_["createElement"])(preferences_modal_section, {
        title: Object(external_mt_i18n_["__"])('Decide what to focus on')
      }, Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "reducedUI",
        help: Object(external_mt_i18n_["__"])('Compacts options and outlines in the toolbar.'),
        label: Object(external_mt_i18n_["__"])('Reduce the interface')
      }), Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "focusMode",
        help: Object(external_mt_i18n_["__"])('Highlights the current block and fades other content.'),
        label: Object(external_mt_i18n_["__"])('Spotlight mode')
      }), showBlockBreadcrumbsOption && Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "showBlockBreadcrumbs",
        help: Object(external_mt_i18n_["__"])('Shows block breadcrumbs at the bottom of the editor.'),
        label: Object(external_mt_i18n_["__"])('Display block breadcrumbs')
      })))
    }, {
      name: 'appearance',
      tabLabel: Object(external_mt_i18n_["__"])('Appearance'),
      content: Object(external_mt_element_["createElement"])(preferences_modal_section, {
        title: Object(external_mt_i18n_["__"])('Choose the way it looks')
      }, Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "showIconLabels",
        help: Object(external_mt_i18n_["__"])('Shows text instead of icons in toolbar.'),
        label: Object(external_mt_i18n_["__"])('Display button labels')
      }), Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "themeStyles",
        help: Object(external_mt_i18n_["__"])('Make the editor look like your theme.'),
        label: Object(external_mt_i18n_["__"])('Use theme styles')
      }))
    }, {
      name: 'blocks',
      tabLabel: Object(external_mt_i18n_["__"])('Blocks'),
      content: Object(external_mt_element_["createElement"])(preferences_modal_section, {
        title: Object(external_mt_i18n_["__"])('Choose how you interact with blocks')
      }, Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "mostUsedBlocks",
        help: Object(external_mt_i18n_["__"])('Places the most frequent blocks in the block library.'),
        label: Object(external_mt_i18n_["__"])('Show most used blocks')
      }), Object(external_mt_element_["createElement"])(options["b" /* EnableFeature */], {
        featureName: "keepCaretInsideBlock",
        help: Object(external_mt_i18n_["__"])('Aids screen readers by stopping text caret from leaving blocks.'),
        label: Object(external_mt_i18n_["__"])('Contain text cursor inside block')
      }))
    }, {
      name: 'panels',
      tabLabel: Object(external_mt_i18n_["__"])('Panels'),
      content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(preferences_modal_section, {
        title: Object(external_mt_i18n_["__"])('Document settings'),
        description: Object(external_mt_i18n_["__"])('Choose what displays in the panel.')
      }, Object(external_mt_element_["createElement"])(options["d" /* EnablePluginDocumentSettingPanelOption */].Slot, null), isViewable && Object(external_mt_element_["createElement"])(options["c" /* EnablePanelOption */], {
        label: Object(external_mt_i18n_["__"])('Permalink'),
        panelName: "post-link"
      }), Object(external_mt_element_["createElement"])(external_mt_editor_["PostTaxonomies"], {
      ...
      }), Object(external_mt_element_["createElement"])(external_mt_editor_["PostFeaturedImageCheck"], null, Object(external_mt_element_["createElement"])(options["c" /* EnablePanelOption */], {
        label: Object(external_mt_i18n_["__"])('Featured image'),
        panelName: "featured-image"
      })), Object(external_mt_element_["createElement"])(external_mt_editor_["PostExcerptCheck"], null, Object(external_mt_element_["createElement"])(options["c" /* EnablePanelOption */], {
        label: Object(external_mt_i18n_["__"])('Excerpt'),
        panelName: "post-excerpt"
      })), Object(external_mt_element_["createElement"])(external_mt_editor_["PostTypeSupportCheck"], {
        supportKeys: ['comments', 'trackbacks']
      }, Object(external_mt_element_["createElement"])(options["c" /* EnablePanelOption */], {
        label: Object(external_mt_i18n_["__"])('Discussion'),
        panelName: "discussion-panel"
      })), Object(external_mt_element_["createElement"])(external_mt_editor_["PageAttributesCheck"], null, Object(external_mt_element_["createElement"])(options["c" /* EnablePanelOption */], {
        label: Object(external_mt_i18n_["__"])('Page attributes'),
        panelName: "page-attributes"
      }))), Object(external_mt_element_["createElement"])(preferences_modal_section, {
        title: Object(external_mt_i18n_["__"])('Additional'),
        description: Object(external_mt_i18n_["__"])('Add extra areas to the editor.')
      }, Object(external_mt_element_["createElement"])(meta_boxes_section, null)))
    }];
  }, [isViewable, isLargeViemtort, showBlockBreadcrumbsOption]); // This is also used to sync the two different rendered components
  // between small and large viemtorts.

  var _useState = Object(external_mt_element_["useState"])(PREFERENCES_MENU),
  ...
  var _useMemo = Object(external_mt_element_["useMemo"])(function () {
  ...
  var getCurrentTab = Object(external_mt_element_["useCallback"])(function (tab) {
  ...
  var modalContent; // We render different components based on the viemtort size.

  if (isLargeViemtort) {
    modalContent = Object(external_mt_element_["createElement"])(external_mt_components_["TabPanel"], {
    ...
    modalContent = Object(external_mt_element_["createElement"])(external_mt_components_["__experimentalNavigation"], {
      activeMenu: activeMenu,
      onActivateMenu: setActiveMenu
    }, Object(external_mt_element_["createElement"])(external_mt_components_["__experimentalNavigationMenu"], {
      menu: PREFERENCES_MENU
    }, tabs.map(function (tab) {
      return Object(external_mt_element_["createElement"])(external_mt_components_["__experimentalNavigationItem"], {
        key: tab.name,
        title: tab.title,
        navigateToMenu: tab.name
      });
    })), sections.map(function (section) {
      return Object(external_mt_element_["createElement"])(external_mt_components_["__experimentalNavigationMenu"], {
        key: "".concat(section.name, "-menu"),
        menu: section.name,
        title: section.tabLabel,
        parentMenu: PREFERENCES_MENU
      }, Object(external_mt_element_["createElement"])(external_mt_components_["__experimentalNavigationItem"], null, section.content));
    }));
  }

  return Object(external_mt_element_["createElement"])(external_mt_components_["Modal"], {
    className: "edit-post-preferences-modal",
    title: Object(external_mt_i18n_["__"])('Preferences'),
    closeLabel: Object(external_mt_i18n_["__"])('Close'),
    onRequestClose: closeModal
  }, modalContent);
}
...
function getPostEditURL(postId) {
  return Object(external_mt_url_["addQueryArgs"])('post.php', {
    post: postId,
    action: 'edit'
  });
}
...
function getPostTrashedURL(postId, postType) {
  return Object(external_mt_url_["addQueryArgs"])('edit.php', {
    trashed: 1,
    post_type: postType,
    ids: postId
  });
...
/* harmony default export */ var browser_url = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
  ...
  var id = post.id,
      status = post.status,
      type = post.type;
  var isTemplate = ['mt_template', 'mt_template_part'].includes(type);
...
function FullscreenModeClose(_ref) {
  ...
  if (siteIconUrl) {
    buttonIcon = Object(external_mt_element_["createElement"])("img", {
      alt: Object(external_mt_i18n_["__"])('Site Icon'),
  ...
  if (icon) {
    buttonIcon = Object(external_mt_element_["createElement"])(external_mt_components_["Icon"], {
      size: "36px",
      icon: icon
    });
  }

  return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    className: "edit-post-fullscreen-mode-close has-icon",
    href: href !== null && href !== void 0 ? href : Object(external_mt_url_["addQueryArgs"])('edit.php', {
      post_type: postType.slug
    }),
    label: Object(external_lodash_["get"])(postType, ['labels', 'view_items'], Object(external_mt_i18n_["__"])('Back')),
...
function TemplateTitle() {
  ...
  return Object(external_mt_element_["createElement"])("span", {
    className: "edit-post-template-title"
  },
  /* translators: 1: Template name. */
  Object(external_mt_i18n_["sprintf"])(Object(external_mt_i18n_["__"])('Editing template: %s'), template.slug));
}
...
function HeaderToolbar() {
  var inserterButton = Object(external_mt_element_["useRef"])();
  ...
  var isLargeViemtort = Object(external_mt_compose_["useViemtortMatch"])('medium');
  var isWideViemtort = Object(external_mt_compose_["useViemtortMatch"])('wide');
  var isSmallViemtort = Object(external_mt_compose_["useViemtortMatch"])('small', '<');

  var _useDispatch2 = Object(external_mt_data_["useDispatch"])('core/block-editor'),
      setNavigationMode = _useDispatch2.setNavigationMode;

  var displayBlockToolbar = !isLargeViemtort || previewDeviceType !== 'Desktop' || hasFixedToolbar;
  var toolbarAriaLabel = displayBlockToolbar ?
  /* translators: accessibility text for the editor toolbar when Top Toolbar is on */
  Object(external_mt_i18n_["__"])('Document and block tools') :
  /* translators: accessibility text for the editor toolbar when Top Toolbar is off */
  Object(external_mt_i18n_["__"])('Document tools');

  var onSwitchMode = function onSwitchMode(mode) {
    setNavigationMode(mode === 'edit' ? false : true);
  };

  var overflowItems = Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["ToolbarItem"], {
    as: external_mt_editor_["TableOfContents"],
    hasOutlineItemsDisabled: isTextModeEnabled,
    repositionDropdown: showIconLabels && !isWideViemtort,
    showTooltip: !showIconLabels,
    isTertiary: showIconLabels
  }), Object(external_mt_element_["createElement"])(external_mt_components_["ToolbarItem"], {
    as: external_mt_blockEditor_["BlockNavigationDropdown"],
    isDisabled: isTextModeEnabled,
    showTooltip: !showIconLabels,
    isTertiary: showIconLabels
  }));
  return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["NavigableToolbar"], {
    ...
    ref: inserterButton,
    as: external_mt_components_["Button"],
    ...
    characters. */
    ,
    label: Object(external_mt_i18n_["_x"])('Add block', 'Generic label for block inserter button'),
    showTooltip: !showIconLabels
  }, showIconLabels && Object(external_mt_i18n_["__"])('Add')), (isWideViemtort || !showIconLabels) && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, isLargeViemtort && Object(external_mt_element_["createElement"])(external_mt_components_["ToolbarItem"], {
    as: external_mt_blockEditor_["ToolSelector"],
    showTooltip: !showIconLabels,
    isTertiary: showIconLabels,
    disabled: isTextModeEnabled
  }), Object(external_mt_element_["createElement"])(external_mt_components_["ToolbarItem"], {
    as: external_mt_editor_["EditorHistoryUndo"],
    showTooltip: !showIconLabels,
    isTertiary: showIconLabels
  }), Object(external_mt_element_["createElement"])(external_mt_components_["ToolbarItem"], {
    as: external_mt_editor_["EditorHistoryRedo"],
    showTooltip: !showIconLabels,
    isTertiary: showIconLabels
  }), overflowItems), !isWideViemtort && !isSmallViemtort && showIconLabels && Object(external_mt_element_["createElement"])(external_mt_components_["DropdownMenu"], {
    position: "bottom right",
    label:
    /* translators: button label text should, if possible, be under 16
    characters. */
    Object(external_mt_i18n_["__"])('Tools')
  }, function () {
    return Object(external_mt_element_["createElement"])("div", {
      className: "edit-post-header__dropdown"
    }, Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], {
      label: Object(external_mt_i18n_["__"])('Modes')
    }, Object(external_mt_element_["createElement"])(external_mt_components_["MenuItemsChoice"], {
      value: isNavigationTool ? 'select' : 'edit',
      onSelect: onSwitchMode,
      choices: [{
        value: 'edit',
        label: Object(external_mt_i18n_["__"])('Edit')
      }, {
        value: 'select',
        label: Object(external_mt_i18n_["__"])('Select')
      }]
    })), Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], {
      label: Object(external_mt_i18n_["__"])('Edit')
    }, Object(external_mt_element_["createElement"])(external_mt_editor_["EditorHistoryUndo"], {
      showTooltip: !showIconLabels,
      isTertiary: showIconLabels
    }), Object(external_mt_element_["createElement"])(external_mt_editor_["EditorHistoryRedo"], {
      showTooltip: !showIconLabels,
      isTertiary: showIconLabels
    })), Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], null, overflowItems));
  })), Object(external_mt_element_["createElement"])(template_title, null), displayBlockToolbar && Object(external_mt_element_["createElement"])("div", {
    className: classnames_default()('edit-post-header-toolbar__block-toolbar', {
      'is-pushed-down': isTemplateMode
    })
  }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockToolbar"], {
    hideDragHandle: true
  })));
}
...
var MODES = [{
  value: 'visual',
  label: Object(external_mt_i18n_["__"])('Visual editor')
}, {
  value: 'text',
  label: Object(external_mt_i18n_["__"])('Code editor')
}];

function ModeSwitcher() {
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    return {
      shortcut: select(external_mt_keyboardShortcuts_["store"]).getShortcutRepresentation('core/edit-post/toggle-mode'),
      isRichEditingEnabled: select('core/editor').getEditorSettings().richEditingEnabled,
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], {
    label: Object(external_mt_i18n_["__"])('Editor')
  }, Object(external_mt_element_["createElement"])(external_mt_components_["MenuItemsChoice"], {
    choices: choices,
    value: mode,
...
function FeatureToggle(_ref) {
  ...
  var speakMessage = function speakMessage() {
    if (isActive) {
      Object(external_mt_a11y_["speak"])(messageDeactivated || Object(external_mt_i18n_["__"])('Feature deactivated'));
    } else {
      Object(external_mt_a11y_["speak"])(messageActivated || Object(external_mt_i18n_["__"])('Feature activated'));
    }
  };
...
/* harmony default export */ var feature_toggle = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select, _ref2) {
...
function WritingMenu() {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], {
    label: Object(external_mt_i18n_["_x"])('View', 'noun')
  }, Object(external_mt_element_["createElement"])(feature_toggle, {
    feature: "fixedToolbar",
    label: Object(external_mt_i18n_["__"])('Top toolbar'),
    info: Object(external_mt_i18n_["__"])('Access all block and document tools in a single place'),
    messageActivated: Object(external_mt_i18n_["__"])('Top toolbar activated'),
    messageDeactivated: Object(external_mt_i18n_["__"])('Top toolbar deactivated')
  }), Object(external_mt_element_["createElement"])(feature_toggle, {
    feature: "focusMode",
    label: Object(external_mt_i18n_["__"])('Spotlight mode'),
    info: Object(external_mt_i18n_["__"])('Focus on one block at a time'),
    messageActivated: Object(external_mt_i18n_["__"])('Spotlight mode activated'),
    messageDeactivated: Object(external_mt_i18n_["__"])('Spotlight mode deactivated')
  }), Object(external_mt_element_["createElement"])(feature_toggle, {
    feature: "fullscreenMode",
    label: Object(external_mt_i18n_["__"])('Fullscreen mode'),
    info: Object(external_mt_i18n_["__"])('Work without distraction'),
    messageActivated: Object(external_mt_i18n_["__"])('Fullscreen mode activated'),
    messageDeactivated: Object(external_mt_i18n_["__"])('Fullscreen mode deactivated'),
    shortcut: external_mt_keycodes_["displayShortcut"].secondary('f')
  }));
}
...
var more_menu_MoreMenu = function MoreMenu(_ref) {
  ...
  var isLargeViemtort = Object(external_mt_compose_["useViemtortMatch"])('large');
  return Object(external_mt_element_["createElement"])(external_mt_components_["DropdownMenu"], {
    className: "edit-post-more-menu",
    icon: more_vertical["a" /* default */]
    /* translators: button label text should, if possible, be under 16 characters. */
    ,
    label: Object(external_mt_i18n_["__"])('Options'),
    ...
    var onClose = _ref2.onClose;
    return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, showIconLabels && !isLargeViemtort && Object(external_mt_element_["createElement"])(build_module["f" /* PinnedItems */].Slot, {
      className: showIconLabels && 'show-icon-labels',
      scope: "core/edit-post"
    }), Object(external_mt_element_["createElement"])(writing_menu, null), Object(external_mt_element_["createElement"])(mode_switcher, null), Object(external_mt_element_["createElement"])(build_module["a" /* ActionItem */].Slot, {
      name: "core/edit-post/plugin-more-menu",
      label: Object(external_mt_i18n_["__"])('Plugins'),
      as: [external_mt_components_["MenuGroup"], external_mt_components_["MenuItem"]],
      fillProps: {
        onClick: onClose
      }
    }), Object(external_mt_element_["createElement"])(tools_more_menu_group.Slot, {
      fillProps: {
        onClose: onClose
      }
    }), Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], null, Object(external_mt_element_["createElement"])(PreferencesMenuItem, null)));
  });
};
...
function PostPublishButtonOrToggle(_ref) {
  ...
  var isSmallerThanMediumViemtort = Object(external_mt_compose_["useViemtortMatch"])('medium', '<');
  var component;
  /**
   ...
   * - is pending and can't be published (but only for viemtorts >= medium).
   * 	 Originally, we considered showing a button for pending posts that couldn't be published
   * 	 (for example, for an author with the contributor role). Some languages can have
   * 	 long translations for "Submit for review", so given the lack of UI real estate available
   * 	 we decided to take into account the viemtort in that case.
   *  	 See: https://github.com/paCMec/gutenberg/issues/10475
   *
   * 2) Then, in small viemtorts, we'll show a TOGGLE.
   *
  ...
  if (isPublished || isScheduled && isBeingScheduled || isPending && !hasPublishAction && !isSmallerThanMediumViemtort) {
    component = IS_BUTTON;
  } else if (isSmallerThanMediumViemtort) {
    component = IS_TOGGLE;
  ...
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostPublishButton"], {
...
/* harmony default export */ var post_publish_button_or_toggle = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  return {
    hasPublishAction: Object(external_lodash_["get"])(select('core/editor').getCurrentPost(), ['_links', 'mt:action-publish'], false),
...
function DevicePreview() {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["__experimentalPreviewOptions"], {
    isEnabled: isPostSaveable,
    className: "edit-post-post-preview-dropdown",
    deviceType: deviceType,
    setDeviceType: setPreviewDeviceType
  }, Object(external_mt_element_["createElement"])(external_mt_components_["MenuGroup"], null, Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-header-preview__grouping-external"
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostPreviewButton"], {
    className: 'edit-post-header-preview__button-external',
    role: "menuitem",
    forceIsAutosaveable: hasActiveMetaboxes,
    forcePreviewLink: isSaving ? null : undefined,
    textContent: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_i18n_["__"])('Preview in new tab'), Object(external_mt_element_["createElement"])(external_mt_components_["Icon"], {
      icon: external["a" /* default */]
    }))
  }))));
}
...
var main_dashboard_button_createSlotFill = Object(external_mt_components_["createSlotFill"])(slotName),
...
var main_dashboard_button_Slot = function Slot(_ref) {
  ...
  var slot = Object(external_mt_components_["__experimentalUseSlot"])(slotName);
  ...
  return Object(external_mt_element_["createElement"])(MainDashboardButtonSlot, {
...
var plugin_post_publish_panel_createSlotFill = Object(external_mt_components_["createSlotFill"])('PluginPostPublishPanel'),
...
var plugin_post_publish_panel_PluginPostPublishPanelFill = function PluginPostPublishPanelFill(_ref) {
  var children = _ref.children,
      ...
      icon = _ref.icon;
  return Object(external_mt_element_["createElement"])(plugin_post_publish_panel_Fill, null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    className: className,
 ...
 * // Using ES5 syntax
 * var __ = mt.i18n.__;
 * var PluginPostPublishPanel = mt.editPost.PluginPostPublishPanel;
 *
 * function MyPluginPostPublishPanel() {
 * 	return mt.element.createElement(
...
var PluginPostPublishPanel = Object(external_mt_compose_["compose"])(Object(external_mt_plugins_["withPluginContext"])(function (context, ownProps) {
  return {
    icon: ownProps.icon || context.icon
  };
...
var plugin_pre_publish_panel_createSlotFill = Object(external_mt_components_["createSlotFill"])('PluginPrePublishPanel'),
...
var plugin_pre_publish_panel_PluginPrePublishPanelFill = function PluginPrePublishPanelFill(_ref) {
  var children = _ref.children,
      ...
      initialOpen = _ref$initialOpen === void 0 ? false : _ref$initialOpen,
      icon = _ref.icon;
  return Object(external_mt_element_["createElement"])(plugin_pre_publish_panel_Fill, null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    className: className,
    initialOpen: initialOpen || !title,
    title: title,
    icon: icon
 ...
 * // Using ES5 syntax
 * var __ = mt.i18n.__;
 * var PluginPrePublishPanel = mt.editPost.PluginPrePublishPanel;
 *
...
var PluginPrePublishPanel = Object(external_mt_compose_["compose"])(Object(external_mt_plugins_["withPluginContext"])(function (context, ownProps) {
  return {
    icon: ownProps.icon || context.icon
  };
...
var actions_panel_createSlotFill = Object(external_mt_components_["createSlotFill"])('ActionsPanel'),
...
function ActionsPanel(_ref) {
  ...
  var openEntitiesSavedStates = Object(external_mt_element_["useCallback"])(function () {
  ...
  if (publishSidebarOpened) {
    unmountableContent = Object(external_mt_element_["createElement"])(external_mt_editor_["PostPublishPanel"], {
    ...
    unmountableContent = Object(external_mt_element_["createElement"])("div", {
      className: "edit-post-layout__toggle-entities-saved-states-panel"
    }, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
      isSecondary: true,
      className: "edit-post-layout__toggle-entities-saved-states-panel-button",
      onClick: openEntitiesSavedStates,
      "aria-expanded": false
    }, Object(external_mt_i18n_["__"])('Open save panel')));
  } else {
    unmountableContent = Object(external_mt_element_["createElement"])("div", {
      ...
      "aria-expanded": false
    }, Object(external_mt_i18n_["__"])('Open publish panel')));
  } // Since EntitiesSavedStates controls its own panel, we can keep it
  // always mounted to retain its own component state (such as checkboxes).


  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["EntitiesSavedStates"], {
    isOpen: isEntitiesSavedStatesOpen,
    close: closeEntitiesSavedStates
  }), Object(external_mt_element_["createElement"])(actions_panel_Slot, {
    bubblesVirtually: true
...
function TemplateSaveButton() {
  var _useState = Object(external_mt_element_["useState"])(false),
      _useState2 = Object(slicedToArray["a" /* default */])(_useState, 2),
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    onClick: function onClick() {
      return setIsEditingTemplate(false);
    },
    isTertiary: true
  }, Object(external_mt_i18n_["__"])('Cancel')), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    isPrimary: true,
    onClick: function onClick() {
      return setIsEntitiesReviewPanelOpen(true);
    },
    "aria-expanded": isEntitiesReviewPanelOpen
  }, Object(external_mt_i18n_["__"])('Apply')), Object(external_mt_element_["createElement"])(ActionsPanelFill, null, Object(external_mt_element_["createElement"])(external_mt_editor_["EntitiesSavedStates"], {
...
function Header(_ref) {
  ...
  return Object(external_mt_element_["createElement"])("div", {
    className: classes
  }, Object(external_mt_element_["createElement"])(main_dashboard_button.Slot, null, Object(external_mt_element_["createElement"])(fullscreen_mode_close, null)), Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-header__toolbar"
  }, Object(external_mt_element_["createElement"])(header_toolbar, null)), Object(external_mt_element_["createElement"])("div", {
    className: "edit-post-header__settings"
  }, !isEditingTemplate && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, !isPublishSidebarOpened && // This button isn't completely hidden by the publish sidebar.
  // We can't hide the whole toolbar when the publish sidebar is open because
  // we want to prevent mounting/unmounting the PostPublishButtonOrToggle DOM node.
  // We track that DOM node to return focus to the PostPublishButtonOrToggle
  // when the publish sidebar has been closed.
  Object(external_mt_element_["createElement"])(external_mt_editor_["PostSavedState"], {
    forceIsDirty: hasActiveMetaboxes,
    forceIsSaving: isSaving,
    showIconLabels: showIconLabels
  }), Object(external_mt_element_["createElement"])(DevicePreview, null), Object(external_mt_element_["createElement"])(external_mt_editor_["PostPreviewButton"], {
    forceIsAutosaveable: hasActiveMetaboxes,
    forcePreviewLink: isSaving ? null : undefined
  }), Object(external_mt_element_["createElement"])(post_publish_button_or_toggle, {
    forceIsDirty: hasActiveMetaboxes,
    forceIsSaving: isSaving,
    setEntitiesSavedStatesCallback: setEntitiesSavedStatesCallback
  })), isEditingTemplate && Object(external_mt_element_["createElement"])(template_save_button, null), (isLargeViemtort || !showIconLabels) && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(build_module["f" /* PinnedItems */].Slot, {
    scope: "core/edit-post"
  }), Object(external_mt_element_["createElement"])(more_menu, {
    showIconLabels: showIconLabels
  })), showIconLabels && !isLargeViemtort && Object(external_mt_element_["createElement"])(more_menu, {
    showIconLabels: showIconLabels
  })));
}
...
var cog = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
  fillRule: "evenodd",
...
var settings_header_SettingsHeader = function SettingsHeader(_ref) {
  ...
  var documentLabel = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    return (// Disable reason: Post type labels object is shaped like this.
      ...
      Object(external_mt_i18n_["__"])('Document')
    );
  });

  var _ref2 = sidebarName === 'edit-post/document' ? // translators: ARIA label for the Document sidebar tab, selected. %s: Document label.
  [Object(external_mt_i18n_["sprintf"])(Object(external_mt_i18n_["__"])('%s (selected)'), documentLabel), 'is-active'] : [documentLabel, ''],
  ...
  [Object(external_mt_i18n_["__"])('Block (selected)'), 'is-active'] : // translators: ARIA label for the Block Settings Sidebar tab, not selected.
  [Object(external_mt_i18n_["__"])('Block'), ''],
  ...
  return Object(external_mt_element_["createElement"])("ul", null, Object(external_mt_element_["createElement"])("li", null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    onClick: openDocumentSettings,
    className: "edit-post-sidebar__panel-tab ".concat(documentActiveClass),
    "aria-label": documentAriaLabel,
    "data-label": documentLabel
  }, documentLabel)), Object(external_mt_element_["createElement"])("li", null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    ...
    ,
    "data-label": Object(external_mt_i18n_["__"])('Block')
...
function PostVisibility() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostVisibilityCheck"], {
    render: function render(_ref) {
      var canEdit = _ref.canEdit;
      return Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], {
        className: "edit-post-post-visibility"
      }, Object(external_mt_element_["createElement"])("span", null, Object(external_mt_i18n_["__"])('Visibility')), !canEdit && Object(external_mt_element_["createElement"])("span", null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostVisibilityLabel"], null)), canEdit && Object(external_mt_element_["createElement"])(external_mt_components_["Dropdown"], {
        position: "bottom left",
        ...
        renderToggle: function renderToggle(_ref2) {
          ...
          return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
            ...
            onClick: onToggle,
            isTertiary: true
          }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostVisibilityLabel"], null));
        },
        renderContent: function renderContent() {
          return Object(external_mt_element_["createElement"])(external_mt_editor_["PostVisibility"], null);
        }
      }));
    }
  });
...
function PostSchedule() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostScheduleCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], {
    className: "edit-post-post-schedule"
  }, Object(external_mt_element_["createElement"])("span", null, Object(external_mt_i18n_["__"])('Publish')), Object(external_mt_element_["createElement"])(external_mt_components_["Dropdown"], {
    position: "bottom left",
    ...
    renderToggle: function renderToggle(_ref) {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        ...
        "aria-expanded": isOpen,
        isTertiary: true
      }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostScheduleLabel"], null)));
    },
    renderContent: function renderContent() {
      return Object(external_mt_element_["createElement"])(external_mt_editor_["PostSchedule"], null);
    }
  })));
}
...
function PostSticky() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostStickyCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostSticky"], null)));
}
...
function PostAuthor() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostAuthorCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostAuthor"], null)));
}
...
function PostSlug() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostSlugCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostSlug"], null)));
}
...
function PostFormat() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostFormatCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostFormat"], null)));
}
...
function PostPendingStatus() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostPendingStatusCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostPendingStatus"], null)));
}
...
var plugin_post_status_info_createSlotFill = Object(external_mt_components_["createSlotFill"])('PluginPostStatusInfo'),
 ...
 * @param {Object}    props             Component properties.
 * @param {string}    [props.className] An optional class name added to the row.
 * @param {MTElement} props.children    Children to be rendered.
 *
 * @example
 * <caption>ES5</caption>
 * ```js
 * // Using ES5 syntax
 * var __ = mt.i18n.__;
 * var PluginPostStatusInfo = mt.editPost.PluginPostStatusInfo;
 *
...
var plugin_post_status_info_PluginPostStatusInfo = function PluginPostStatusInfo(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return Object(external_mt_element_["createElement"])(plugin_post_status_info_Fill, null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], {
    className: className
  }, children));
};
...
function PostTemplate() {
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    var link = getEditedPostAttribute('link');
    var isFSEEnabled = select(external_mt_editor_["store"]).getEditorSettings().isFSETheme;
  ...
  var _useDispatch2 = Object(external_mt_data_["useDispatch"])(external_mt_notices_["store"]),
  ...
  }, Object(external_mt_element_["createElement"])("span", null, Object(external_mt_i18n_["__"])('Template')), !isEditing && Object(external_mt_element_["createElement"])("span", {
    className: "edit-post-post-template__value"
  }, Object(external_mt_element_["createInterpolateElement"])(Object(external_mt_i18n_["sprintf"])(
  /* translators: 1: Template name. */
  Object(external_mt_i18n_["__"])('%s (<a>Edit</a>)'), template.slug), {
    a: Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
      isLink: true,
      onClick: function onClick() {
        setIsEditingTemplate(true);
        createSuccessNotice(Object(external_mt_i18n_["__"])('Editing template. Changes made here affect all posts and pages that use the template.'), {
          type: 'snackbar'
        });
      }
    }, Object(external_mt_i18n_["__"])('Edit'))
  })), isEditing && Object(external_mt_element_["createElement"])("span", {
    className: "edit-post-post-template__value"
  }, template.slug));
}
...
function PostStatus(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    className: "edit-post-post-status",
    title: Object(external_mt_i18n_["__"])('Status & visibility'),
    opened: isOpened,
    onToggle: onTogglePanel
  }, Object(external_mt_element_["createElement"])(plugin_post_status_info.Slot, null, function (fills) {
    return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(post_template, null), Object(external_mt_element_["createElement"])(post_visibility, null), Object(external_mt_element_["createElement"])(post_schedule, null), Object(external_mt_element_["createElement"])(post_format, null), Object(external_mt_element_["createElement"])(post_sticky, null), Object(external_mt_element_["createElement"])(post_pending_status, null), Object(external_mt_element_["createElement"])(post_slug, null), Object(external_mt_element_["createElement"])(post_author, null), fills, Object(external_mt_element_["createElement"])(PostTrash, null));
  }));
}

/* harmony default export */ var post_status = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
...
function LastRevision() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostLastRevisionCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    className: "edit-post-last-revision__panel"
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostLastRevision"], null)));
}
...
/* harmony default export */ var taxonomy_panel = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select, ownProps) {
...
function PostTaxonomies() {
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostTaxonomiesCheck"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostTaxonomies"], {
    taxonomyWrapper: function taxonomyWrapper(content, taxonomy) {
      return Object(external_mt_element_["createElement"])(taxonomy_panel, {
        taxonomy: taxonomy
      }, content);
    }
  }));
...
function FeaturedImage(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostFeaturedImageCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    title: Object(external_lodash_["get"])(postType, ['labels', 'featured_image'], Object(external_mt_i18n_["__"])('Featured image')),
    opened: isOpened,
    onToggle: onTogglePanel
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostFeaturedImage"], null)));
}

var applyWithSelect = Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getEditedPostAttribute = _select.getEditedPostAttribute;
...
var applyWithDispatch = Object(external_mt_data_["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch(store["a" /* store */]),
...
function PostExcerpt(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostExcerptCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    title: Object(external_mt_i18n_["__"])('Excerpt'),
    opened: isOpened,
    onToggle: onTogglePanel
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostExcerpt"], null)));
}

/* harmony default export */ var post_excerpt = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
function PostLink(_ref) {
  ...
  if (isEditable) {
    prefixElement = permalinkPrefix && Object(external_mt_element_["createElement"])("span", {
      className: "edit-post-post-link__link-prefix"
    }, permalinkPrefix);
    postNameElement = postSlug && Object(external_mt_element_["createElement"])("span", {
      className: "edit-post-post-link__link-post-name"
    }, postSlug);
    suffixElement = permalinkSuffix && Object(external_mt_element_["createElement"])("span", {
      className: "edit-post-post-link__link-suffix"
    }, permalinkSuffix);
  }

  return Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    title: Object(external_mt_i18n_["__"])('Permalink'),
    opened: isOpened,
    onToggle: onTogglePanel
  }, isEditable && Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-link"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["TextControl"], {
    label: Object(external_mt_i18n_["__"])('URL Slug'),
    ...
    onBlur: function onBlur(event) {
      editPermalink(Object(external_mt_editor_["cleanForSlug"])(event.target.value));
    ...
    href: postLink,
    target: "_blank"
  }, isEditable ? Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, prefixElement, postNameElement, suffixElement) : postLink)));
}

/* harmony default export */ var post_link = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
  ...
  return {
    ...
    isViewable: Object(external_lodash_["get"])(postType, ['viewable'], false),
    postSlug: Object(external_mt_url_["safeDecodeURIComponent"])(getEditedPostSlug()),
...
}), Object(external_mt_compose_["withState"])({
  forceEmptyField: false
})])(PostLink));
...
function DiscussionPanel(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PostTypeSupportCheck"], {
    supportKeys: ['comments', 'trackbacks']
  }, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    title: Object(external_mt_i18n_["__"])('Discussion'),
    opened: isOpened,
    onToggle: onTogglePanel
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PostTypeSupportCheck"], {
    supportKeys: "comments"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostComments"], null))), Object(external_mt_element_["createElement"])(external_mt_editor_["PostTypeSupportCheck"], {
    supportKeys: "trackbacks"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PostPingbacks"], null)))));
}

/* harmony default export */ var discussion_panel = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
function PageAttributes(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_editor_["PageAttributesCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    title: Object(external_lodash_["get"])(postType, ['labels', 'attributes'], Object(external_mt_i18n_["__"])('Page attributes')),
    opened: isOpened,
    onToggle: onTogglePanel
  }, Object(external_mt_element_["createElement"])(external_mt_editor_["PageTemplate"], null), Object(external_mt_element_["createElement"])(external_mt_editor_["PageAttributesParent"], null), Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["PageAttributesOrder"], null))));
}
var page_attributes_applyWithSelect = Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getEditedPostAttribute = _select.getEditedPostAttribute;
...
var page_attributes_applyWithDispatch = Object(external_mt_data_["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch(store["a" /* store */]),
      toggleEditorPanelOpened = _dispatch.toggleEditorPanelOpened;
...
/* harmony default export */ var page_attributes = (Object(external_mt_compose_["compose"])(page_attributes_applyWithSelect, page_attributes_applyWithDispatch)(PageAttributes));
...
var meta_boxes_area_MetaBoxesArea = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(MetaBoxesArea, [{
    ...
    value: function render() {
      ...
      return Object(external_mt_element_["createElement"])("div", {
        className: classes
      }, isSaving && Object(external_mt_element_["createElement"])(external_mt_components_["Spinner"], null), Object(external_mt_element_["createElement"])("div", {
...
/* harmony default export */ var meta_boxes_area = (Object(external_mt_data_["withSelect"])(function (select) {
  return {
    isSaving: select(store["a" /* store */]).isSavingMetaBoxes()
  };
...
/* harmony default export */ var meta_box_visibility = (Object(external_mt_data_["withSelect"])(function (select, _ref) {
  var id = _ref.id;
  return {
...
function MetaBoxes(_ref) {
  var location = _ref.location,
      ...
      metaBoxes = _ref.metaBoxes;
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_lodash_["map"])(metaBoxes, function (_ref2) {
    var id = _ref2.id;
    return Object(external_mt_element_["createElement"])(meta_box_visibility, {
      key: id,
      id: id
    });
  }), isVisible && Object(external_mt_element_["createElement"])(meta_boxes_area, {
    location: location
  }));
}

/* harmony default export */ var meta_boxes = (Object(external_mt_data_["withSelect"])(function (select, _ref3) {
 ...
 * If you wish to display the sidebar, you can with use the `PluginSidebarMoreMenuItem` component or the `mt.data.dispatch` API:
 *
 * ```js
 * mt.data.dispatch( 'core/edit-post' ).openGeneralSidebar( 'plugin-name/sidebar-name' );
 * ```
 *
 ...
 * var __ = mt.i18n.__;
 * var el = mt.element.createElement;
 * var PanelBody = mt.components.PanelBody;
 * var PluginSidebar = mt.editPost.PluginSidebar;
 * var moreIcon = mt.element.createElement( 'svg' ); //... svg element.
 *
...
function PluginSidebarEditPost(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(build_module["b" /* ComplementaryArea */], Object(esm_extends["a" /* default */])({
    panelClassName: className,
    className: "edit-post-sidebar",
    smallScreenTitle: postTitle || Object(external_mt_i18n_["__"])('(no title)'),
    scope: "core/edit-post",
...
var SIDEBAR_ACTIVE_BY_DEFAULT = external_mt_element_["Platform"].select({
  web: true,
  native: false
});
...
var settings_sidebar_SettingsSidebar = function SettingsSidebar() {
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    var shortcut = select(external_mt_keyboardShortcuts_["store"]).getShortcutRepresentation('core/edit-post/toggle-sidebar');
    return {
      sidebarName: sidebar,
  ...
  return Object(external_mt_element_["createElement"])(PluginSidebarEditPost, {
    identifier: sidebarName,
    header: Object(external_mt_element_["createElement"])(settings_header, {
      sidebarName: sidebarName
    }),
    closeLabel: Object(external_mt_i18n_["__"])('Close settings'),
    headerClassName: "edit-post-sidebar__panel-tabs"
    /* translators: button label text should, if possible, be under 16 characters. */
    ,
    title: Object(external_mt_i18n_["__"])('Settings'),
    toggleShortcut: keyboardShortcut,
    icon: library_cog,
    isActiveByDefault: SIDEBAR_ACTIVE_BY_DEFAULT
  }, sidebarName === 'edit-post/document' && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(post_status, null), Object(external_mt_element_["createElement"])(plugin_document_setting_panel["a" /* default */].Slot, null), Object(external_mt_element_["createElement"])(last_revision, null), Object(external_mt_element_["createElement"])(post_link, null), Object(external_mt_element_["createElement"])(post_taxonomies, null), Object(external_mt_element_["createElement"])(featured_image, null), Object(external_mt_element_["createElement"])(post_excerpt, null), Object(external_mt_element_["createElement"])(discussion_panel, null), Object(external_mt_element_["createElement"])(page_attributes, null), Object(external_mt_element_["createElement"])(meta_boxes, {
    location: "side"
  })), sidebarName === 'edit-post/block' && Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockInspector"], null));
};
...
var images_InserterIconImage = function InserterIconImage(props) {
  return Object(external_mt_element_["createElement"])("img", Object(esm_extends["a" /* default */])({
    alt: Object(external_mt_i18n_["__"])('inserter'),
...
function WelcomeGuide() {
  var isActive = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Guide"], {
    className: "edit-post-welcome-guide",
    contentLabel: Object(external_mt_i18n_["__"])('Welcome to the block editor'),
    finishButtonText: Object(external_mt_i18n_["__"])('Get started'),
    onFinish: function onFinish() {
      return toggleFeature('welcomeGuide');
    },
    pages: [{
      image: Object(external_mt_element_["createElement"])(images_CanvasImage, null),
      content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("h1", {
        className: "edit-post-welcome-guide__heading"
      }, Object(external_mt_i18n_["__"])('Welcome to the block editor')), Object(external_mt_element_["createElement"])("p", {
        className: "edit-post-welcome-guide__text"
      }, Object(external_mt_i18n_["__"])('In the paCMec editor, each paragraph, image, or video is presented as a distinct “block” of content.')))
    }, {
      image: Object(external_mt_element_["createElement"])(images_EditorImage, null),
      content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("h1", {
        className: "edit-post-welcome-guide__heading"
      }, Object(external_mt_i18n_["__"])('Make each block your own')), Object(external_mt_element_["createElement"])("p", {
        className: "edit-post-welcome-guide__text"
      }, Object(external_mt_i18n_["__"])('Each block comes with its own set of controls for changing things like color, width, and alignment. These will show and hide automatically when you have a block selected.')))
    }, {
      image: Object(external_mt_element_["createElement"])(images_BlockLibraryImage, null),
      content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("h1", {
        className: "edit-post-welcome-guide__heading"
      }, Object(external_mt_i18n_["__"])('Get to know the block library')), Object(external_mt_element_["createElement"])("p", {
        className: "edit-post-welcome-guide__text"
      }, Object(external_mt_element_["createInterpolateElement"])(Object(external_mt_i18n_["__"])('All of the blocks available to you live in the block library. You’ll find it wherever you see the <InserterIconImage /> icon.'), {
        InserterIconImage: Object(external_mt_element_["createElement"])(images_InserterIconImage, {
          className: "edit-post-welcome-guide__inserter-icon"
        })
      })))
    }, {
      image: Object(external_mt_element_["createElement"])(images_DocumentationImage, null),
      content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("h1", {
        className: "edit-post-welcome-guide__heading"
...
var interfaceLabels = {
  secondarySidebar: Object(external_mt_i18n_["__"])('Block library'),

  /* translators: accessibility text for the editor top bar landmark region. */
  header: Object(external_mt_i18n_["__"])('Editor top bar'),

  /* translators: accessibility text for the editor content landmark region. */
  body: Object(external_mt_i18n_["__"])('Editor content'),

  /* translators: accessibility text for the editor settings landmark region. */
  sidebar: Object(external_mt_i18n_["__"])('Editor settings'),

  /* translators: accessibility text for the editor publish landmark region. */
  actions: Object(external_mt_i18n_["__"])('Editor publish'),

  /* translators: accessibility text for the editor footer landmark region. */
  footer: Object(external_mt_i18n_["__"])('Editor footer')
};

function Layout(_ref) {
  var styles = _ref.styles;
  var isMobileViemtort = Object(external_mt_compose_["useViemtortMatch"])('medium', '<');
  var isHugeViemtort = Object(external_mt_compose_["useViemtortMatch"])('huge', '>=');
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    return {
      ...
      isRichEditingEnabled: select('core/editor').getEditorSettings().richEditingEnabled,
      hasActiveMetaboxes: select(store["a" /* store */]).hasMetaBoxes(),
      previousShortcut: select(external_mt_keyboardShortcuts_["store"]).getAllShortcutRawKeyCombinations('core/edit-post/previous-region'),
      nextShortcut: select(external_mt_keyboardShortcuts_["store"]).getAllShortcutRawKeyCombinations('core/edit-post/next-region'),
      showIconLabels: select(store["a" /* store */]).isFeatureActive('showIconLabels'),
      hasReducedUI: select(store["a" /* store */]).isFeatureActive('reducedUI'),
  ...
  Object(external_mt_element_["useEffect"])(function () {
    if (sidebarIsOpened && !isHugeViemtort) {
      setIsInserterOpened(false);
    }
  }, [sidebarIsOpened, isHugeViemtort]);
  Object(external_mt_element_["useEffect"])(function () {
    if (isInserterOpened && !isHugeViemtort) {
      closeGeneralSidebar();
    }
  }, [isInserterOpened, isHugeViemtort]); // Local state for save panel.
  ...
  var closeEntitiesSavedStates = Object(external_mt_element_["useCallback"])(function (arg) {
  ...
  var ref = Object(external_mt_element_["useRef"])();
  Object(external_mt_components_["__unstableUseDrop"])(ref);

  var _useDialog = Object(external_mt_compose_["__experimentalUseDialog"])({
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(build_module["d" /* FullscreenMode */], {
    isActive: isFullscreenActive
  }), Object(external_mt_element_["createElement"])(browser_url, null), Object(external_mt_element_["createElement"])(external_mt_editor_["UnsavedChangesWarning"], null), Object(external_mt_element_["createElement"])(external_mt_editor_["AutosaveMonitor"], null), Object(external_mt_element_["createElement"])(external_mt_editor_["LocalAutosaveMonitor"], null), Object(external_mt_element_["createElement"])(keyboard_shortcuts, null), Object(external_mt_element_["createElement"])(external_mt_editor_["EditorKeyboardShortcutsRegister"], null), Object(external_mt_element_["createElement"])(settings_sidebar, null), Object(external_mt_element_["createElement"])(build_module["e" /* InterfaceSkeleton */], {
    ref: ref,
    className: className,
    labels: interfaceLabels,
    header: Object(external_mt_element_["createElement"])(header, {
      setEntitiesSavedStatesCallback: setEntitiesSavedStatesCallback
    }),
    secondarySidebar: mode === 'visual' && isInserterOpened && Object(external_mt_element_["createElement"])("div", Object(esm_extends["a" /* default */])({
    ...
    }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["__experimentalLibrary"], {
    ...
    sidebar: (!isMobileViemtort || sidebarIsOpened) && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, !isMobileViemtort && !sidebarIsOpened && Object(external_mt_element_["createElement"])("div", {
      ...
      "aria-expanded": false
    }, hasBlockSelected ? Object(external_mt_i18n_["__"])('Open block settings') : Object(external_mt_i18n_["__"])('Open document settings'))), Object(external_mt_element_["createElement"])(build_module["b" /* ComplementaryArea */].Slot, {
      scope: "core/edit-post"
    })),
    content: Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["EditorNotices"], null), (mode === 'text' || !isRichEditingEnabled) && Object(external_mt_element_["createElement"])(text_editor, null), isRichEditingEnabled && mode === 'visual' && Object(external_mt_element_["createElement"])(VisualEditor, {
      styles: styles
    }), Object(external_mt_element_["createElement"])("div", {
      className: "edit-post-layout__metaboxes"
    }, Object(external_mt_element_["createElement"])(meta_boxes, {
      location: "normal"
    }), Object(external_mt_element_["createElement"])(meta_boxes, {
      location: "advanced"
    })), isMobileViemtort && sidebarIsOpened && Object(external_mt_element_["createElement"])(external_mt_components_["ScrollLock"], null)),
    footer: !hasReducedUI && showBlockBreadcrumbs && !isMobileViemtort && isRichEditingEnabled && mode === 'visual' && Object(external_mt_element_["createElement"])("div", {
      className: "edit-post-layout__footer"
    }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockBreadcrumb"], null)),
    actions: Object(external_mt_element_["createElement"])(ActionsPanel, {
  ...
  }), Object(external_mt_element_["createElement"])(manage_blocks_modal, null), Object(external_mt_element_["createElement"])(PreferencesModal, null), Object(external_mt_element_["createElement"])(keyboard_shortcut_help_modal, null), Object(external_mt_element_["createElement"])(WelcomeGuide, null), Object(external_mt_element_["createElement"])(external_mt_components_["Popover"].Slot, null), Object(external_mt_element_["createElement"])(external_mt_plugins_["PluginArea"], null));
}
...
var listener_hooks_useBlockSelectionListener = function useBlockSelectionListener(postId) {
  ...
  var _useDispatch = Object(external_mt_data_["useDispatch"])(constants["a" /* STORE_NAME */]),
      openGeneralSidebar = _useDispatch.openGeneralSidebar;
...
var listener_hooks_useUpdatePostLinkListener = function useUpdatePostLinkListener(postId) {
  var _useSelect2 = Object(external_mt_data_["useSelect"])(function (select) {
    return {
  ...
  var nodeToUpdate = Object(external_mt_element_["useRef"])();
  Object(external_mt_element_["useEffect"])(function () {
...
function Editor(_ref) {
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    var _select4 = select(external_mt_blocks_["store"]),
        getBlockTypes = _select4.getBlockTypes;

    var isTemplate = ['mt_template', 'mt_template_part'].includes(postType); // Ideally the initializeEditor function should be called using the ID of the REST endpoint.
  ...
  var editorSettings = Object(external_mt_element_["useMemo"])(function () {
  ...
  var styles = Object(external_mt_element_["useMemo"])(function () {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["StrictMode"], null, Object(external_mt_element_["createElement"])(edit_post_settings.Provider, {
    value: settings
  }, Object(external_mt_element_["createElement"])(external_mt_components_["SlotFillProvider"], null, Object(external_mt_element_["createElement"])(external_mt_components_["__unstableDropZoneContextProvider"], null, Object(external_mt_element_["createElement"])(external_mt_editor_["EditorProvider"], Object(esm_extends["a" /* default */])({
    settings: editorSettings,
    post: post,
    initialEdits: initialEdits,
    useSubRegistry: false,
    __unstableTemplate: isTemplateMode ? template : undefined
  }, props), Object(external_mt_element_["createElement"])(external_mt_editor_["ErrorBoundary"], {
    onError: onError
  }, Object(external_mt_element_["createElement"])(EditorInitialization, {
    postId: postId
  }), Object(external_mt_element_["createElement"])(layout, {
    styles: styles
  }), Object(external_mt_element_["createElement"])(external_mt_components_["KeyboardShortcuts"], {
    shortcuts: prevent_event_discovery
  })), Object(external_mt_element_["createElement"])(external_mt_editor_["PostLockedModal"], null))))));
}
 ...
 * // Using ES5 syntax
 * var __ = mt.i18n.__;
 * var PluginBlockSettingsMenuItem = mt.editPost.PluginBlockSettingsMenuItem;
 *
 * function doOnClick(){
...
var plugin_block_settings_menu_item_PluginBlockSettingsMenuItem = function PluginBlockSettingsMenuItem(_ref) {
  var allowedBlocks = _ref.allowedBlocks,
      ...
      small = _ref.small,
      role = _ref.role;
  return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockSettingsMenuControls"], null, function (_ref2) {
    ...
    return Object(external_mt_element_["createElement"])(external_mt_components_["MenuItem"], {
      onClick: Object(external_mt_compose_["compose"])(onClick, onClose),
      icon: icon,
 ...
 * // Using ES5 syntax
 * var __ = mt.i18n.__;
 * var PluginMoreMenuItem = mt.editPost.PluginMoreMenuItem;
 * var moreIcon = mt.element.createElement( 'svg' ); //... svg element.
 *
...
/* harmony default export */ var plugin_more_menu_item = (Object(external_mt_compose_["compose"])(Object(external_mt_plugins_["withPluginContext"])(function (context, ownProps) {
  return {
    icon: ownProps.icon || context.icon,
    name: 'core/edit-post/plugin-more-menu'
  };
 ...
 * // Using ES5 syntax
 * var __ = mt.i18n.__;
 * var PluginSidebarMoreMenuItem = mt.editPost.PluginSidebarMoreMenuItem;
 * var moreIcon = mt.element.createElement( 'svg' ); //... svg element.
 *
...
function PluginSidebarMoreMenuItem(props) {
  return Object(external_mt_element_["createElement"])(build_module["c" /* ComplementaryAreaMoreMenuItem */], Object(esm_extends["a" /* default */])({
    scope: "core/edit-post"
  }, props));
}
...
function reinitializeEditor(postType, postId, target, settings, initialEdits) {
  Object(external_mt_element_["unmountComponentAtNode"])(target);
  var reboot = reinitializeEditor.bind(null, postType, postId, target, settings, initialEdits);
  Object(external_mt_element_["render"])(Object(external_mt_element_["createElement"])(editor, {
    settings: settings,
    onError: reboot,
    postId: postId,
    postType: postType,
...
function initializeEditor(id, postType, postId, settings, initialEdits) {
  ...
  var reboot = reinitializeEditor.bind(null, postType, postId, target, settings, initialEdits);
  Object(external_mt_blockLibrary_["registerCoreBlocks"])();
...
(function() { module.exports = window["mt"]["keyboardShortcuts"]; }());
...
(function() { module.exports = window["mt"]["a11y"]; }());
...
(function() { module.exports = window["mt"]["dataControls"]; }());
...
(function() { module.exports = window["mt"]["notices"]; }());
...
(function() { module.exports = window["mt"]["coreData"]; }());
...
(function() { module.exports = window["mt"]["blockEditor"]; }());
...
var enableItems = Object(external_mt_data_["combineReducers"])({
...
var store = Object(external_mt_data_["createReduxStore"])(STORE_NAME, {
  reducer: reducer,
  actions: actions_namespaceObject,
  selectors: selectors_namespaceObject,
  persist: ['enableItems']
...
Object(external_mt_data_["registerStore"])(STORE_NAME, {
  reducer: reducer,
  actions: actions_namespaceObject,
  selectors: selectors_namespaceObject,
  persist: ['enableItems']
...
/* harmony default export */ var complementary_area_context = (Object(external_mt_plugins_["withPluginContext"])(function (context, ownProps) {
  return {
    icon: ownProps.icon || context.icon,
...
function ComplementaryAreaToggle(_ref) {
  var _ref$as = _ref.as,
      as = _ref$as === void 0 ? external_mt_components_["Button"] : _ref$as,
      scope = _ref.scope,
  ...
  var isSelected = Object(external_mt_data_["useSelect"])(function (select) {
    return select(store).getActiveComplementaryArea(scope) === identifier;
  }, [identifier]);

  var _useDispatch = Object(external_mt_data_["useDispatch"])(store),
  ...
  return Object(external_mt_element_["createElement"])(ComponentToUse, Object(esm_extends["a" /* default */])({
...
var complementary_area_header_ComplementaryAreaHeader = function ComplementaryAreaHeader(_ref) {
  ...
  var toggleButton = Object(external_mt_element_["createElement"])(complementary_area_toggle, Object(esm_extends["a" /* default */])({
    icon: close_small["a" /* default */]
  }, toggleButtonProps));
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("div", {
    className: "components-panel__header interface-complementary-area-header__small"
  }, smallScreenTitle && Object(external_mt_element_["createElement"])("span", {
    className: "interface-complementary-area-header__small-title"
  }, smallScreenTitle), toggleButton), Object(external_mt_element_["createElement"])("div", {
...
function PinnedItems(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Fill"], Object(esm_extends["a" /* default */])({
...
function PinnedItemsSlot(_ref2) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Slot"], Object(esm_extends["a" /* default */])({
    name: "PinnedItems/".concat(scope)
  }, props), function (fills) {
    return !Object(external_lodash_["isEmpty"])(fills) && Object(external_mt_element_["createElement"])("div", {
...
function ComplementaryAreaFill(_ref2) {
  var scope = _ref2.scope,
      ...
      className = _ref2.className;
  return Object(external_mt_element_["createElement"])(external_mt_components_["Fill"], {
    name: "ComplementaryArea/".concat(scope)
  }, Object(external_mt_element_["createElement"])("div", {
    className: className
  }, children));
...
function useAdjustComplementaryListener(scope, identifier, activeArea, isActive, isSmall) {
  var previousIsSmall = Object(external_mt_element_["useRef"])(false);
  var shouldOpenWhenNotSmall = Object(external_mt_element_["useRef"])(false);
...
function ComplementaryArea(_ref3) {
  var children = _ref3.children,
      ...
      closeLabel = _ref3$closeLabel === void 0 ? Object(external_mt_i18n_["__"])('Close plugin') : _ref3$closeLabel,
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    return {
      ...
      isSmall: select(external_mt_viemtort_["store"]).isViemtortMatch('< medium'),
      isLarge: select(external_mt_viemtort_["store"]).isViemtortMatch('large')
    };
  }, [identifier, scope]),
      isActive = _useSelect.isActive,
  ...
  var _useDispatch2 = Object(external_mt_data_["useDispatch"])(store),
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, isPinned && isPinnable && Object(external_mt_element_["createElement"])(pinned_items, {
    scope: scope
  }, Object(external_mt_element_["createElement"])(complementary_area_toggle, {
    scope: scope,
    ...
    showTooltip: !showIconLabels,
    isTertiary: showIconLabels
  })), isActive && Object(external_mt_element_["createElement"])(ComplementaryAreaFill, {
    className: classnames_default()('interface-complementary-area', className),
    scope: scope
  }, Object(external_mt_element_["createElement"])(complementary_area_header, {
  ...
  }, header || Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("strong", null, title), isPinnable && Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    className: "interface-complementary-area__pin-unpin-item",
    icon: isPinned ? star_filled["a" /* default */] : star_empty["a" /* default */],
    label: isPinned ? Object(external_mt_i18n_["__"])('Unpin from toolbar') : Object(external_mt_i18n_["__"])('Pin to toolbar'),
    onClick: function onClick() {
      return (isPinned ? unpinItem : pinItem)(scope, identifier);
    },
    isPressed: isPinned,
    "aria-expanded": isPinned
  }))), Object(external_mt_element_["createElement"])(external_mt_components_["Panel"], {
...
function ActionItemSlot(_ref) {
  var name = _ref.name,
      _ref$as = _ref.as,
      as = _ref$as === void 0 ? [external_mt_components_["ButtonGroup"], external_mt_components_["Button"]] : _ref$as,
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Slot"], {
    name: name,
    ...
    return !Object(external_lodash_["isEmpty"])(fills) && Object(external_mt_element_["createElement"])(Container, props, fills);
  });
}
...
function ActionItem(_ref2) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Fill"], {
    ...
    var fpOnClick = fillProps.onClick,
        fpAs = fillProps.as;
    var Item = as || fpAs || external_mt_components_["Button"];
    return Object(external_mt_element_["createElement"])(Item, Object(esm_extends["a" /* default */])({
...
function ComplementaryAreaMoreMenuItem(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(complementary_area_toggle, Object(esm_extends["a" /* default */])({
    as: function as(toggleProps) {
      return Object(external_mt_element_["createElement"])(action_item, Object(esm_extends["a" /* default */])({
...
var fullscreen_mode_FullscreenMode = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(FullscreenMode, [{
    ...
    value: function componentDidMount() {
      ...
      // `sticky-menu` to be applied by paCMec and prevents the admin menu being scrolled
...
function InterfaceSkeleton(_ref, ref) {
  ...
  var fallbackRef = Object(external_mt_element_["useRef"])();
  var regionsClassName = Object(external_mt_components_["__unstableUseNavigateRegions"])(fallbackRef, shortcuts);
  useHTMLClass('interface-interface-skeleton__html-container');
  var defaultLabels = {
    /* translators: accessibility text for the nav bar landmark region. */
    drawer: Object(external_mt_i18n_["__"])('Drawer'),

    /* translators: accessibility text for the top bar landmark region. */
    header: Object(external_mt_i18n_["__"])('Header'),

    /* translators: accessibility text for the content landmark region. */
    body: Object(external_mt_i18n_["__"])('Content'),

    /* translators: accessibility text for the secondary sidebar landmark region. */
    secondarySidebar: Object(external_mt_i18n_["__"])('Block Library'),

    /* translators: accessibility text for the settings landmark region. */
    sidebar: Object(external_mt_i18n_["__"])('Settings'),

    /* translators: accessibility text for the publish landmark region. */
    actions: Object(external_mt_i18n_["__"])('Publish'),

    /* translators: accessibility text for the footer landmark region. */
    footer: Object(external_mt_i18n_["__"])('Footer')
  };

  var mergedLabels = interface_skeleton_objectSpread(interface_skeleton_objectSpread({}, defaultLabels), labels);

  return Object(external_mt_element_["createElement"])("div", {
    ref: Object(external_mt_element_["useCallback"])(Object(react_merge_refs_esm["a" /* default */])([ref, fallbackRef]), [ref, fallbackRef]),
    className: classnames_default()(className, 'interface-interface-skeleton', regionsClassName, !!footer && 'has-footer')
  }, !!drawer && Object(external_mt_element_["createElement"])("div", {
    className: "interface-interface-skeleton__drawer",
    role: "region",
    "aria-label": mergedLabels.drawer
  }, drawer), Object(external_mt_element_["createElement"])("div", {
    className: "interface-interface-skeleton__editor"
  }, !!header && Object(external_mt_element_["createElement"])("div", {
  ...
  }, !!secondarySidebar && Object(external_mt_element_["createElement"])("div", {
    ...
    tabIndex: "-1"
  }, content), !!sidebar && Object(external_mt_element_["createElement"])("div", {
    className: "interface-interface-skeleton__sidebar",
    role: "region",
    "aria-label": mergedLabels.sidebar,
    tabIndex: "-1"
  }, sidebar), !!actions && Object(external_mt_element_["createElement"])("div", {
    className: "interface-interface-skeleton__actions",
    role: "region",
    "aria-label": mergedLabels.actions,
    tabIndex: "-1"
  }, actions))), !!footer && Object(external_mt_element_["createElement"])("div", {
...
function BaseOption(_ref) {
  ...
  }, Object(external_mt_element_["createElement"])(external_mt_components_["ToggleControl"], {
    help: help,
    label: label,
    checked: isChecked,
    onChange: onChange
...
function CustomFieldsConfirmation(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("p", {
    className: "edit-post-preferences-modal__custom-fields-confirmation-message"
  }, Object(external_mt_i18n_["__"])('A page reload is required for this change. Make sure your content is saved before reloading.')), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
  ...
  }, willEnable ? Object(external_mt_i18n_["__"])('Enable & Reload') : Object(external_mt_i18n_["__"])('Disable & Reload')));
}
function EnableCustomFieldsOption(_ref2) {
  var label = _ref2.label,
      areCustomFieldsEnabled = _ref2.areCustomFieldsEnabled;

  var _useState3 = Object(external_mt_element_["useState"])(areCustomFieldsEnabled),
      _useState4 = Object(slicedToArray["a" /* default */])(_useState3, 2),
      isChecked = _useState4[0],
      setIsChecked = _useState4[1];

  return Object(external_mt_element_["createElement"])(base, {
    label: label,
    isChecked: isChecked,
    onChange: setIsChecked
  }, isChecked !== areCustomFieldsEnabled && Object(external_mt_element_["createElement"])(CustomFieldsConfirmation, {
    willEnable: isChecked
  }));
}
/* harmony default export */ var enable_custom_fields = (Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
/* harmony default export */ var enable_panel = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select, _ref) {
  ...
  var isRemoved = _ref2.isRemoved;
  return !isRemoved;
}), Object(external_mt_data_["withDispatch"])(function (dispatch, _ref3) {
  var panelName = _ref3.panelName;
  return {
...
var _createSlotFill = Object(external_mt_components_["createSlotFill"])('EnablePluginDocumentSettingPanelOption'),
    Fill = _createSlotFill.Fill,
    Slot = _createSlotFill.Slot;
...
var enable_plugin_document_setting_panel_EnablePluginDocumentSettingPanelOption = function EnablePluginDocumentSettingPanelOption(_ref) {
  var label = _ref.label,
      panelName = _ref.panelName;
  return Object(external_mt_element_["createElement"])(Fill, null, Object(external_mt_element_["createElement"])(enable_panel, {
    label: label,
    panelName: panelName
  }));
};
...
/* harmony default export */ var enable_publish_sidebar = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
}), // In < medium viemtorts we override this option and always show the publish sidebar.
...
/* harmony default export */ var enable_feature = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select, _ref) {
...
(function() { module.exports = window["mt"]["primitives"]; }());
...
(function() { module.exports = window["mt"]["plugins"]; }());
...
(function() { module.exports = window["mt"]["blocks"]; }());
