this["mt"] = this["mt"] || {}; this["mt"]["viemtort"] =
 ...
 *
 * @param {Object} state Viemtort state object.
...
var STORE_NAME = 'core/viemtort';
/**
 * Store definition for the viemtort namespace.
 *
...
var listener_addDimensionsEventListener = function addDimensionsEventListener(breakpoints, operators) {
  ...
  var setIsMatching = Object(external_lodash_["debounce"])(function () {
    ...
    Object(external_mt_data_["dispatch"])(store).setIsMatching(values);
  }, {
    leading: true
  });
  /**
 ...
 * @see isViemtortMatch
 *
 * @param {Object} queries  Object of prop name to viemtort query.
 *
 * @example
 *
 * ```jsx
 ...
 * }
 *
 * MyComponent = withViemtortMatch( { isMobile: '< small' } )( MyComponent );
 * ```
 *
 * @return {Function} Higher-order component.
 */

var with_viemtort_match_withViemtortMatch = function withViemtortMatch(queries) {
  var useViewPortQueriesResult = function useViewPortQueriesResult() {
    return Object(external_lodash_["mapValues"])(queries, function (query) {
      ...
      return Object(external_mt_compose_["useViemtortMatch"])(breakpointName, operator);
    });
  };

  return Object(external_mt_compose_["createHigherOrderComponent"])(function (WrappedComponent) {
    return Object(external_mt_compose_["pure"])(function (props) {
      var queriesResult = useViewPortQueriesResult();
      return Object(external_mt_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, props, queriesResult));
    });
  }, 'withViemtortMatch');
};
 ...
 * the viemtort query is satisfied.
 *
 * @see withViemtortMatches
 *
 * @param {string} query Viemtort query.
 *
 * @example
 *
 * ```jsx
 * function MyMobileComponent() {
 * 	return <div>I'm only rendered on mobile viemtorts!</div>;
 * }
 *
 * MyMobileComponent = ifViemtortMatches( '< small' )( MyMobileComponent );
 * ```
 *
 * @return {Function} Higher-order component.
 */

var if_viemtort_matches_ifViemtortMatches = function ifViemtortMatches(query) {
  return Object(external_mt_compose_["createHigherOrderComponent"])(Object(external_mt_compose_["compose"])([with_viemtort_match({
    isViemtortMatch: query
  }), Object(external_mt_compose_["ifCondition"])(function (props) {
    return props.isViemtortMatch;
  })]), 'ifViemtortMatches');
};
