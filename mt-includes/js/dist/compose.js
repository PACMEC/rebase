this["mt"] = this["mt"] || {}; this["mt"]["compose"] =
...
(function() { module.exports = window["mt"]["priorityQueue"]; }());
...
__webpack_require__.d(__webpack_exports__, "useViemtortMatch", function() { return /* reexport */ use_viemtort_match; });
 ...
 *
 * @return {MTComponent} Component class with generated display name assigned.
 */
...
var if_condition_ifCondition = function ifCondition(predicate) {
  return create_higher_order_component(function (WrappedComponent) {
    return function (props) {
      ...
      return Object(external_mt_element_["createElement"])(WrappedComponent, props);
    };
  }, 'ifCondition');
};
...
var pure = create_higher_order_component(function (Wrapped) {
  if (Wrapped.prototype instanceof external_mt_element_["Component"]) {
    return /*#__PURE__*/function (_Wrapped) {
      ...
      Object(createClass["a" /* default */])(_class, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
          return !external_mt_isShallowEqual_default()(nextProps, this.props) || !external_mt_isShallowEqual_default()(nextState, this.state);
        }
      }]);
  ...
  return /*#__PURE__*/function (_Component) {
    ...
    Object(createClass["a" /* default */])(_class2, [{
      ...
      value: function shouldComponentUpdate(nextProps) {
        return !external_mt_isShallowEqual_default()(nextProps, this.props);
      }
    }, {
      key: "render",
      value: function render() {
        return Object(external_mt_element_["createElement"])(Wrapped, this.props);
      }
    }]);
...
function withGlobalEvents(eventTypesToHandlers) {
  external_mt_deprecated_default()('mt.compose.withGlobalEvents', {
  ...
  return create_higher_order_component(function (WrappedComponent) {
    var Wrapper = /*#__PURE__*/function (_Component) {
      ...
      Object(createClass["a" /* default */])(Wrapper, [{
        ...
        key: "render",
        value: function render() {
          return Object(external_mt_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, this.props.ownProps, {
            ref: this.handleRef
          }));
        }
      }]);
    ...
    return Object(external_mt_element_["forwardRef"])(function (props, ref) {
      return Object(external_mt_element_["createElement"])(Wrapper, {
        ownProps: props,
        forwardedRef: ref
      });
    });
 ...
 * component.
 *
 * @param {MTComponent} WrappedComponent The wrapped component.
 *
 * @return {MTComponent} Component with an instanceId prop.
 */
...
/* harmony default export */ var with_instance_id = (create_higher_order_component(function (WrappedComponent) {
  return function (props) {
    ...
    return Object(external_mt_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, props, {
 ...
 *
 * @param {MTComponent} OriginalComponent Component requiring setTimeout
 *
 * @return {MTComponent} Wrapped component.
 */
...
var withSafeTimeout = create_higher_order_component(function (OriginalComponent) {
  return /*#__PURE__*/function (_Component) {
    ...
    Object(createClass["a" /* default */])(WrappedComponent, [{
      ...
      key: "render",
      value: function render() {
        return Object(external_mt_element_["createElement"])(OriginalComponent, Object(esm_extends["a" /* default */])({}, this.props, {
  ...
  return create_higher_order_component(function (OriginalComponent) {
    return /*#__PURE__*/function (_Component) {
      ...
      Object(createClass["a" /* default */])(WrappedComponent, [{
        key: "render",
        value: function render() {
          return Object(external_mt_element_["createElement"])(OriginalComponent, Object(esm_extends["a" /* default */])({}, this.props, this.state, {
...
function useCallbackRef(callback, deps) {
  return Object(external_mt_element_["useCallback"])(memize_default()(callback, {
    maxSize: 1
  }), deps);
}
...
function useConstrainedTabbing() {
  var ref = use_callback_ref(function (node) {
    ...
    node.addEventListener('keydown', function (event) {
      if (event.keyCode !== external_mt_keycodes_["TAB"]) {
        return;
      }

      var tabbables = external_mt_dom_["focus"].tabbable.find(node);
...
function useCopyOnClick(ref, _text) {
  ...
  var clipboard = Object(external_mt_element_["useRef"])();
...
function useFocusOnMount() {
  ...
  var focusOnMountRef = Object(external_mt_element_["useRef"])(focusOnMount);
  Object(external_mt_element_["useEffect"])(function () {
  ...
  return use_callback_ref(function (node) {
    ...
    if (focusOnMountRef.current === 'firstElement') {
      var firstTabbable = external_mt_dom_["focus"].tabbable.find(node)[0];
...
function useFocusReturn(onFocusReturn) {
  ...
  var focusedBeforeMount = Object(external_mt_element_["useRef"])();
  var onFocusReturnRef = Object(external_mt_element_["useRef"])(onFocusReturn);
  Object(external_mt_element_["useEffect"])(function () {
...
function useFocusOutside(onFocusOutside) {
  var currentOnFocusOutside = Object(external_mt_element_["useRef"])(onFocusOutside);
  Object(external_mt_element_["useEffect"])(function () {
    currentOnFocusOutside.current = onFocusOutside;
  }, [onFocusOutside]);
  var preventBlurCheck = Object(external_mt_element_["useRef"])(false);
  /**
   * @type {import('react').MutableRefObject<number | undefined>}
   */

  var blurCheckTimeoutId = Object(external_mt_element_["useRef"])();
  /**
   * Cancel a blur check timeout.
   */

  var cancelBlurCheck = Object(external_mt_element_["useCallback"])(function () {
  ...
  var normalizeButtonFocus = Object(external_mt_element_["useCallback"])(function (event) {
    var type = event.type,
        target = event.target;
  ...
  var queueBlurCheck = Object(external_mt_element_["useCallback"])(function (event) {
...
function useDialog(options) {
  var onClose = Object(external_mt_element_["useRef"])();
  Object(external_mt_element_["useEffect"])(function () {
  ...
  var closeOnEscapeRef = use_callback_ref(function (node) {
    ...
    node.addEventListener('keydown', function (event) {
      // Close on escape
      if (event.keyCode === external_mt_keycodes_["ESCAPE"] && onClose.current) {
...
function useDragging(_ref) {
  ...
  var eventsRef = Object(external_mt_element_["useRef"])({
  ...
  var onMouseMove = Object(external_mt_element_["useCallback"])(function () {
  ...
  var endDrag = Object(external_mt_element_["useCallback"])(function () {
  ...
  var startDrag = Object(external_mt_element_["useCallback"])(function () {
 ...
 *
 * @typedef {Object} MTKeyboardShortcutConfig
 *
 ...
 * @param {MTKeyboardShortcutConfig} options    Shortcut options.
 */
...
function useKeyboardShortcut(shortcuts, callback) {
  ...
  var currentCallback = Object(external_mt_element_["useRef"])(callback);
  Object(external_mt_element_["useEffect"])(function () {
...
function useMediaQuery(query) {
  var _useState = Object(external_mt_element_["useState"])(function () {
...
function usePrevious(value) {
  ...
  // https://github.com/paCMec/gutenberg/pull/22597#issuecomment-633588366
...
/**
 * @typedef {"huge"|"wide"|"large"|"medium"|"small"|"mobile"} MTBreakpoint
 */
 ...
 *
 * @type {Object<MTBreakpoint,number>}
 */
...
/**
 * @typedef {">="|"<"} MTViemtortOperator
 */

/**
 * Object mapping media query operators to the condition to be used.
 *
 * @type {Object<MTViemtortOperator,string>}
 */
 ...
 *
 * @type {Object<MTViemtortOperator,Function>}
 */
...
var ViemtortMatchWidthContext = Object(external_mt_element_["createContext"])(null);
/**
 * Returns true if the viemtort matches the given query, or false otherwise.
 *
 * @param {MTBreakpoint}       breakpoint      Breakpoint size name.
 * @param {MTViemtortOperator} [operator=">="] Viemtort operator.
 *
 * @example
 *
 * ```js
 * useViemtortMatch( 'huge', '<' );
 * useViemtortMatch( 'medium' );
 * ```
 *
 * @return {boolean} Whether viemtort matches query.
 */

var use_viemtort_match_useViemtortMatch = function useViemtortMatch(breakpoint) {
  var operator = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '>=';
  var simulatedWidth = Object(external_mt_element_["useContext"])(ViemtortMatchWidthContext);
...
use_viemtort_match_useViemtortMatch.__experimentalWidthProvider = ViemtortMatchWidthContext.Provider;
/* harmony default export */ var use_viemtort_match = (use_viemtort_match_useViemtortMatch);
...
function useAsyncList(list) {
  var _useReducer = Object(external_mt_element_["useReducer"])(listReducer, []),
  ...
  Object(external_mt_element_["useEffect"])(function () {
    ...
    var asyncQueue = Object(external_mt_priorityQueue_["createQueue"])();
