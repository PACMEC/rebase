this["mt"] = this["mt"] || {}; this["mt"]["blocks"] =
...
(function() { module.exports = window["mt"]["autop"]; }());
...
(function() { module.exports = window["mt"]["shortcode"]; }());
...
(function() { module.exports = window["mt"]["dom"]; }());
...
(function() { module.exports = window["mt"]["blockSerializationDefaultParser"]; }());
...
(function() { module.exports = window["mt"]["blob"]; }());
...
/**
 * @typedef {Object} MTBlockCategory
 *
 ...
 *
 * @type {MTBlockCategory[]}
 */

var DEFAULT_CATEGORIES = [{
  slug: 'text',
  title: Object(external_mt_i18n_["__"])('Text')
}, {
  slug: 'media',
  title: Object(external_mt_i18n_["__"])('Media')
}, {
  slug: 'design',
  title: Object(external_mt_i18n_["__"])('Design')
}, {
  slug: 'widgets',
  title: Object(external_mt_i18n_["__"])('Widgets')
}, {
  slug: 'embed',
  title: Object(external_mt_i18n_["__"])('Embeds')
}, {
  slug: 'reusable',
  title: Object(external_mt_i18n_["__"])('Reusable blocks')
}];
/**
 ...
 *
 * @param {MTBlockCategory[]} state  Current state.
 * @param {Object}            action Dispatched action.
 *
 * @return {MTBlockCategory[]} Updated state.
 */
...
/** @typedef {import('../api/registration').MTBlockVariation} MTBlockVariation */

/** @typedef {import('../api/registration').MTBlockVariationScope} MTBlockVariationScope */

/** @typedef {import('./reducer').MTBlockCategory} MTBlockCategory */
 ...
 * @param {MTBlockVariationScope} [scope]   Block variation scope name.
 *
 * @return {(MTBlockVariation[]|void)} Block variations.
 */
 ...
 * @param {MTBlockVariationScope} [scope]   Block variation scope name.
 *
 * @return {?MTBlockVariation} The default block variation.
 */
 ...
 * @param {Object} state Data state.
 *
 * @return {MTBlockCategory[]} Categories list.
 */
 ...
 *
 * @param {string}                              blockName  Block name.
 * @param {MTBlockVariation|MTBlockVariation[]} variations Block variations.
 *
 * @return {Object} Action object.
 */
 ...
 *
 * @param  {MTBlock} block Block Object
 *
...
function isValidIcon(icon) {
  return !!icon && (Object(external_lodash_["isString"])(icon) || Object(external_mt_element_["isValidElement"])(icon) || Object(external_lodash_["isFunction"])(icon) || icon instanceof external_mt_element_["Component"]);
}
/**
 ...
 * in the codebase.
 *
 * @param {MTBlockTypeIconRender} icon Render behavior of a block type icon;
 *                                     one of a Dashicon slug, an element, or a
 *                                     component.
 *
 * @return {MTBlockTypeIconDescriptor} Object describing the icon.
 */
...
function getBlockLabel(blockType, attributes) {
  ...
  if ('core/template-part' === blockType.name && attributes.slug) {
    var entity = Object(external_mt_data_["select"])('core').getEntityRecord('postType', 'mt_template_part', attributes.theme + '//' + attributes.slug);
  ...
  return Object(external_mt_dom_["__unstableStripHTML"])(label);
}
/**
...
function getAccessibleBlockLabel(blockType, attributes, position) {
  ...
  if (hasPosition && direction === 'vertical') {
    if (hasLabel) {
      return Object(external_mt_i18n_["sprintf"])(
      /* translators: accessibility text. 1: The block title. 2: The block row number. 3: The block label.. */
      Object(external_mt_i18n_["__"])('%1$s Block. Row %2$d. %3$s'), title, position, label);
    }

    return Object(external_mt_i18n_["sprintf"])(
    /* translators: accessibility text. 1: The block title. 2: The block row number. */
    Object(external_mt_i18n_["__"])('%1$s Block. Row %2$d'), title, position);
  } else if (hasPosition && direction === 'horizontal') {
    if (hasLabel) {
      return Object(external_mt_i18n_["sprintf"])(
      /* translators: accessibility text. 1: The block title. 2: The block column number. 3: The block label.. */
      Object(external_mt_i18n_["__"])('%1$s Block. Column %2$d. %3$s'), title, position, label);
    }

    return Object(external_mt_i18n_["sprintf"])(
    /* translators: accessibility text. 1: The block title. 2: The block column number. */
    Object(external_mt_i18n_["__"])('%1$s Block. Column %2$d'), title, position);
  }

  if (hasLabel) {
    return Object(external_mt_i18n_["sprintf"])(
    /* translators: accessibility text. %1: The block title. %2: The block label. */
    Object(external_mt_i18n_["__"])('%1$s Block. %2$s'), title, label);
  }

  return Object(external_mt_i18n_["sprintf"])(
  /* translators: accessibility text. %s: The block title. */
  Object(external_mt_i18n_["__"])('%s Block'), title);
}
/**
 ...
 * or a component.
 *
 * @typedef {MTIcon} MTBlockTypeIconRender
 */

/**
 * An object describing a normalized block type icon.
 *
 * @typedef {Object} MTBlockTypeIconDescriptor
 *
 * @property {MTBlockTypeIconRender} src         Render behavior of the icon,
 ...
 * the icon.
 *
 * @typedef {(MTBlockTypeIconDescriptor|MTBlockTypeIconRender)} MTBlockTypeIcon
 */

/**
 * Named block variation scopes.
 *
 * @typedef {'block'|'inserter'|'transform'} MTBlockVariationScope
 */

/**
 * An object describing a variation defined for the block type.
 *
 * @typedef {Object} MTBlockVariation
 *
 ...
 * @property {MTIcon}   [icon]                 An icon helping to visualize the variation.
 ...
 *                                             for the block type.
 * @property {MTBlockVariationScope[]} [scope] The list of scopes where the variation
 ...
 *                                              used in search interfaces to arrange
 *                                              block types by category.
 * @property {MTBlockTypeIcon}    [icon]        Block type icon.
 * @property {string[]}           [keywords]    Additional keywords to produce block
 *                                              type as result in search interfaces.
 * @property {Object}             [attributes]  Block type attributes.
 * @property {MTComponent}        [save]        Optional component describing
 *                                              serialized markup structure of a
 *                                              block type.
 * @property {MTComponent}        edit          Component rendering an element to
 *                                              manipulate the attributes of a block
 *                                              in the context of an editor.
 * @property {MTBlockVariation[]} [variations]  The list of block variations.
 * @property {Object}             [example]     Example provides structured data for
 ...
 *
 * @return {?MTBlock} The block, if it has been successfully registered;
 *                    otherwise `undefined`.
 */
...
function registerBlockType(name, settings) {
  ...
  if (Object(external_mt_data_["select"])(store).getBlockType(name)) {
  ...
  settings = Object(external_mt_hooks_["applyFilters"])('blocks.registerBlockType', settings, name);
  ...
  if (settings.deprecated) {
    settings.deprecated = settings.deprecated.map(function (deprecation) {
      ...
      Object(external_mt_hooks_["applyFilters"])('blocks.registerBlockType', // Merge deprecation keys with pre-filter settings
  ...
  if ('category' in settings && !Object(external_lodash_["some"])(Object(external_mt_data_["select"])(store).getCategories(), {
  ...
  Object(external_mt_data_["dispatch"])(store).addBlockTypes(settings);
  return settings;
}
/**
...
function registerBlockCollection(namespace, _ref) {
  var title = _ref.title,
      icon = _ref.icon;
  Object(external_mt_data_["dispatch"])(store).addBlockCollection(namespace, title, icon);
}
/**
...
function unregisterBlockCollection(namespace) {
  Object(external_mt_data_["dispatch"])(store).removeBlockCollection(namespace);
}
/**
 * Unregisters a block.
 *
 * @param {string} name Block name.
 *
 * @return {?MTBlock} The previous block value, if it has been successfully
 *                    unregistered; otherwise `undefined`.
 */

function unregisterBlockType(name) {
  var oldBlock = Object(external_mt_data_["select"])(store).getBlockType(name);
  ...
  Object(external_mt_data_["dispatch"])(store).removeBlockTypes(name);
  return oldBlock;
}
/**
...
function setFreeformContentHandlerName(blockName) {
  Object(external_mt_data_["dispatch"])(store).setFreeformFallbackBlockName(blockName);
}
/**
...
function getFreeformContentHandlerName() {
  return Object(external_mt_data_["select"])(store).getFreeformFallbackBlockName();
}
/**
...
function registration_getGroupingBlockName() {
  return Object(external_mt_data_["select"])(store).getGroupingBlockName();
}
/**
...
function setUnregisteredTypeHandlerName(blockName) {
  Object(external_mt_data_["dispatch"])(store).setUnregisteredFallbackBlockName(blockName);
}
/**
...
function getUnregisteredTypeHandlerName() {
  return Object(external_mt_data_["select"])(store).getUnregisteredFallbackBlockName();
}
/**
...
function registration_setDefaultBlockName(name) {
  Object(external_mt_data_["dispatch"])(store).setDefaultBlockName(name);
}
/**
...
function registration_setGroupingBlockName(name) {
  Object(external_mt_data_["dispatch"])(store).setGroupingBlockName(name);
}
/**
...
function registration_getDefaultBlockName() {
  return Object(external_mt_data_["select"])(store).getDefaultBlockName();
}
/**
...
function registration_getBlockType(name) {
  return Object(external_mt_data_["select"])(store).getBlockType(name);
}
/**
...
function registration_getBlockTypes() {
  return Object(external_mt_data_["select"])(store).getBlockTypes();
}
/**
 * Returns the block support value for a feature, if defined.
 *
...
function registration_getBlockSupport(nameOrType, feature, defaultSupports) {
  return Object(external_mt_data_["select"])(store).getBlockSupport(nameOrType, feature, defaultSupports);
}
/**
 * Returns true if the block defines support for a feature, or false otherwise.
 *
...
function registration_hasBlockSupport(nameOrType, feature, defaultSupports) {
  return Object(external_mt_data_["select"])(store).hasBlockSupport(nameOrType, feature, defaultSupports);
}
/**
...
var registration_getChildBlockNames = function getChildBlockNames(blockName) {
  return Object(external_mt_data_["select"])(store).getChildBlockNames(blockName);
};
/**
 * Returns a boolean indicating if a block has child blocks or not.
 *
...
var registration_hasChildBlocks = function hasChildBlocks(blockName) {
  return Object(external_mt_data_["select"])(store).hasChildBlocks(blockName);
};
/**
 * Returns a boolean indicating if a block has at least one child block with inserter support.
 *
...
var registration_hasChildBlocksWithInserterSupport = function hasChildBlocksWithInserterSupport(blockName) {
  return Object(external_mt_data_["select"])(store).hasChildBlocksWithInserterSupport(blockName);
};
/**
...
var registration_registerBlockStyle = function registerBlockStyle(blockName, styleVariation) {
  Object(external_mt_data_["dispatch"])(store).addBlockStyles(blockName, styleVariation);
};
/**
...
var registration_unregisterBlockStyle = function unregisterBlockStyle(blockName, styleVariationName) {
  Object(external_mt_data_["dispatch"])(store).removeBlockStyles(blockName, styleVariationName);
};
/**
...
var registration_getBlockVariations = function getBlockVariations(blockName, scope) {
  return Object(external_mt_data_["select"])(store).getBlockVariations(blockName, scope);
};
/**
 * Registers a new block variation for the given block type.
 *
 * @param {string}           blockName Name of the block (example: “core/columns”).
 * @param {MTBlockVariation} variation Object describing a block variation.
 */

var registration_registerBlockVariation = function registerBlockVariation(blockName, variation) {
  Object(external_mt_data_["dispatch"])(store).addBlockVariations(blockName, variation);
};
/**
...
function findTransform(transforms, predicate) {
  ...
  var hooks = Object(external_mt_hooks_["createHooks"])();
...
function switchToBlockType(blocks, name) {
  ...
  return transformationResults.map(function (result, index) {
    ...
    return Object(external_mt_hooks_["applyFilters"])('blocks.switchToBlockType.transformedBlock', transformedBlock, blocks);
  });
}
/**
...
// EXTERNAL MODULE: external ["mt","autop"]
var external_mt_autop_ = __webpack_require__(115);

// EXTERNAL MODULE: external ["mt","blockSerializationDefaultParser"]
var external_mt_blockSerializationDefaultParser_ = __webpack_require__(284);
...
var _createContext = Object(external_mt_element_["createContext"])(function () {}),
 ...
 * @param {MTElement} props.children    Block save result.
 * @param {Array}     props.innerBlocks Block(s) to serialize.
 *
 * @return {MTComponent} Element with BlockContent injected via context.
 */
...
var block_content_provider_BlockContentProvider = function BlockContentProvider(_ref) {
  ...
  var BlockContent = function BlockContent() {
    ...
    return Object(external_mt_element_["createElement"])(external_mt_element_["RawHTML"], null, html);
  };

  return Object(external_mt_element_["createElement"])(Provider, {
    value: BlockContent
  }, children);
};
/**
 ...
 * wrapped component.
 *
 * @return {MTComponent} Enhanced component with injected BlockContent as prop.
 */


var withBlockContentContext = Object(external_mt_compose_["createHigherOrderComponent"])(function (OriginalComponent) {
  return function (props) {
    return Object(external_mt_element_["createElement"])(Consumer, null, function (context) {
      return Object(external_mt_element_["createElement"])(OriginalComponent, Object(esm_extends["a" /* default */])({}, props, {
...
/**
 * @typedef {Object} MTBlockSerializationOptions Serialization Options.
 *
...
function getBlockDefaultClassName(blockName) {
  ...
  var className = 'mt-block-' + blockName.replace(/\//, '-').replace(/^core-/, '');
  return Object(external_mt_hooks_["applyFilters"])('blocks.getBlockDefaultClassName', className, blockName);
}
/**
...
function getBlockMenuDefaultClassName(blockName) {
  ...
  return Object(external_mt_hooks_["applyFilters"])('blocks.getBlockMenuDefaultClassName', className, blockName);
}
...
function getBlockProps() {
  ...
  return Object(external_mt_hooks_["applyFilters"])('blocks.getSaveContent.extraProps', serializer_objectSpread({}, props), blockType, attributes);
}
/**
...
function getSaveElement(blockTypeOrName, attributes) {
  ...
  if (save.prototype instanceof external_mt_element_["Component"]) {
  ...
  if (Object(external_lodash_["isObject"])(element) && Object(external_mt_hooks_["hasFilter"])('blocks.getSaveContent.extraProps') && !hasLightBlockWrapper) {
    /**
     * Filters the props applied to the block save result element.
     *
     * @param {Object}  props      Props applied to save element.
     * @param {MTBlock} blockType  Block type definition.
     * @param {Object}  attributes Block attributes.
     */
    var props = Object(external_mt_hooks_["applyFilters"])('blocks.getSaveContent.extraProps', serializer_objectSpread({}, element.props), blockType, attributes);

    if (!external_mt_isShallowEqual_default()(props, element.props)) {
      element = Object(external_mt_element_["cloneElement"])(element, props);
    }
  }
  /**
   * Filters the save result of a block during serialization.
   *
   * @param {MTElement} element    Block save result.
   * @param {MTBlock}   blockType  Block type definition.
   * @param {Object}    attributes Block attributes.
   */


  element = Object(external_mt_hooks_["applyFilters"])('blocks.getSaveElement', element, blockType, attributes);
  return Object(external_mt_element_["createElement"])(block_content_provider, {
    innerBlocks: innerBlocks
  }, element);
}
/**
...
function getSaveContent(blockTypeOrName, attributes, innerBlocks) {
  var blockType = normalizeBlockType(blockTypeOrName);
  return Object(external_mt_element_["renderToString"])(getSaveElement(blockType, attributes, innerBlocks));
}
/**
...
function getCommentDelimitedContent(rawBlockName, attributes, content) {
  ...
  var blockName = Object(external_lodash_["startsWith"])(rawBlockName, 'core/') ? rawBlockName.slice(5) : rawBlockName; // @todo make the `mt:` prefix potentially configurable.

  if (!content) {
    return "<!-- mt:".concat(blockName, " ").concat(serializedAttributes, "/-->");
  }
 ...
 *
 * @param {Object}                      block   Block instance.
 * @param {MTBlockSerializationOptions} options Serialization options.
 *
...
function __unstableSerializeAndClean(blocks) {
  ...
  if (blocks.length === 1 && blocks[0].name === getFreeformContentHandlerName()) {
    content = Object(external_mt_autop_["removep"])(content);
  }
...
var BOOLEAN_ATTRIBUTES = ['allowfullscreen', 'allomtaymentrequest', 'allowusermedia', 'async', 'autofocus', 'autoplay', 'checked', 'controls', 'default', 'defer', 'disabled', 'download', 'formnovalidate', 'hidden', 'ismap', 'itemscope', 'loop', 'multiple', 'muted', 'nomodule', 'novalidate', 'open', 'playsinline', 'readonly', 'required', 'reversed', 'selected', 'typemustmatch'];
/**
  ...
  Object(createClass["a" /* default */])(DecodeEntityParser, [{
    ...
    value: function parse(entity) {
      if (isValidCharacterReference(entity)) {
        return Object(external_mt_htmlEntities_["decodeEntities"])('&' + entity + ';');
      }
    }
  }]);
 ...
 * 2. `props` (object): Attributes and children array of MTBlockNode.
 *
 * @typedef {string|Object} MTBlockNode
 */
 ...
 *
 * @param {MTBlockNode} node Block node to test
 ...
 *
 * @return {MTBlockNode} Block node equivalent to DOM node.
 */
 ...
 *
 * @param {MTBlockNode} node Block node to convert to string.
 *
...
/**
 * Given a selector, returns an hpq matcher generating a MTBlockNode value
 ...
 * source `node`.
 *
 * @see https://github.com/paCMec/gutenberg/pull/10439
 *
 ...
 *
 * @typedef {MTBlockNode[]} MTBlockChildren
 */

/**
 * Given block children, returns a serialize-capable paCMec element.
 *
 * @param {MTBlockChildren} children Block children object to convert.
 *
 * @return {MTElement} A serialize-capable element.
 */
 ...
 * @param {MTBlockChildren} children Block children object to convert.
 *
 * @return {Array<MTBlockNode>} An array of individual block nodes.
 */
 ...
 *
 * @param {...MTBlockChildren} blockNodes Block nodes to concatenate.
 *
 * @return {MTBlockChildren} Concatenated block node.
 */
 ...
 *
 * @return {MTBlockChildren} Block children equivalent to DOM nodes.
 */
 ...
 * Given a block node, returns its HTML string representation.
 *
 * @param {MTBlockChildren} children Block node(s) to convert to string.
 *
 * @return {string} String HTML representation of block node.
 */
...
function children_toHTML(children) {
  ...
  return Object(external_mt_element_["renderToString"])(element);
}
/**
 * Given a selector, returns an hpq matcher generating a MTBlockChildren value
 * matching the selector result.
 *
 * @param {string} selector DOM selector.
 *
...
function getBlockAttributes(blockTypeOrName, innerHTML) {
  ...
  return Object(external_mt_hooks_["applyFilters"])('blocks.getBlockAttributes', blockAttributes, blockType, innerHTML, attributes);
}
/**
 ...
 *
 * @param {MTBlock} block            Original block object.
 * @param {Object}  parsedAttributes Attributes as parsed from the initial
 *                                   block markup.
 *
 * @return {MTBlock} Migrated block object.
 */
...
function createBlockWithFallback(blockNode) {
  ...
  // automatic paragraphs, so preserve them. Assumes mtautop is idempotent,
  // meaning there are no negative consequences to repeated autop calls.
  if (name === freeformContentFallbackBlock) {
    innerHTML = Object(external_mt_autop_["autop"])(innerHTML).trim();
  ...
  // empty freeform block nodes. See https://github.com/paCMec/gutenberg/pull/17164.
  ...
  while (decu.firstChild) {
    ...
    if (node.nodeType === node.TEXT_NODE) {
      ...
      if (node.nodeName === 'BR') {
        ...
        if (Object(external_mt_dom_["isEmpty"])(node)) {
          decu.removeChild(node);
        } else {
          accu.appendChild(node);
        }
      } else if (Object(external_mt_dom_["isPhrasingContent"])(node)) {
        if (!accu.lastChild || accu.lastChild.nodeName !== 'P') {
          accu.appendChild(accuDoc.createElement('P'));
        }
...
function specialCommentConverter(node, doc) {
  ...
  if (node.nodeValue === 'nextpage') {
    Object(external_mt_dom_["replace"])(node, createNextpage(doc));
    return;
  }
  ...
  if (node.nodeValue.indexOf('more') === 0) {
    ...
    while (sibling = sibling.nextSibling) {
      if (sibling.nodeType === sibling.COMMENT_NODE && sibling.nodeValue === 'noteaser') {
        noTeaser = true;
        Object(external_mt_dom_["remove"])(sibling);
        break;
      }
    }

    Object(external_mt_dom_["replace"])(node, createMore(customText, noTeaser, doc));
  }
}

function createMore(customText, noTeaser, doc) {
  var node = doc.createElement('mt-block');
...
function commentRemover(node) {
  if (node.nodeType === node.COMMENT_NODE) {
    Object(external_mt_dom_["remove"])(node);
  }
}
...
function isInline(node, contextTag) {
  if (Object(external_mt_dom_["isTextContent"])(node)) {
    return true;
  }
...
function phrasingContentReducer(node, doc) {
  ...
  if (node.nodeName === 'SPAN' && node.style) {
    ...
    if (fontWeight === 'bold' || fontWeight === '700') {
      Object(external_mt_dom_["wrap"])(doc.createElement('strong'), node);
    }

    if (fontStyle === 'italic') {
      Object(external_mt_dom_["wrap"])(doc.createElement('em'), node);
    ...
    if (textDecorationLine === 'line-through' || Object(external_lodash_["includes"])(textDecoration, 'line-through')) {
      Object(external_mt_dom_["wrap"])(doc.createElement('s'), node);
    }

    if (verticalAlign === 'super') {
      Object(external_mt_dom_["wrap"])(doc.createElement('sup'), node);
    } else if (verticalAlign === 'sub') {
      Object(external_mt_dom_["wrap"])(doc.createElement('sub'), node);
    }
  } else if (node.nodeName === 'B') {
    node = Object(external_mt_dom_["replaceTag"])(node, 'strong');
  } else if (node.nodeName === 'I') {
    node = Object(external_mt_dom_["replaceTag"])(node, 'em');
...
function imageCorrector(node) {
  ...
  if (node.src.indexOf('data:') === 0) {
    ...
    node.src = Object(external_mt_blob_["createBlobURL"])(file);
...
function isFigureContent(node, schema) {
  ...
  if (tag === 'figcaption' || Object(external_mt_dom_["isTextContent"])(node)) {
    return false;
  }
...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  var transformation = findTransform(transformsFrom, function (transform) {
    return excludedBlockNames.indexOf(transform.blockName) === -1 && transform.type === 'shortcode' && Object(external_lodash_["some"])(Object(external_lodash_["castArray"])(transform.tag), function (tag) {
      return Object(external_mt_shortcode_["regexp"])(tag).test(HTML);
    });
  });
  ...
  if (match = Object(external_mt_shortcode_["next"])(transformTag, HTML, lastIndex)) {
    ...
    //
    // See: https://github.com/paCMec/gutenberg/pull/3610#discussion_r152546926
    function (schema) {
...
function getBlockContentSchemaFromTransforms(transforms, context) {
  var phrasingContentSchema = Object(external_mt_dom_["getPhrasingContentSchema"])(context);
  var schemaArgs = {
...
function getSibling(node, which) {
  ...
  if (sibling && Object(external_mt_dom_["isPhrasingContent"])(sibling)) {
    return sibling;
  }

  var parentNode = node.parentNode;

  if (!parentNode || !Object(external_mt_dom_["isPhrasingContent"])(parentNode)) {
    return;
  }
...
function filterInlineHTML(HTML, preserveWhiteSpace) {
  ...
  HTML = Object(external_mt_dom_["removeInvalidHTML"])(HTML, Object(external_mt_dom_["getPhrasingContentSchema"])('paste'), {
    inline: true
  });
...
function pasteHandler(_ref) {
  ...
  var phrasingContentSchema = Object(external_mt_dom_["getPhrasingContentSchema"])('paste');
  ...
  var blocks = Object(external_lodash_["compact"])(Object(external_lodash_["flatMap"])(pieces, function (piece) {
    ...
    piece = Object(external_mt_dom_["removeInvalidHTML"])(piece, schema);
  ...
  if (mode === 'AUTO' && blocks.length === 1 && registration_hasBlockSupport(blocks[0].name, '__unstablePasteTextInline', false)) {
    ...
    if (trimmedPlainText !== '' && trimmedPlainText.indexOf('\n') === -1) {
      return Object(external_mt_dom_["removeInvalidHTML"])(getBlockContent(blocks[0]), phrasingContentSchema);
    }
  }
...
function deprecatedGetPhrasingContentSchema(context) {
  external_mt_deprecated_default()('mt.blocks.getPhrasingContentSchema', {
    alternative: 'mt.dom.getPhrasingContentSchema'
  });
  return Object(external_mt_dom_["getPhrasingContentSchema"])(context);
}
/**
...
/** @typedef {import('../store/reducer').MTBlockCategory} MTBlockCategory */

/**
 * Returns all the block categories.
 *
 * @return {MTBlockCategory[]} Block categories.
 */

function categories_getCategories() {
  return Object(external_mt_data_["select"])(store).getCategories();
}
/**
 * Sets the block categories.
 *
 * @param {MTBlockCategory[]} categories Block categories.
 */

function categories_setCategories(categories) {
  Object(external_mt_data_["dispatch"])(store).setCategories(categories);
}
/**
 * Updates a category.
 *
 * @param {string}          slug     Block category slug.
 * @param {MTBlockCategory} category Object containing the category properties
  ...
  return Object(external_lodash_["map"])(template, function (_ref3, index) {
    ...
    var normalizeAttribute = function normalizeAttribute(definition, value) {
      if (isHTMLAttribute(definition) && Object(external_lodash_["isArray"])(value)) {
        ...
        return Object(external_mt_element_["renderToString"])(value);
      }
...
(function() { module.exports = window["mt"]["isShallowEqual"]; }());
