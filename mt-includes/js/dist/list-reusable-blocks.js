this["mt"] = this["mt"] || {}; this["mt"]["listReusableBlocks"] =
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return external_mt_apiFetch_default()({
              path: "/mt/v2/".concat(postType.rest_base, "/").concat(id, "?context=edit")
            });
    ...
    return external_regeneratorRuntime_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            if (!(parsedContent.__file !== 'mt_block' || !parsedContent.title || !parsedContent.content || !Object(external_lodash_["isString"])(parsedContent.title) || !Object(external_lodash_["isString"])(parsedContent.content))) {
              _context.next = 12;
              break;
            }
          ...
          case 14:
            ...
            _context.next = 17;
            return external_mt_apiFetch_default()({
              path: "/mt/v2/".concat(postType.rest_base),
              data: {
...
var import_form_ImportForm = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(ImportForm, [{
      ...
      utils_import(file).then(function (reusableBlock) {
        ...
        switch (error.message) {
          case 'Invalid JSON file':
            uiMessage = Object(external_mt_i18n_["__"])('Invalid JSON file');
            break;

          case 'Invalid Reusable Block JSON file':
            uiMessage = Object(external_mt_i18n_["__"])('Invalid Reusable Block JSON file');
            break;

          default:
            uiMessage = Object(external_mt_i18n_["__"])('Unknown error');
        }
    ...
    value: function render() {
      ...
      return Object(external_mt_element_["createElement"])("form", {
        className: "list-reusable-blocks-import-form",
        onSubmit: this.onSubmit
      }, error && Object(external_mt_element_["createElement"])(external_mt_components_["Notice"], {
        status: "error",
        onRemove: function onRemove() {
          return _this3.onDismissError();
        }
      }, error), Object(external_mt_element_["createElement"])("label", {
        htmlFor: inputId,
        className: "list-reusable-blocks-import-form__label"
      }, Object(external_mt_i18n_["__"])('File')), Object(external_mt_element_["createElement"])("input", {
        id: inputId,
        type: "file",
      ...
      }, Object(external_mt_i18n_["_x"])('Import', 'button label')));
    }
  }]);
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Dropdown"], {
    ...
    renderToggle: function renderToggle(_ref2) {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        ...
        onClick: onToggle,
        isPrimary: true
      }, Object(external_mt_i18n_["__"])('Import from JSON'));
    },
    renderContent: function renderContent(_ref3) {
      var onClose = _ref3.onClose;
      return Object(external_mt_element_["createElement"])(import_form, {
...
document.body.addEventListener('click', function (event) {
  if (!event.target.classList.contains('mt-list-reusable-blocks__export')) {
    return;
  }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var showNotice = function showNotice() {
    ...
    notice.innerHTML = "<p>".concat(Object(external_mt_i18n_["__"])('Reusable block imported successfully!'), "</p>");
    var headerEnd = document.querySelector('.mt-header-end');
  ...
  Object(external_mt_element_["render"])(Object(external_mt_element_["createElement"])(import_dropdown, {
    onUpload: showNotice
  }), container);
});
