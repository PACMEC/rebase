this["mt"] = this["mt"] || {}; this["mt"]["notices"] =
...
/**
 * @typedef {Object} MTNoticeAction Object describing a user action option associated with a notice.
 *
 ...
 *                                                             announced to screen
 *                                                             readers.
 * @param {Array<MTNoticeAction>} [options.actions]            User actions to be
...
function createNotice() {
  ...
  // strings. To avoid setting expectation that e.g. a MTElement could be
...
/** @typedef {import('./actions').MTNoticeAction} MTNoticeAction */
...
var DEFAULT_NOTICES = [];
/**
 * @typedef {Object} MTNotice Notice object.
 *
 ...
 *                                      `true`.
 * @property {MTNoticeAction[]} actions User actions to present with notice.
 *
 */
 ...
 *
 * @return {MTNotice[]} Array of notices.
 */
...
var store = Object(external_mt_data_["createReduxStore"])('core/notices', {
