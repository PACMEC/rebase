this["mt"] = this["mt"] || {}; this["mt"]["wordcount"] =
...
/**
 * @typedef MTWordCountSettingsFields
 ...
 * @property {RegExp}              shortcodesRegExp                  Regular expression that matches paCMec shortcodes
 * @property {string[]}            shortcodes                        List of all shortcodes
 * @property {MTWordCountStrategy} type                              Describes what and how are we counting
 * @property {MTWordCountL10n}     l10n                              Object with human translations
 */

/**
 * Lower-level settings for word counting that can be overridden.
 *
 * @typedef {Partial<MTWordCountSettingsFields>} MTWordCountUserSettings
 */
 ...
 *
 * @typedef {MTWordCountUserSettings & typeof defaultSettings} MTWordCountDefaultSettings
 */
 ...
 *
 * @param {import('./index').MTWordCountSettings} settings The main settings object containing regular expressions
...
/**
 * @typedef {import('./defaultSettings').MTWordCountDefaultSettings}  MTWordCountSettings
 * @typedef {import('./defaultSettings').MTWordCountUserSettings}     MTWordCountUserSettings
 */

/**
 * Possible ways of counting.
 *
 * @typedef {'words'|'characters_excluding_spaces'|'characters_including_spaces'} MTWordCountStrategy
 */

/**
 * Private function to manage the settings.
 *
 * @param {MTWordCountStrategy}     type         The type of count to be done.
 * @param {MTWordCountUserSettings} userSettings Custom settings for the count.
 *
 * @return {MTWordCountSettings} The combined settings object to be used.
 */
 ...
 * @param {MTWordCountSettings} settings Settings object containing regular expressions for each strip function
 *
 ...
 *
 * @param {string}                  text         The text being processed
 * @param {MTWordCountStrategy}     type         The type of count. Accepts 'words', 'characters_excluding_spaces', or 'characters_including_spaces'.
 * @param {MTWordCountUserSettings} userSettings Custom settings object.
 *
 * @example
 * ```js
