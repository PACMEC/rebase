...
(function() { module.exports = window["mt"]["reduxRoutine"]; }());
...
// EXTERNAL MODULE: external ["mt","reduxRoutine"]
var external_mt_reduxRoutine_ = __webpack_require__(291);
var external_mt_reduxRoutine_default = /*#__PURE__*/__webpack_require__.n(external_mt_reduxRoutine_);
...
/** @typedef {import('./registry').MTDataRegistry} MTDataRegistry */

/**
 * Creates a middleware handling resolvers cache invalidation.
 *
 * @param {MTDataRegistry} registry   The registry reference for which to create
 *                                    the middleware.
...
/** @typedef {import('../types').MTDataRegistry} MTDataRegistry */

/** @typedef {import('../types').MTDataStore} MTDataStore */

/** @typedef {import('../types').MTDataReduxStoreConfig} MTDataReduxStoreConfig */
 ...
 * @param {MTDataReduxStoreConfig} options  Registered store options, with properties
 *                                          describing reducer, actions, selectors,
 *                                          and resolvers.
 *
 * @return {MTDataStore} Store Object.
 */
 ...
 *                                  describing reducer, actions, selectors,
 *                                  and resolvers.
 * @param {MTDataRegistry} registry Registry reference.
...
function instantiateReduxStore(key, options, registry, thunkArgs) {
  ...
  var middlewares = [resolvers_cache_middleware(registry, key), promise_middleware, external_mt_reduxRoutine_default()(normalizedControls)];
...
/**
 * @typedef {Object} MTDataRegistry An isolated orchestrator of store registrations.
 *
...
/**
 * @typedef {Object} MTDataPlugin An object of registry function overrides.
 *
 ...
 *
 * @return {MTDataRegistry} Data registry.
 */
...
function createRegistry() {
   ...
   *
   * @param {string|MTDataStore} storeNameOrDefinition Unique namespace identifier for the store
   ...
   *
   * @param {MTDataStore} store Store definition.
   */
  ...
  function __experimentalSubscribeStore(storeName, handler) {
    ...
    // See https://github.com/paCMec/gutenberg/pull/27466 for more info.
...
/* harmony default export */ var plugins_controls = (function (registry) {
  external_mt_deprecated_default()('mt.data.plugins.controls', {
...
try {
  ...
  default_storage.setItem('__mtDataTestLocalStorage', '');
  default_storage.removeItem('__mtDataTestLocalStorage');
} catch (error) {
...
/** @typedef {import('../../registry').MTDataPlugin} MTDataPlugin */

/**
 * @typedef {Object} MTDataPersistencePluginOptions Persistence plugin options.
 *
...
var DEFAULT_STORAGE_KEY = 'MT_DATA';
/**
 ...
 *
 * @param {MTDataPersistencePluginOptions} options Plugin options.
 *
 ...
 *
 * @param {MTDataRegistry}                  registry      Data registry.
 * @param {?MTDataPersistencePluginOptions} pluginOptions Plugin options.
 *
 * @return {MTDataPlugin} Data plugin.
 */
...
/**
 * Deprecated: Remove this function and the code in paCMec Core that calls
 * it once paCMec 5.4 is released.
 */
...
var Context = Object(external_mt_element_["createContext"])(default_registry);
...
var context_Context = Object(external_mt_element_["createContext"])(false);
...
var renderQueue = Object(external_mt_priorityQueue_["createQueue"])();
/**
...
function useSelect(_mapSelect, deps) {
  var mapSelect = Object(external_mt_element_["useCallback"])(_mapSelect, deps);
  ...
  var _useReducer = Object(external_mt_element_["useReducer"])(function (s) {
    return s + 1;
  }, 0),
      _useReducer2 = Object(slicedToArray["a" /* default */])(_useReducer, 2),
      forceRender = _useReducer2[1];

  var latestMapSelect = Object(external_mt_element_["useRef"])();
  var latestIsAsync = Object(external_mt_element_["useRef"])(isAsync);
  var latestMapOutput = Object(external_mt_element_["useRef"])();
  var latestMapOutputError = Object(external_mt_element_["useRef"])();
  var isMountedAndNotUnsubscribing = Object(external_mt_element_["useRef"])(); // Keep track of the stores being selected in the mapSelect function,
  // and only subscribe to those stores later.

  var listeningStores = Object(external_mt_element_["useRef"])([]);
  var trapSelect = Object(external_mt_element_["useCallback"])(function (callback) {
  ...
  var depsChangedFlag = Object(external_mt_element_["useMemo"])(function () {
    return {};
  }, deps || []);
  var mapOutput;
  ...
  Object(external_mt_compose_["useIsomorphicLayoutEffect"])(function () {
    ...
    var onStoreChange = function onStoreChange() {
      if (isMountedAndNotUnsubscribing.current) {
        try {
          ...
          if (external_mt_isShallowEqual_default()(latestMapOutput.current, newMapOutput)) {
            return;
          }
...
var with_select_withSelect = function withSelect(mapSelectToProps) {
  return Object(external_mt_compose_["createHigherOrderComponent"])(function (WrappedComponent) {
    return Object(external_mt_compose_["pure"])(function (ownProps) {
      ...
      return Object(external_mt_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, ownProps, mergeProps));
    });
  }, 'withSelect');
};
...
var use_dispatch_with_map_useDispatchWithMap = function useDispatchWithMap(dispatchMap, deps) {
  var registry = useRegistry();
  var currentDispatchMap = Object(external_mt_element_["useRef"])(dispatchMap);
  Object(external_mt_compose_["useIsomorphicLayoutEffect"])(function () {
 ...
 *
 * @return {MTComponent} Enhanced component with merged dispatcher props.
 */
...
var with_dispatch_withDispatch = function withDispatch(mapDispatchToProps) {
  return Object(external_mt_compose_["createHigherOrderComponent"])(function (WrappedComponent) {
    return function (ownProps) {
      ...
      return Object(external_mt_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, ownProps, dispatchProps));
    };
  }, 'withDispatch');
};
 ...
 *
 * @param {MTComponent} OriginalComponent Original component.
 *
 * @return {MTComponent} Enhanced component.
 */

var withRegistry = Object(external_mt_compose_["createHigherOrderComponent"])(function (OriginalComponent) {
  return function (props) {
    return Object(external_mt_element_["createElement"])(RegistryConsumer, null, function (registry) {
 ...
 * RegistryProvider.
 *
 * @param {string|MTDataStore} [storeNameOrDefinition] Optionally provide the name of the
