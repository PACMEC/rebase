this["mt"] = this["mt"] || {}; this["mt"]["keycodes"] =
...
/** @typedef {typeof ALT | CTRL | COMMAND | SHIFT } MTModifierPart */

/** @typedef {'primary' | 'primaryShift' | 'primaryAlt' | 'secondary' | 'access' | 'ctrl' | 'alt' | 'ctrlShift' | 'shift' | 'shiftAlt'} MTKeycodeModifier */
 ...
 * @template T
 *
 * @typedef {Record<MTKeycodeModifier, T>} MTModifierHandler
 */
 ...
 * @template T
 *
 * @typedef {(character: string, isApple?: () => boolean) => T} MTKeyHandler
 */

/** @typedef {(event: KeyboardEvent, character: string, isApple?: () => boolean) => boolean} MTEventKeyHandler */
 ...
 *
 * @type {MTModifierHandler< ( isApple: () => boolean ) => MTModifierPart[]>}
 */
 ...
 * ```
 *
 * @type {MTModifierHandler<MTKeyHandler<string>>} Keyed map of functions to raw
 *                                                 shortcuts.
 */

var rawShortcut = Object(external_lodash_["mapValues"])(modifiers, function (modifier) {
  return (
    /** @type {MTKeyHandler<string>} */
    function (character) {
 ...
 * ```
 *
 * @type {MTModifierHandler<MTKeyHandler<string[]>>} Keyed map of functions to
 *                                                   shortcut sequences.
 */
...
var shortcutAriaLabel = Object(external_lodash_["mapValues"])(modifiers, function (modifier) {
  return (
    ...
    function (character) {
      ...
      var replacementKeyMap = (_replacementKeyMap2 = {}, Object(defineProperty["a" /* default */])(_replacementKeyMap2, SHIFT, 'Shift'), Object(defineProperty["a" /* default */])(_replacementKeyMap2, COMMAND, isApple ? 'Command' : 'Control'), Object(defineProperty["a" /* default */])(_replacementKeyMap2, CTRL, 'Control'), Object(defineProperty["a" /* default */])(_replacementKeyMap2, ALT, isApple ? 'Option' : 'Alt'), Object(defineProperty["a" /* default */])(_replacementKeyMap2, ',', Object(external_mt_i18n_["__"])('Comma')), Object(defineProperty["a" /* default */])(_replacementKeyMap2, '.', Object(external_mt_i18n_["__"])('Period')), Object(defineProperty["a" /* default */])(_replacementKeyMap2, '`', Object(external_mt_i18n_["__"])('Backtick')), _replacementKeyMap2);
 ...
 *
 * @return {Array<MTModifierPart>} Active modifier constants.
 */
 ...
 * ```
 *
 * @type {MTModifierHandler<MTEventKeyHandler>} Keyed map of functions
 *                                                       to match events.
 */
