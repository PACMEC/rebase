this["mt"] = this["mt"] || {}; this["mt"]["coreData"] =
  ...
  return external_regeneratorRuntime_default.a.wrap(function __unstableAcquireStoreLock$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          _context.next = 6;
          return Object(external_mt_dataControls_["__unstableAwaitPromise"])(promise);
  ...
  return external_regeneratorRuntime_default.a.wrap(function __unstableProcessPendingLockRequests$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          _context4.next = 4;
          return external_mt_data_["controls"].select('core', '__unstableGetPendingLockRequests');
        ...
        case 8:
          ...
          _context4.next = 13;
          return external_mt_data_["controls"].select('core', '__unstableIsLockAvailable', store, path, {
            exclusive: exclusive
          });
 ...
 * API request using the paCMec batch processing API (/v1/batch).
 *
 * ```
...
var controls = {
  ...
  GET_DISPATCH: Object(external_mt_data_["createRegistryControl"])(function (_ref2) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 13:
          ...
          if (query) {
            path = Object(external_mt_url_["addQueryArgs"])(path, query);
          }
          ...
          _context.next = 20;
          return Object(external_mt_dataControls_["__unstableAwaitPromise"])(__unstableFetch(options));
        ...
        case 23:
          _context.next = 25;
          return Object(external_mt_dataControls_["apiFetch"])(options);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return external_mt_data_["controls"].select('core', 'getEntity', kind, name);
        ...
        case 6:
          ...
          _context2.next = 9;
          return external_mt_data_["controls"].select('core', 'getRawEntityRecord', kind, name, recordId);

        case 9:
          record = _context2.sent;
          _context2.next = 12;
          return external_mt_data_["controls"].select('core', 'getEditedEntityRecord', kind, name, recordId);
  ...
  return external_regeneratorRuntime_default.a.wrap(function undo$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return external_mt_data_["controls"].select('core', 'getUndoEdit');
  ...
  return external_regeneratorRuntime_default.a.wrap(function redo$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return external_mt_data_["controls"].select('core', 'getRedoEdit');
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 33:
          ...
          _context5.next = 37;
          return external_mt_data_["controls"].select('core', 'getCurrentUser');

        case 37:
          currentUser = _context5.sent;
          currentUserId = currentUser ? currentUser.id : undefined;
          _context5.next = 41;
          return external_mt_data_["controls"].select('core', 'getAutosave', persistedRecord.type, persistedRecord.id, currentUserId);
        ...
        case 65:
          ...
          _context5.next = 71;
          return Object(external_mt_dataControls_["__unstableAwaitPromise"])(__unstableFetch(_options));
        ...
        case 74:
          _context5.next = 76;
          return Object(external_mt_dataControls_["apiFetch"])(_options);
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          _context6.next = 8;
          return Object(external_mt_dataControls_["__unstableAwaitPromise"])(Promise.all([batch.run()].concat(Object(toConsumableArray["a" /* default */])(resultPromises))));
  ...
  return external_regeneratorRuntime_default.a.wrap(function saveEditedEntityRecord$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return external_mt_data_["controls"].select('core', 'hasEditsForEntityRecord', kind, name, recordId);
        ...
        case 4:
          _context7.next = 6;
          return external_mt_data_["controls"].select('core', 'getEntityRecordNonTransientEdits', kind, name, recordId);
...
var defaultEntities = [{
  label: Object(external_mt_i18n_["__"])('Base'),
  name: '__unstableBase',
  kind: 'root',
  baseURL: ''
}, {
  label: Object(external_mt_i18n_["__"])('Site'),
  name: 'site',
  kind: 'root',
  baseURL: '/mt/v2/settings',
  getTitle: function getTitle(record) {
    return Object(external_lodash_["get"])(record, ['title'], Object(external_mt_i18n_["__"])('Site Title'));
  }
}, {
  label: Object(external_mt_i18n_["__"])('Post Type'),
  name: 'postType',
  kind: 'root',
  key: 'slug',
  baseURL: '/mt/v2/types'
  ...
  baseURL: '/mt/v2/media',
  plural: 'mediaItems',
  label: Object(external_mt_i18n_["__"])('Media')
}, {
  name: 'taxonomy',
  kind: 'root',
  key: 'slug',
  baseURL: '/mt/v2/taxonomies',
  plural: 'taxonomies',
  label: Object(external_mt_i18n_["__"])('Taxonomy')
}, {
  name: 'sidebar',
  kind: 'root',
  baseURL: '/mt/v2/sidebars',
  plural: 'sidebars',
  transientEdits: {
    blocks: true
  },
  label: Object(external_mt_i18n_["__"])('Widget areas')
}, {
  name: 'widget',
  kind: 'root',
  baseURL: '/mt/v2/widgets',
  plural: 'widgets',
  transientEdits: {
    blocks: true
  },
  label: Object(external_mt_i18n_["__"])('Widgets')
}, {
  label: Object(external_mt_i18n_["__"])('User'),
  name: 'user',
  kind: 'root',
  baseURL: '/mt/v2/users',
  plural: 'users'
  ...
  name: 'comment',
  kind: 'root',
  baseURL: '/mt/v2/comments',
  plural: 'comments',
  label: Object(external_mt_i18n_["__"])('Comment')
}, {
  name: 'menu',
  kind: 'root',
  baseURL: '/__experimental/menus',
  plural: 'menus',
  label: Object(external_mt_i18n_["__"])('Menu')
}, {
  name: 'menuItem',
  kind: 'root',
  baseURL: '/__experimental/menu-items',
  plural: 'menuItems',
  label: Object(external_mt_i18n_["__"])('Menu Item')
}, {
  name: 'menuLocation',
  kind: 'root',
  baseURL: '/__experimental/menu-locations',
  plural: 'menuLocations',
  label: Object(external_mt_i18n_["__"])('Menu Location'),
  key: 'name'
}];
var kinds = [{
  name: 'postType',
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return Object(external_mt_dataControls_["apiFetch"])({
            path: '/mt/v2/types?context=edit'
          });

        case 2:
          postTypes = _context.sent;
          return _context.abrupt("return", Object(external_lodash_["map"])(postTypes, function (postType, name) {
            var isTemplate = ['mt_template', 'mt_template_part'].includes(name);
            return {
              kind: 'postType',
              baseURL: '/mt/v2/' + postType.rest_base,
              name: name,
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: '/mt/v2/taxonomies?context=edit'
          });
        ...
        case 2:
          ...
          return _context2.abrupt("return", Object(external_lodash_["map"])(taxonomies, function (taxonomy, name) {
            return {
              kind: 'taxonomy',
              baseURL: '/mt/v2/' + taxonomy.rest_base,
              name: name,
  ...
  return external_regeneratorRuntime_default.a.wrap(function getKindEntities$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return external_mt_data_["controls"].select('core', 'getEntitiesByKind', kind);
 ...
 *
 * @typedef {Object} MTQueriedDataQueryParts
 *
 ...
 * @param {Object} query Optional query object.
 *
 * @return {MTQueriedDataQueryParts} Query parts.
 */

function getQueryParts(query) {
  /**
   * @type {MTQueriedDataQueryParts}
   */
  var parts = {
    stableKey: '',
    page: 1,
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    switch (key) {
      ...
      default:
        ...
        parts.stableKey += (parts.stableKey ? '&' : '') + Object(external_mt_url_["addQueryArgs"])('', Object(defineProperty["a" /* default */])({}, key, value)).slice(1);
    }
  }
...
/* harmony default export */ var queried_data_reducer = (Object(external_mt_data_["combineReducers"])({
  items: reducer_items,
...
function reducer_entity(entityConfig) {
  ...
  })])(Object(external_mt_data_["combineReducers"])({
...
var reducer_entities = function entities() {
  ...
  if (!entitiesDataReducer || newConfig !== state.config) {
    ...
    entitiesDataReducer = Object(external_mt_data_["combineReducers"])(Object.entries(entitiesByKind).reduce(function (memo, _ref) {
      var _ref2 = Object(slicedToArray["a" /* default */])(_ref, 2),
          kind = _ref2[0],
          subEntities = _ref2[1];

      var kindReducer = Object(external_mt_data_["combineReducers"])(subEntities.reduce(function (kindMemo, entityConfig) {
...
function reducer_undo() {
  ...
  switch (action.type) {
    ...
    case 'CREATE_UNDO_LEVEL':
      ...
      if (!external_mt_isShallowEqual_default()(comparisonUndoEdits, comparisonEdits)) {
        nextState.push({
          kind: action.kind,
          name: action.name,
...
/* harmony default export */ var build_module_reducer = (Object(external_mt_data_["combineReducers"])({
  terms: terms,
  users: reducer_users,
  currentTheme: currentTheme,
...
var isRequestingEmbedPreview = Object(external_mt_data_["createRegistrySelector"])(function (select) {
...
function getAuthors(state, query) {
  var path = Object(external_mt_url_["addQueryArgs"])('/mt/v2/users/?who=authors&per_page=100', query);
 ...
 *
 * paCMec can be configured to return a simple link to a URL if it is not embeddable.
...
function hasUploadPermissions(state) {
  external_mt_deprecated_default()("select( 'core' ).hasUploadPermissions()", {
...
var hasFetchedAutosaves = Object(external_mt_data_["createRegistrySelector"])(function (select) {
...
function __experimentalGetTemplateForLink(state, link) {
  var records = getEntityRecords(state, 'postType', 'mt_template', {
    'find-template': link
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return external_mt_data_["controls"].select('core', 'hasStartedResolution', selectorName, args);
...
function resolvers_getAuthors(query) {
  ...
  return external_regeneratorRuntime_default.a.wrap(function getAuthors$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          path = Object(external_mt_url_["addQueryArgs"])('/mt/v2/users/?who=authors&per_page=100', query);
          _context.next = 3;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: path
          });
...
function resolvers_unstableGetAuthor(id) {
  ...
  return external_regeneratorRuntime_default.a.wrap(function __unstableGetAuthor$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          path = "/mt/v2/users?who=authors&include=".concat(id);
          _context2.next = 3;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: path
          });
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 9:
          ...
          _context4.next = 17;
          return external_mt_data_["controls"].select('core', 'hasEntityRecords', kind, name, query);
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 8:
          ...
          path = Object(external_mt_url_["addQueryArgs"])(entity.baseURL, resolvers_objectSpread(resolvers_objectSpread({}, query), {}, {
            context: 'edit'
          }));
          _context5.t1 = Object;
          _context5.next = 15;
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: '/mt/v2/themes?status=active'
          });
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          ...
          _context8.next = 3;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: Object(external_mt_url_["addQueryArgs"])('/oembed/1.0/proxy', {
              url: url
            })
          });
  ...
  return external_regeneratorRuntime_default.a.wrap(function canUser$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 4:
          path = id ? "/mt/v2/".concat(resource, "/").concat(id) : "/mt/v2/".concat(resource);
          _context10.prev = 5;
          _context10.next = 8;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: path,
  ...
  return external_regeneratorRuntime_default.a.wrap(function getAutosaves$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _context11.next = 2;
          return external_mt_data_["controls"].resolveSelect('core', 'getPostType', postType);
        ...
        case 2:
          ...
          _context11.next = 6;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: "/mt/v2/".concat(restBase, "/").concat(postId, "/autosaves?context=edit")
          });
  ...
  return external_regeneratorRuntime_default.a.wrap(function getAutosave$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        case 0:
          _context12.next = 2;
          return external_mt_data_["controls"].resolveSelect('core', 'getAutosaves', postType, postId);
  ...
  return external_regeneratorRuntime_default.a.wrap(function __experimentalGetTemplateForLink$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        case 0:
          _context13.next = 2;
          return regularFetch(Object(external_mt_url_["addQueryArgs"])(link, {
            '_mt-find-template': true
          }));
        ...
        case 5:
          _context13.next = 7;
          return resolvers_getEntityRecord('postType', 'mt_template', template.id);

        case 7:
          _context13.next = 9;
          return external_mt_data_["controls"].select('core', 'getEntityRecord', 'postType', 'mt_template', template.id);
        ...
        case 9:
          ...
          _context13.next = 13;
          return receiveEntityRecords('postType', 'mt_template', [record], {
            'find-template': link
          });
...
var entity_provider_entities = entity_provider_objectSpread(entity_provider_objectSpread({}, defaultEntities.reduce(function (acc, entity) {
  ...
  acc[entity.kind][entity.name] = {
    context: Object(external_mt_element_["createContext"])()
  };
  return acc;
...
function useEntityId(kind, type) {
  return Object(external_mt_element_["useContext"])(entity_provider_getEntity(kind, type).context);
}
/**
...
function useEntityProp(kind, type, prop, _id) {
  ...
  var setValue = Object(external_mt_element_["useCallback"])(function (newValue) {
 ...
 *
 * @return {[MTBlock[], Function, Function]} The block array and setters.
 */
...
function useEntityBlockEditor(kind, type) {
  ...
  var _useDispatch2 = Object(external_mt_data_["useDispatch"])('core'),
  ...
  Object(external_mt_element_["useEffect"])(function () {
    ...
    if (content && typeof content !== 'function' && !blocks) {
      var parsedContent = Object(external_mt_blocks_["parse"])(content);
  ...
  var onChange = Object(external_mt_element_["useCallback"])(function (newBlocks, options) {
  ...
  var onInput = Object(external_mt_element_["useCallback"])(function (newBlocks, options) {
    var selectionStart = options.selectionStart,
        selectionEnd = options.selectionEnd;
    var edits = {
      blocks: newBlocks,
...
var storeConfig = {
  ...
  controls: build_module_objectSpread(build_module_objectSpread({}, build_module_controls), external_mt_dataControls_["controls"]),
...
var build_module_store = Object(external_mt_data_["createReduxStore"])(STORE_NAME, storeConfig);
Object(external_mt_data_["register"])(build_module_store);
