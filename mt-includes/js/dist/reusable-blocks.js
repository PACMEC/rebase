this["mt"] = this["mt"] || {}; this["mt"]["reusableBlocks"] =
...
var controls = {
  CONVERT_BLOCK_TO_STATIC: Object(external_mt_data_["createRegistryControl"])(function (registry) {
    return function (_ref) {
      var clientId = _ref.clientId;
      var oldBlock = registry.select('core/block-editor').getBlock(clientId);
      var reusableBlock = registry.select('core').getEditedEntityRecord('postType', 'mt_block', oldBlock.attributes.ref);
      var newBlocks = Object(external_mt_blocks_["parse"])(reusableBlock.content);
      registry.dispatch('core/block-editor').replaceBlocks(oldBlock.clientId, newBlocks);
    };
  }),
  CONVERT_BLOCKS_TO_REUSABLE: Object(external_mt_data_["createRegistryControl"])(function (registry) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                reusableBlock = {
                  title: Object(external_mt_i18n_["__"])('Untitled Reusable Block'),
                  content: Object(external_mt_blocks_["serialize"])(registry.select('core/block-editor').getBlocksByClientId(clientIds)),
                  status: 'publish'
                };
                _context.next = 4;
                return registry.dispatch('core').saveEntityRecord('postType', 'mt_block', reusableBlock);

              case 4:
                updatedRecord = _context.sent;
                newBlock = Object(external_mt_blocks_["createBlock"])('core/block', {
  ...
  DELETE_REUSABLE_BLOCK: Object(external_mt_data_["createRegistryControl"])(function (registry) {
    return /*#__PURE__*/function () {
        ...
        return external_regeneratorRuntime_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                id = _ref4.id;
                reusableBlock = registry.select('core').getEditedEntityRecord('postType', 'mt_block', id); // Don't allow a reusable block with a temporary ID to be deleted
              ...
              case 4:
                ...
                associatedBlocks = allBlocks.filter(function (block) {
                  return Object(external_mt_blocks_["isReusableBlock"])(block) && block.attributes.ref === id;
                });
                ...
                _context2.next = 10;
                return registry.dispatch('core').deleteEntityRecord('postType', 'mt_block', id);
...
var reusable_block_reusableBlock = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
...
function ReusableBlockConvertButton(_ref) {
  ...
  var canConvert = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    var isReusable = blocks.length === 1 && blocks[0] && Object(external_mt_blocks_["isReusableBlock"])(blocks[0]) && !!select('core').getEntityRecord('postType', 'mt_block', blocks[0].attributes.ref);
    ...
    canInsertBlockType('core/block', rootClientId) && blocks.every(function (block) {
      return (// Guard against the case where a regular block has *just* been converted.
        ...
        Object(external_mt_blocks_["hasBlockSupport"])(block.name, 'reusable', true)
      );
  ...
  var onConvert = Object(external_mt_element_["useCallback"])( /*#__PURE__*/Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/external_regeneratorRuntime_default.a.mark(function _callee() {
    return external_regeneratorRuntime_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            createSuccessNotice(Object(external_mt_i18n_["__"])('Block created.'), {
              type: 'snackbar'
            });
            _context.next = 9;
            break;
  ...
  return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockSettingsMenuControls"], null, function (_ref3) {
    ...
    }, Object(external_mt_i18n_["__"])('Add to Reusable blocks'));
  });
}
...
function ReusableBlocksManageButton(_ref) {
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    return {
      isVisible: !!reusableBlock && Object(external_mt_blocks_["isReusableBlock"])(reusableBlock) && !!canUser('update', 'blocks', reusableBlock.attributes.ref)
    };
  }, [clientId]),
  ...
  return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockSettingsMenuControls"], null, Object(external_mt_element_["createElement"])(external_mt_components_["MenuItem"], {
    href: Object(external_mt_url_["addQueryArgs"])('edit.php', {
      post_type: 'mt_block'
    })
  }, Object(external_mt_i18n_["__"])('Manage Reusable blocks')));
}
...
function ReusableBlocksMenuItems(_ref) {
  var clientIds = _ref.clientIds,
      rootClientId = _ref.rootClientId;
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(ReusableBlockConvertButton, {
    clientIds: clientIds,
    rootClientId: rootClientId
  }), clientIds.length === 1 && Object(external_mt_element_["createElement"])(reusable_blocks_manage_button, {
    clientId: clientIds[0]
  }));
}

/* harmony default export */ var reusable_blocks_menu_items = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/block-editor'),
