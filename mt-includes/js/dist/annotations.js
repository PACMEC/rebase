this["mt"] = this["mt"] || {}; this["mt"]["annotations"] =
...
function applyAnnotations(record) {
  ...
  annotations.forEach(function (annotation) {
    ...
    record = Object(external_mt_richText_["applyFormat"])(record, {
      type: FORMAT_NAME,
      attributes: {
        className: className,
        id: id
...
function removeAnnotations(record) {
  return Object(external_mt_richText_["removeFormat"])(record, 'core/annotation', 0, record.text.length);
}
/**
...
var annotation_annotation = {
  name: FORMAT_NAME,
  title: Object(external_mt_i18n_["__"])('Annotation'),
  tagName: 'mark',
...
Object(external_mt_richText_["registerFormatType"])(format_name, settings);
...
var block_addAnnotationClassName = function addAnnotationClassName(OriginalComponent) {
  return Object(external_mt_data_["withSelect"])(function (select, _ref) {
...
Object(external_mt_hooks_["addFilter"])('editor.BlockListBlock', 'core/annotations', block_addAnnotationClassName);
 ...
 * @param {MTAnnotationRange} annotation.range              The range at which to apply this annotation.
