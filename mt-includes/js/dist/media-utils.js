this["mt"] = this["mt"] || {}; this["mt"]["mediaUtils"] =
 ...
 *
 * @return {mt.media.view.MediaFrame.Select} The default media workflow.
 */

var getFeaturedImageMediaFrame = function getFeaturedImageMediaFrame() {
  return mt.media.view.MediaFrame.Select.extend({
    /**
    ...
    editState: function editState() {
      ...
      var view = new mt.media.view.EditImage({
    ...
    createStates: function createStates() {
      ...
      this.states.add([new mt.media.controller.FeaturedImage(), new mt.media.controller.EditImage({
 ...
 *
 * @return {mt.media.view.MediaFrame.Post} The default media workflow.
 */
...
var media_upload_getGalleryDetailsMediaFrame = function getGalleryDetailsMediaFrame() {
   ...
   *
   * @see https://github.com/xmt/mt-core-media-widgets/blob/905edbccfc2a623b73a93dac803c5335519d7837/mt-admin/js/widgets/media-gallery-widget.js
   * @class GalleryDetailsMediaFrame
   * @class
   */
  return mt.media.view.MediaFrame.Post.extend({
    /**
    ...
    galleryToolbar: function galleryToolbar() {
      ...
      this.toolbar.set(new mt.media.view.Toolbar({
        ...
        items: {
          insert: {
            style: 'primary',
            text: editing ? mt.media.view.l10n.updateGallery : mt.media.view.l10n.insertGallery,
            priority: 80,
            requires: {
              library: true
            },
    ...
    createStates: function createStates() {
      ...
      this.on('content:render:edit-image', this.editState, this);
      this.states.add([new mt.media.controller.Library({
        id: 'gallery',
        title: mt.media.view.l10n.createGalleryTitle,
        priority: 40,
        toolbar: 'main-gallery',
        filterable: 'uploaded',
        multiple: 'add',
        editable: false,
        library: mt.media.query(Object(external_lodash_["defaults"])({
          type: 'image'
...
var media_upload_MediaUpload = /*#__PURE__*/function (_Component) {
  ...
  function MediaUpload(_ref) {
    ...
    var allowedTypes = _ref.allowedTypes,
        ...
        title = _ref$title === void 0 ? Object(external_mt_i18n_["__"])('Select or Upload Media') : _ref$title;
    ...
    if (gallery) {
      ...
      _this.frame = mt.media(frameConfig);
    }
  ...
  Object(createClass["a" /* default */])(MediaUpload, [{
    ...
    value: function buildAndSetGalleryFrame() {
      ...
      var selection = new mt.media.model.Selection(attachments.models, {
    ...
    value: function onOpen() {
      ...
      if (!this.props.gallery) {
        ...
        Object(external_lodash_["castArray"])(this.props.value).forEach(function (id) {
          selection.add(mt.media.attachment(id));
        });
 ...
 *
 * @param {?Object} mtMimeTypesObject Mime type object received from the server.
 *                                    Extensions are keys separated by '|' and values are mime types associated with an extension.
 *
 * @return {?Array} An array of mime types or the parameter passed if it was "falsy".
 */

function getMimeTypesArray(mtMimeTypesObject) {
  if (!mtMimeTypesObject) {
    return mtMimeTypesObject;
  }

  return Object(external_lodash_["flatMap"])(mtMimeTypesObject, function (mime, extensionsString) {
 ...
 * @param   {?Object}  $0.mtAllowedMimeTypes List of allowed mime types and file extensions.
 */
...
function _uploadMedia() {
  _uploadMedia = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/external_regeneratorRuntime_default.a.mark(function _callee(_ref) {
    var allowedTypes, _ref$additionalData, additionalData, filesList, maxUploadFileSize, _ref$onError, onError, onFileChange, _ref$mtAllowedMimeTyp, mtAllowedMimeTypes, files, filesSet, setAndUpdateFiles, isAllowedType, allowedMimeTypesForUser, isAllowedMimeTypeForUser, triggerError, validFiles, _iterator, _step, _mediaFile, idx, mediaFile, savedMedia, mediaObject, message;

    return external_regeneratorRuntime_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            allowedTypes = _ref.allowedTypes, _ref$additionalData = _ref.additionalData, additionalData = _ref$additionalData === void 0 ? {} : _ref$additionalData, filesList = _ref.filesList, maxUploadFileSize = _ref.maxUploadFileSize, _ref$onError = _ref.onError, onError = _ref$onError === void 0 ? external_lodash_["noop"] : _ref$onError, onFileChange = _ref.onFileChange, _ref$mtAllowedMimeTyp = _ref.mtAllowedMimeTypes, mtAllowedMimeTypes = _ref$mtAllowedMimeTyp === void 0 ? null : _ref$mtAllowedMimeTyp;
            // Cast filesList to array
            files = Object(toConsumableArray["a" /* default */])(filesList);
            filesSet = [];

            setAndUpdateFiles = function setAndUpdateFiles(idx, value) {
              Object(external_mt_blob_["revokeBlobURL"])(Object(external_lodash_["get"])(filesSet, [idx, 'url']));
              filesSet[idx] = value;
            ...
            }; // Allowed types for the current MT_User


            allowedMimeTypesForUser = getMimeTypesArray(mtAllowedMimeTypes);
            ...
            triggerError = function triggerError(error) {
              error.message = [Object(external_mt_element_["createElement"])("strong", {
                key: "filename"
          ...
          case 12:
            ...
            triggerError({
              ...
              message: Object(external_mt_i18n_["__"])('Sorry, this file type is not permitted for security reasons.'),
              file: _mediaFile
            });
          ...
          case 17:
            ...
            triggerError({
              ...
              message: Object(external_mt_i18n_["__"])('Sorry, this file type is not supported here.'),
              file: _mediaFile
            });
            return _context.abrupt("continue", 29);
          ...
          case 20:
            ...
            triggerError({
              ...
              message: Object(external_mt_i18n_["__"])('This file exceeds the maximum upload size for this site.'),
              file: _mediaFile
            });
            return _context.abrupt("continue", 29);
          ...
          case 23:
            ...
            triggerError({
              code: 'EMPTY_FILE',
              message: Object(external_mt_i18n_["__"])('This file is empty.'),
              file: _mediaFile
            });
            return _context.abrupt("continue", 29);
          ...
          case 26:
            ...
            filesSet.push({
              url: Object(external_mt_blob_["createBlobURL"])(_mediaFile)
            });
          ...
          case 50:
            ...
            if (Object(external_lodash_["has"])(_context.t1, ['message'])) {
              ...
              message = Object(external_mt_i18n_["sprintf"])( // translators: %s: file name
              Object(external_mt_i18n_["__"])('Error while uploading file %s to the media library.'), mediaFile.name);
            }
