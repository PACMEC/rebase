this["mt"] = this["mt"] || {}; this["mt"]["editor"] =
...
(function() { module.exports = window["mt"]["wordcount"]; }());
...
(function() { module.exports = window["mt"]["reusableBlocks"]; }());
...
(function() { module.exports = window["mt"]["richText"]; }());
...
var layout = Object(_managertechnology_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_managertechnology_primitives__WEBPACK_IMPORTED_MODULE_1__["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "-2 -2 24 24"
}, Object(_managertechnology_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_managertechnology_primitives__WEBPACK_IMPORTED_MODULE_1__["Path"], {
...
(function() { module.exports = window["mt"]["deprecated"]; }());
...
__webpack_require__.d(__webpack_exports__, "ServerSideRender", function() { return /* reexport */ external_mt_serverSideRender_default.a; });
...
__webpack_require__.d(__webpack_exports__, "transformStyles", function() { return /* reexport */ external_mt_blockEditor_["transformStyles"]; });

// NAMESPACE OBJECT: ./node_modules/@managertechnology/editor/build-module/store/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@managertechnology/editor/build-module/store/actions.js
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/hooks/custom-sources-backwards-compatibility.js
...
/** @typedef {import('@managertechnology/compose').MTHigherOrderComponent} MTHigherOrderComponent */

/** @typedef {import('@managertechnology/blocks').MTBlockSettings} MTBlockSettings */
 ...
 * post's meta keys.
 *
 * @param {MTMetaAttributeMapping} metaAttributes Meta attribute mapping.
 *
 * @return {MTHigherOrderComponent} Higher-order component.
 */
...
var custom_sources_backwards_compatibility_createWithMetaAttributeSource = function createWithMetaAttributeSource(metaAttributes) {
  return Object(external_mt_compose_["createHigherOrderComponent"])(function (BlockEdit) {
    return function (_ref) {
      var attributes = _ref.attributes,
          _setAttributes = _ref.setAttributes,
          props = Object(objectWithoutProperties["a" /* default */])(_ref, ["attributes", "setAttributes"]);

      var postType = Object(external_mt_data_["useSelect"])(function (select) {
        return select('core/editor').getCurrentPostType();
      }, []);

      var _useEntityProp = Object(external_mt_coreData_["useEntityProp"])('postType', postType, 'meta'),
          _useEntityProp2 = Object(slicedToArray["a" /* default */])(_useEntityProp, 2),
          meta = _useEntityProp2[0],
          setMeta = _useEntityProp2[1];

      var mergedAttributes = Object(external_mt_element_["useMemo"])(function () {
        return _objectSpread(_objectSpread({}, attributes), Object(external_lodash_["mapValues"])(metaAttributes, function (metaKey) {
          return meta[metaKey];
        }));
      }, [attributes, meta]);
      return Object(external_mt_element_["createElement"])(BlockEdit, Object(esm_extends["a" /* default */])({
 ...
 *
 * @param {MTBlockSettings} settings Registered block settings.
 *
 * @return {MTBlockSettings} Filtered block settings.
 */


function shimAttributeSource(settings) {
  /** @type {MTMetaAttributeMapping} */
...
Object(external_mt_hooks_["addFilter"])('blocks.registerBlockType', 'core/editor/custom-sources-backwards-compatibility/shim-attribute-source', shimAttributeSource); // The above filter will only capture blocks registered after the filter was
...
Object(external_mt_data_["select"])(external_mt_blocks_["store"]).getBlockTypes().map(function (_ref2) {
  var name = _ref2.name;
  return Object(external_mt_data_["select"])(external_mt_blocks_["store"]).getBlockType(name);
}).forEach(shimAttributeSource);

// EXTERNAL MODULE: external ["mt","apiFetch"]
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/autocompleters/user.js
...
/** @typedef {import('@managertechnology/components').MTCompleter} MTCompleter */
...
/* harmony default export */ var autocompleters_user = ({
  ...
  options: function options(search) {
    ...
    return external_mt_apiFetch_default()({
      path: '/mt/v2/users' + payload
    });
  },
  isDebounced: true,
  ...
  getOptionLabel: function getOptionLabel(user) {
    var avatar = user.avatar_urls && user.avatar_urls[24] ? Object(external_mt_element_["createElement"])("img", {
      key: "avatar",
      className: "editor-autocompleters__user-avatar",
      alt: "",
      src: user.avatar_urls[24]
    }) : Object(external_mt_element_["createElement"])("span", {
      className: "editor-autocompleters__no-avatar"
    });
    return [avatar, Object(external_mt_element_["createElement"])("span", {
      key: "name",
      className: "editor-autocompleters__user-name"
    }, user.name), Object(external_mt_element_["createElement"])("span", {
      key: "slug",
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/hooks/default-autocompleters.js
/**
 * External dependencies
 */
...
Object(external_mt_hooks_["addFilter"])('editor.Autocomplete.completers', 'editor/autocompleters/set-default-completers', setDefaultCompleters);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/hooks/index.js
/**
 * Internal dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/defaults.js
...
var PREFERENCES_DEFAULTS = {
  insertUsage: {},
  // Should be kept for backward compatibility, see: https://github.com/paCMec/gutenberg/issues/14580.
 ...
 *  enableCustomFields boolean       Whether the paCMec custom fields are enabled or not
...
var EDITOR_SETTINGS_DEFAULTS = defaults_objectSpread(defaults_objectSpread({}, external_mt_blockEditor_["SETTINGS_DEFAULTS"]), {}, {
  richEditingEnabled: true,
  codeEditingEnabled: true,
  enableCustomFields: false
});

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/reducer.js
 ...
 * the MT REST API is in progress, successful, or failed).
 *
 * @param {Object} state  Current state.
 * @param {Object} action Dispatched action.
 *
...
// EXTERNAL MODULE: external ["mt","deprecated"]
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/constants.js
/**
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/utils/url.js
/**
 * External dependencies
 */
...
/**
 * Returns the URL of a MTAdmin Page.
 *
 ...
 *
 * @return {string} MTAdmin URL.
 */

function getMTAdminURL(page, query) {
  return Object(external_mt_url_["addQueryArgs"])(page, query);
}
/**
 * Performs some basic cleanup of a string for use as a post slug
 *
 * This replicates some of what sanitize_title() does in paCMec core, but
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/selectors.js
...
var hasEditorUndo = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function () {
...
var hasEditorRedo = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function () {
...
var selectors_isEditedPostDirty = Object(external_mt_data_["createRegistrySelector"])(function (select) {
...
var selectors_hasNonPostEntityChanges = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
...
var selectors_getCurrentPost = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    var postId = selectors_getCurrentPostId(state);
    var postType = selectors_getCurrentPostType(state);
...
var selectors_getPostEdits = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    var postType = selectors_getCurrentPostType(state);
    var postId = selectors_getCurrentPostId(state);
...
var getReferenceByDistinctEdits = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function ()
  /* state */
  {
    external_mt_deprecated_default()("`mt.data.select( 'core/editor' ).getReferenceByDistinctEdits`", {
      alternative: "`mt.data.select( 'core' ).getReferenceByDistinctEdits`"
    });
 ...
 * 			   from the '@managertechnology/core-data' package and access properties on the returned
...
var getAutosaveAttribute = Object(external_mt_data_["createRegistrySelector"])(function (select) {
...
function selectors_isCurrentPostPublished(state, currentPost) {
  ...
  return ['publish', 'private'].indexOf(post.status) !== -1 || post.status === 'future' && !Object(external_mt_date_["isInTheFuture"])(new Date(Number(Object(external_mt_date_["getDate"])(post.date)) - ONE_MINUTE_IN_MS));
}
/**
...
function selectors_isEditedPostSaveable(state) {
  ...
  //  See: https://github.com/paCMec/gutenberg/pull/4184


  return !!selectors_getEditedPostAttribute(state, 'title') || !!selectors_getEditedPostAttribute(state, 'excerpt') || !isEditedPostEmpty(state) || external_mt_element_["Platform"].OS === 'native';
}
/**
...
function isEditedPostEmpty(state) {
  ...
  if (blocks.length) {
    ...
    if (blockName !== Object(external_mt_blocks_["getDefaultBlockName"])() && blockName !== Object(external_mt_blocks_["getFreeformContentHandlerName"])()) {
      return false;
    }
  }
...
var selectors_isEditedPostAutosaveable = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
 ...
 * 			   selector from the '@managertechnology/core-data' package.
 *
 * @param {Object} state Editor state.
 *
...
var getAutosave = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    external_mt_deprecated_default()("`mt.data.select( 'core/editor' ).getAutosave()`", {
      alternative: "`mt.data.select( 'core' ).getAutosave( postType, postId, userId )`",
      plugin: 'Gutenberg'
    });
    var postType = selectors_getCurrentPostType(state);
    var postId = selectors_getCurrentPostId(state);
 ...
 *
 * @deprecated since 5.6. Callers should use the `getAutosave( postType, postId, userId )` selector
 *             from the '@managertechnology/core-data' package and check for a truthy value.
 *
 * @param {Object} state Global application state.
 *
...
var hasAutosave = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    external_mt_deprecated_default()("`mt.data.select( 'core/editor' ).hasAutosave()`", {
      alternative: "`!! mt.data.select( 'core' ).getAutosave( postType, postId, userId )`",
      plugin: 'Gutenberg'
    });
    var postType = selectors_getCurrentPostType(state);
...
function selectors_isEditedPostBeingScheduled(state) {
  ...
  var checkedDate = new Date(Number(Object(external_mt_date_["getDate"])(date)) - ONE_MINUTE_IN_MS);
  return Object(external_mt_date_["isInTheFuture"])(checkedDate);
}
/**
...
function isEditedPostDateFloating(state) {
  ...
  // See https://github.com/paCMec/gutenberg/issues/28083
...
var selectors_isSavingPost = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    var postType = selectors_getCurrentPostType(state);
    var postId = selectors_getCurrentPostId(state);
...
var didPostSaveRequestSucceed = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    var postType = selectors_getCurrentPostType(state);
    var postId = selectors_getCurrentPostId(state);
...
var didPostSaveRequestFail = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    var postType = selectors_getCurrentPostType(state);
    var postId = selectors_getCurrentPostId(state);
    return !!select('core').getLastEntitySaveError('postType', postType, postId);
...
function selectors_getEditedPostPreviewLink(state) {
  ...
  if (!previewLink) {
    ...
    if (previewLink) {
      previewLink = Object(external_mt_url_["addQueryArgs"])(previewLink, {
        preview: true
      });
    }
  }
  ...
  if (previewLink && featuredImageId) {
    return Object(external_mt_url_["addQueryArgs"])(previewLink, {
 ...
 * @param {Object} state Editor state.
 *
 * @return {MTBlock[]} Filtered set of blocks for save.
 */

function getBlocksForSerialization(state) {
  external_mt_deprecated_default()('`core/editor` getBlocksForSerialization selector', {
    plugin: 'Gutenberg',
  ...
  var isSingleUnmodifiedDefaultBlock = blocks.length === 1 && Object(external_mt_blocks_["isUnmodifiedDefaultBlock"])(blocks[0]);
...
var getEditedPostContent = Object(external_mt_data_["createRegistrySelector"])(function (select) {
  return function (state) {
    var postId = selectors_getCurrentPostId(state);
    var postType = selectors_getCurrentPostType(state);
    ...
    if (record) {
      if (typeof record.content === 'function') {
        ...
        return Object(external_mt_blocks_["__unstableSerializeAndClean"])(record.blocks);
...
function selectors_canUserUseUnfilteredHTML(state) {
  return Object(external_lodash_["has"])(selectors_getCurrentPost(state), ['_links', 'mt:action-unfiltered-html']);
}
/**
 ...
 *
 * @typedef {Object} MTBlockSelection
 *
 * @property {string} clientId     A block client ID.
 * @property {string} attributeKey A block attribute key.
 * @property {number} offset       An attribute value offset, based on the rich
 *                                 text value. See `mt.richText.create`.
 */
 ...
 *
 * @param {Object} state
 * @return {MTBlockSelection} The selection start.
 */
 ...
 *
 * @param {Object} state
 * @return {MTBlockSelection} The selection end.
 */
...
function getStateBeforeOptimisticTransaction() {
  external_mt_deprecated_default()("select('core/editor').getStateBeforeOptimisticTransaction", {
...
function inSomeHistory() {
  external_mt_deprecated_default()("select('core/editor').inSomeHistory", {
    hint: 'No state history is kept on this store anymore'
  });
  return false;
}
...
function getBlockEditorSelector(name) {
  return Object(external_mt_data_["createRegistrySelector"])(function (select) {
    return function (state) {
      var _select;

      external_mt_deprecated_default()("`mt.data.select( 'core/editor' )." + name + '`', {
        alternative: "`mt.data.select( 'core/block-editor' )." + name + '`'
      });
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/utils/notice-builder.js
/**
 * paCMec dependencies
 */
...
function getNotificationArgumentsForSaveFail(data) {
  ...
  var messages = {
    publish: Object(external_mt_i18n_["__"])('Publishing failed.'),
    private: Object(external_mt_i18n_["__"])('Publishing failed.'),
    future: Object(external_mt_i18n_["__"])('Scheduling failed.')
  };
  var noticeMessage = !isPublished && publishStatus.indexOf(edits.status) !== -1 ? messages[edits.status] : Object(external_mt_i18n_["__"])('Updating failed.'); // Check if message string contains HTML. Notice text is currently only
...
function getNotificationArgumentsForTrashFail(data) {
  return [data.error.message && data.error.code !== 'unknown_error' ? data.error.message : Object(external_mt_i18n_["__"])('Trashing failed'), {
    id: TRASH_POST_NOTICE_ID
  }];
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/actions.js
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          blocks = Object(external_mt_blocks_["parse"])(content); // Apply a template for new posts only, if exists.

          isNewPost = post.status === 'auto-draft';

          if (isNewPost && template) {
            blocks = Object(external_mt_blocks_["synchronizeBlocksWithTemplate"])(blocks, template);
          }
  ...
  return external_regeneratorRuntime_default.a.wrap(function resetAutosave$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          external_mt_deprecated_default()('resetAutosave action (`core/editor` store)', {
            alternative: 'receiveAutosaves action (`core` store)',
            plugin: 'Gutenberg'
          });
          _context2.next = 3;
          return external_mt_data_["controls"].select(STORE_NAME, 'getCurrentPostId');

        case 3:
          postId = _context2.sent;
          _context2.next = 6;
          return external_mt_data_["controls"].dispatch('core', 'receiveAutosaves', postId, newAutosave);
...
function updatePost() {
  external_mt_deprecated_default()("mt.data.dispatch( 'core/editor' ).updatePost", {
  ...
  return external_regeneratorRuntime_default.a.wrap(function editPost$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return external_mt_data_["controls"].select(STORE_NAME, 'getCurrentPost');
        ...
        case 2:
          ...
          _context3.next = 7;
          return external_mt_data_["controls"].dispatch('core', 'editEntityRecord', 'postType', type, id, edits, options);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return external_mt_data_["controls"].select(STORE_NAME, 'isEditedPostSaveable');
        ...
        case 5:
          _context4.next = 7;
          return external_mt_data_["controls"].select(STORE_NAME, 'getEditedPostContent');
        ...
        case 7:
          ...
          _context4.next = 12;
          return external_mt_data_["controls"].dispatch(STORE_NAME, 'editPost', edits, {
            undoIgnore: true
          });
        ...
        case 16:
          ...
          _context4.next = 22;
          return external_mt_data_["controls"].select('core', 'getEntityRecordNonTransientEdits', 'postType', previousRecord.type, previousRecord.id);
        ...
        case 22:
          ...
          _context4.next = 28;
          return external_mt_data_["controls"].dispatch('core', 'saveEntityRecord', 'postType', previousRecord.type, edits, options);
        ...
        case 30:
          _context4.next = 32;
          return external_mt_data_["controls"].select('core', 'getLastEntitySaveError', 'postType', previousRecord.type, previousRecord.id);
        ...
        case 32:
          ...
          _context4.next = 38;
          return external_mt_data_["controls"].dispatch.apply(external_mt_data_["controls"], [external_mt_notices_["store"], 'createErrorNotice'].concat(Object(toConsumableArray["a" /* default */])(args)));
        ...
        case 42:
          ...
          _context4.next = 48;
          return external_mt_data_["controls"].resolveSelect('core', 'getPostType', updatedRecord.type);
        ...
        case 48:
          ...
          _context4.next = 55;
          return external_mt_data_["controls"].dispatch.apply(external_mt_data_["controls"], [external_mt_notices_["store"], 'createSuccessNotice'].concat(Object(toConsumableArray["a" /* default */])(_args4)));
        ...
        case 55:
          ...
          _context4.next = 58;
          return external_mt_data_["controls"].dispatch('core/block-editor', '__unstableMarkLastChangeAsPersistent');
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          post = _context5.sent;
          _context5.next = 5;
          return external_mt_data_["controls"].select(STORE_NAME, 'getCurrentPostType');

        case 5:
          postTypeSlug = _context5.sent;
          _context5.next = 8;
          return external_mt_data_["controls"].resolveSelect('core', 'getPostType', postTypeSlug);
        ...
        case 8:
          ...
          return Object(external_mt_dataControls_["apiFetch"])({
            ...
            path: "/mt/v2/".concat(postType.rest_base, "/").concat(post.id) + "?context=edit&_timestamp=".concat(Date.now())
          });

        case 11:
          newPost = _context5.sent;
          _context5.next = 14;
          return external_mt_data_["controls"].dispatch(STORE_NAME, 'resetPost', newPost);
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          _context6.next = 8;
          return external_mt_data_["controls"].dispatch(external_mt_notices_["store"], 'removeNotice', TRASH_POST_NOTICE_ID);
        ...
        case 11:
          ...
          _context6.next = 14;
          return Object(external_mt_dataControls_["apiFetch"])({
            path: "/mt/v2/".concat(postType.rest_base, "/").concat(post.id),
            method: 'DELETE'
          });

        case 14:
          _context6.next = 16;
          return external_mt_data_["controls"].dispatch(STORE_NAME, 'savePost');
        ...
        case 18:
          ...
          _context6.next = 22;
          return external_mt_data_["controls"].dispatch.apply(external_mt_data_["controls"], [external_mt_notices_["store"], 'createErrorNotice'].concat(Object(toConsumableArray["a" /* default */])(getNotificationArgumentsForTrashFail({
            error: _context6.t0
          }))));
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 4:
          post = _context7.sent;
          _context7.next = 7;
          return external_mt_data_["controls"].select(STORE_NAME, 'isEditedPostNew');

        case 7:
          isPostNew = _context7.sent;
          _context7.next = 10;
          return external_mt_data_["controls"].select(STORE_NAME, 'getEditedPostAttribute', 'title');

        case 10:
          title = _context7.sent;
          _context7.next = 13;
          return external_mt_data_["controls"].select(STORE_NAME, 'getEditedPostAttribute', 'content');

        case 13:
          content = _context7.sent;
          _context7.next = 16;
          return external_mt_data_["controls"].select(STORE_NAME, 'getEditedPostAttribute', 'excerpt');
        ...
        case 21:
          _context7.next = 23;
          return external_mt_data_["controls"].dispatch(STORE_NAME, 'savePost', actions_objectSpread({
            isAutosave: true
          }, options));
  ...
  return external_regeneratorRuntime_default.a.wrap(function redo$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return external_mt_data_["controls"].dispatch('core', 'redo');
  ...
  return external_regeneratorRuntime_default.a.wrap(function undo$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          _context9.next = 2;
          return external_mt_data_["controls"].dispatch('core', 'undo');
 ...
 * @example
 * ```
 * const { subscribe } = mt.data;
 *
 * const initialPostStatus = mt.data.select( 'core/editor' ).getEditedPostAttribute( 'status' );
 *
 ...
 * 		const currentPostStatus = mt.data.select( 'core/editor' ).getEditedPostAttribute( 'status' );
 * 		if ( 'publish' !== currentPostStatus ) {
 *
 * 			// Compare the post date to the current date, lock the post if the date isn't in the future.
 * 			const postDate = new Date( mt.data.select( 'core/editor' ).getEditedPostAttribute( 'date' ) );
 * 			const currentDate = new Date();
 * 			if ( postDate.getTime() <= currentDate.getTime() ) {
 * 				if ( ! locked ) {
 * 					locked = true;
 * 					mt.data.dispatch( 'core/editor' ).lockPostSaving( 'futurelock' );
 * 				}
 * 			} else {
 * 				if ( locked ) {
 * 					locked = false;
 * 					mt.data.dispatch( 'core/editor' ).unlockPostSaving( 'futurelock' );
 * 				}
 * 			}
 * 		}
 * 	} );
 ...
 * mt.data.dispatch( 'core/editor' ).unlockPostSaving( 'mylock' );
 * ```
 *
 * @return {Object} Action object
 */
 ...
 * mt.data.dispatch( 'core/editor' ).lockPostAutosaving( 'mylock' );
 * ```
 *
 * @return {Object} Action object
 */
 ...
 * ```
 * // Unlock post saving with the lock key `mylock`:
 * mt.data.dispatch( 'core/editor' ).unlockPostAutosaving( 'mylock' );
 * ```
 *
 * @return {Object} Action object
 */
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 6:
          ...
          _context10.next = 11;
          return external_mt_data_["controls"].select('core', 'getEditedEntityRecord', 'postType', type, id);
        ...
        case 11:
          ...
          _context10.next = 17;
          return external_mt_data_["controls"].dispatch('core', '__unstableCreateUndoLevel', 'postType', type, id);
        ...
        case 18:
          ...
          edits.content = function (_ref2) {
            ...
            return Object(external_mt_blocks_["__unstableSerializeAndClean"])(blocksForSerialization);
          };
    ...
    return external_regeneratorRuntime_default.a.wrap(function _callee$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            external_mt_deprecated_default()("`mt.data.dispatch( 'core/editor' )." + name + '`', {
              alternative: "`mt.data.dispatch( 'core/block-editor' )." + name + '`'
            });
            ...
            _context11.next = 4;
            return external_mt_data_["controls"].dispatch.apply(external_mt_data_["controls"], ['core/block-editor', name].concat(args));
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/controls.js
/**
 * Function returning a sessionStorage key to set or retrieve a given post's
 * automatic session backup.
 *
 * Keys are crucially prefixed with 'mt-autosave-' so that mt-login.php's
 * `loggedout` handler can clear sessionStorage of any user-private content.
 *
 * @see https://github.com/paCMec/managertechnology-develop/blob/6dad32d2aed47e6c0cf2aee8410645f6d7aba6bd/src/mt-login.php#L103
 *
...
function postKey(postId, isPostNew) {
  return "mt-autosave-block-editor-post-".concat(isPostNew ? 'auto-draft' : postId);
}
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/store/index.js
 ...
 *
 * @see https://github.com/paCMec/gutenberg/blob/HEAD/packages/data/README.md#registerStore
 *
 * @type {Object}
 */
...
var storeConfig = {
  ...
  controls: store_objectSpread(store_objectSpread({}, external_mt_dataControls_["controls"]), store_controls)
};
/**
...
var store = Object(external_mt_data_["createReduxStore"])(STORE_NAME, store_objectSpread(store_objectSpread({}, storeConfig), {}, {
  persist: ['preferences']
})); // Once we build a more generic persistence plugin that works across types of stores
// we'd be able to replace this with a register call.

Object(external_mt_data_["registerStore"])(STORE_NAME, store_objectSpread(store_objectSpread({}, storeConfig), {}, {
  persist: ['preferences']
}));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/autocompleters/index.js
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/autosave-monitor/index.js
...
/* harmony default export */ var autosave_monitor = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select, ownProps) {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/document-outline/item.js
...
var item_TableOfContentsItem = function TableOfContentsItem(_ref) {
  ...
  return Object(external_mt_element_["createElement"])("li", {
  ...
  }, Object(external_mt_element_["createElement"])("a", {
    href: href,
    ...
    "aria-hidden": "true"
  }), Object(external_mt_element_["createElement"])("strong", {
    className: "document-outline__level"
  }, level), Object(external_mt_element_["createElement"])("span", {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/document-outline/index.js
...
var emptyHeadingContent = Object(external_mt_element_["createElement"])("em", null, Object(external_mt_i18n_["__"])('(Empty heading)'));
var incorrectLevelContent = [Object(external_mt_element_["createElement"])("br", {
  key: "incorrect-break"
}), Object(external_mt_element_["createElement"])("em", {
  key: "incorrect-message"
}, Object(external_mt_i18n_["__"])('(Incorrect heading level)'))];
var singleH1Headings = [Object(external_mt_element_["createElement"])("br", {
  key: "incorrect-break-h1"
}), Object(external_mt_element_["createElement"])("em", {
  key: "incorrect-message-h1"
}, Object(external_mt_i18n_["__"])('(Your theme may already use a H1 for the post title)'))];
var multipleH1Headings = [Object(external_mt_element_["createElement"])("br", {
  key: "incorrect-break-multiple-h1"
}), Object(external_mt_element_["createElement"])("em", {
  key: "incorrect-message-multiple-h1"
}, Object(external_mt_i18n_["__"])('(Multiple H1 headings are not recommended)'))];
/**
...
var document_outline_DocumentOutline = function DocumentOutline(_ref) {
  ...
  return Object(external_mt_element_["createElement"])("div", {
  ...
  }, Object(external_mt_element_["createElement"])("ul", null, hasTitle && Object(external_mt_element_["createElement"])(document_outline_item, {
    level: Object(external_mt_i18n_["__"])('Title'),
    isValid: true,
    onSelect: onSelect,
    ...
    return Object(external_mt_element_["createElement"])(document_outline_item, {
      key: index,
      ...
      onSelect: onSelect
    }, item.isEmpty ? emptyHeadingContent : Object(external_mt_richText_["getTextContent"])(Object(external_mt_richText_["create"])({
      html: item.attributes.content
    })), isIncorrectLevel && incorrectLevelContent, item.level === 1 && hasMultipleH1 && multipleH1Headings, hasTitle && item.level === 1 && !hasMultipleH1 && singleH1Headings);
  })));
};
/* harmony default export */ var document_outline = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/document-outline/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var check = (Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/global-keyboard-shortcuts/save-shortcut.js
/**
 * paCMec dependencies
 */
...
function SaveShortcut(_ref) {
  ...
  var _useDispatch = Object(external_mt_data_["useDispatch"])('core/editor'),
  ...
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/editor/save', function (event) {
    ...
    if (resetBlocksOnSave) {
      ...
      if (postEdits.content && typeof postEdits.content === 'string') {
        var blocks = Object(external_mt_blocks_["parse"])(postEdits.content);
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/global-keyboard-shortcuts/visual-editor-shortcuts.js
...
function VisualEditorGlobalKeyboardShortcuts() {
  ...
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/editor/undo', function (event) {
    undo();
    event.preventDefault();
  }, {
    bindGlobal: true
  });
  Object(external_mt_keyboardShortcuts_["useShortcut"])('core/editor/redo', function (event) {
    redo();
    event.preventDefault();
  }, {
    bindGlobal: true
  });
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockEditorKeyboardShortcuts"], null), Object(external_mt_element_["createElement"])(save_shortcut, null));
}
...
function EditorGlobalKeyboardShortcuts() {
  external_mt_deprecated_default()('EditorGlobalKeyboardShortcuts', {
    alternative: 'VisualEditorGlobalKeyboardShortcuts',
    plugin: 'Gutenberg'
  });
  return Object(external_mt_element_["createElement"])(VisualEditorGlobalKeyboardShortcuts, null);
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/global-keyboard-shortcuts/text-editor-shortcuts.js
...
function TextEditorGlobalKeyboardShortcuts() {
  return Object(external_mt_element_["createElement"])(save_shortcut, {
    resetBlocksOnSave: true
  });
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/global-keyboard-shortcuts/register-shortcuts.js
...
function EditorKeyboardShortcutsRegister() {
  ...
  var _useDispatch = Object(external_mt_data_["useDispatch"])(external_mt_keyboardShortcuts_["store"]),
  ...
  Object(external_mt_element_["useEffect"])(function () {
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Save your changes.'),
      keyCombination: {
        modifier: 'primary',
        character: 's'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Undo your last changes.'),
      keyCombination: {
        modifier: 'primary',
        character: 'z'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(external_mt_i18n_["__"])('Redo your last undo.'),
      keyCombination: {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockEditorKeyboardShortcuts"].Register, null);
}
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/redo.js
...
var redo_redo = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/editor-history/redo.js
...
function EditorHistoryRedo(props, ref) {
  var hasRedo = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], Object(esm_extends["a" /* default */])({}, props, {
    ref: ref,
    icon: library_redo
    /* translators: button label text should, if possible, be under 16 characters. */
    ,
    label: Object(external_mt_i18n_["__"])('Redo'),
    shortcut: external_mt_keycodes_["displayShortcut"].primaryShift('z') // If there are no redo levels we don't want to actually disable this
    // button, because it will remove focus for keyboard users.
    // See: https://github.com/paCMec/gutenberg/issues/3486
    ,
...
/* harmony default export */ var editor_history_redo = (Object(external_mt_element_["forwardRef"])(EditorHistoryRedo));

// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/undo.js
...
var undo_undo = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/editor-history/undo.js
...
function EditorHistoryUndo(props, ref) {
  var hasUndo = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], Object(esm_extends["a" /* default */])({}, props, {
    ...
    /* translators: button label text should, if possible, be under 16 characters. */
    ,
    label: Object(external_mt_i18n_["__"])('Undo'),
    shortcut: external_mt_keycodes_["displayShortcut"].primary('z') // If there are no undo levels we don't want to actually disable this
    // button, because it will remove focus for keyboard users.
    // See: https://github.com/paCMec/gutenberg/issues/3486
    ,
...
/* harmony default export */ var editor_history_undo = (Object(external_mt_element_["forwardRef"])(EditorHistoryUndo));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/template-validation-notice/index.js
...
function TemplateValidationNotice(_ref) {
  ...
  var confirmSynchronization = function confirmSynchronization() {
    ...
    window.confirm(Object(external_mt_i18n_["__"])('Resetting the template may result in loss of content, do you want to continue?'))) {
      props.synchronizeTemplate();
    }
  };

  return Object(external_mt_element_["createElement"])(external_mt_components_["Notice"], {
    className: "editor-template-validation-notice",
    isDismissible: false,
    status: "warning",
    actions: [{
      label: Object(external_mt_i18n_["__"])('Keep it as is'),
      onClick: props.resetTemplateValidity
    }, {
      label: Object(external_mt_i18n_["__"])('Reset the template'),
      onClick: confirmSynchronization,
      isPrimary: true
    }]
  }, Object(external_mt_i18n_["__"])('The content of your post doesn’t match the template assigned to your post type.'));
}

/* harmony default export */ var template_validation_notice = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/editor-notices/index.js
...
function EditorNotices(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["NoticeList"], {
    notices: nonDismissibleNotices,
    className: "components-editor-notices__pinned"
  }), Object(external_mt_element_["createElement"])(external_mt_components_["NoticeList"], {
    notices: dismissibleNotices,
    className: "components-editor-notices__dismissible",
    onRemove: onRemove
  }, Object(external_mt_element_["createElement"])(template_validation_notice, null)), Object(external_mt_element_["createElement"])(external_mt_components_["SnackbarList"], {
    notices: snackbarNotices,
    className: "components-editor-notices__snackbar",
    onRemove: onRemove
  }));
}
/* harmony default export */ var editor_notices = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
    notices: select(external_mt_notices_["store"]).getNotices()
  };
}), Object(external_mt_data_["withDispatch"])(function (dispatch) {
  return {
    onRemove: dispatch(external_mt_notices_["store"]).removeNotice
  };
})])(EditorNotices));
...
// EXTERNAL MODULE: ./node_modules/@managertechnology/icons/build-module/library/layout.js
var layout = __webpack_require__(313);

// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/page.js
...
var page_page = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/entities-saved-states/entity-record-item.js
...
function EntityRecordItem(_ref) {
  ...
  var name = record.name,
      ...
      title = record.title,
      key = record.key;
  var parentBlockId = Object(external_mt_data_["useSelect"])(function (select) {
    var _blocks$;
  ...
  var entityRecordTitle = Object(external_mt_data_["useSelect"])(function (select) {
    if ('postType' !== kind || 'mt_template' !== name) {
      return title;
    }
  ...
  var isSelectedText = isSelected ? Object(external_mt_i18n_["__"])('Selected') : Object(external_mt_i18n_["__"])('Select');

  var _useDispatch = Object(external_mt_data_["useDispatch"])('core/block-editor'),
      selectBlock = _useDispatch.selectBlock;

  var selectParentBlock = Object(external_mt_element_["useCallback"])(function () {
    return selectBlock(parentBlockId);
  }, [parentBlockId]);
  var selectAndDismiss = Object(external_mt_element_["useCallback"])(function () {
    selectBlock(parentBlockId);
    closePanel();
  }, [parentBlockId]);
  return Object(external_mt_element_["createElement"])(external_mt_components_["PanelRow"], null, Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
    label: Object(external_mt_element_["createElement"])("strong", null, entityRecordTitle || Object(external_mt_i18n_["__"])('Untitled')),
    checked: checked,
    onChange: onChange
  }), parentBlockId ? Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    onClick: selectParentBlock,
    className: "entities-saved-states__find-entity",
    disabled: isSelected
  }, isSelectedText), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/entities-saved-states/entity-type-list.js
...
function EntityTypeList(_ref) {
  ...
  var entity = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    ...
    return Object(external_mt_element_["createElement"])(EntityRecordItem, {
      key: record.key || 'site',
      record: record,
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/entities-saved-states/index.js
...
var ENTITY_NAMES = {
  mt_template_part: function mt_template_part(number) {
    return Object(external_mt_i18n_["_n"])('template part', 'template parts', number);
  },
  mt_template: function mt_template(number) {
    return Object(external_mt_i18n_["_n"])('template', 'templates', number);
  },
  post: function post(number) {
    return Object(external_mt_i18n_["_n"])('post', 'posts', number);
  },
  page: function page(number) {
    return Object(external_mt_i18n_["_n"])('page', 'pages', number);
  },
  site: function site(number) {
    return Object(external_mt_i18n_["_n"])('site', 'sites', number);
  }
};
var PLACEHOLDER_PHRASES = {
  // 0 is a back up, but should never be observed.
  0: Object(external_mt_i18n_["__"])('There are no changes.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  1: Object(external_mt_i18n_["__"])('The following changes have been made to your %s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  2: Object(external_mt_i18n_["__"])('The following changes have been made to your %1$s and %2$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  3: Object(external_mt_i18n_["__"])('The following changes have been made to your %1$s, %2$s, and %3$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  4: Object(external_mt_i18n_["__"])('The following changes have been made to your %1$s, %2$s, %3$s, and %4$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  5: Object(external_mt_i18n_["__"])('The following changes have been made to your %1$s, %2$s, %3$s, %4$s, and %5$s.')
};
...
function EntitiesSavedStates(_ref) {
  ...
  var _useDispatch = Object(external_mt_data_["useDispatch"])('core'),
  ...
  Object(external_mt_i18n_["__"])('The following changes have been made to multiple entities.'); // eslint-disable-next-line @managertechnology/valid-sprintf


  var promptPhrase = external_mt_i18n_["sprintf"].apply(void 0, [placeholderPhrase].concat(entityNamesForPrompt)); // Unchecked entities to be ignored by save function.

  var _useState = Object(external_mt_element_["useState"])([]),
  ...
  var dismissPanel = Object(external_mt_element_["useCallback"])(function () {
    return close();
  }, [close]);
  return isOpen ? Object(external_mt_element_["createElement"])("div", {
  ...
  }, Object(external_mt_i18n_["__"])('Save')), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    onClick: dismissPanel,
    icon: library_close["a" /* default */],
    label: Object(external_mt_i18n_["__"])('Close panel')
  })), Object(external_mt_element_["createElement"])("div", {
    className: "entities-saved-states__text-prompt"
  }, Object(external_mt_element_["createElement"])("strong", null, Object(external_mt_i18n_["__"])('Are you ready to save?')), Object(external_mt_element_["createElement"])("p", null, promptPhrase)), partitionedSavables.map(function (list) {
    return Object(external_mt_element_["createElement"])(EntityTypeList, {
      key: list[0].name,
      list: list,
...
/* harmony default export */ var entities_saved_states = (Object(external_mt_components_["withFocusReturn"])(EntitiesSavedStates));

// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js
var assertThisInitialized = __webpack_require__(18);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/error-boundary/index.js
  ...
  Object(createClass["a" /* default */])(ErrorBoundary, [{
    ...
    value: function getContent() {
      try {
        ...
        // application.
        return Object(external_mt_data_["select"])('core/editor').getEditedPostContent();
      } catch (error) {}
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_blockEditor_["Warning"], {
        className: "editor-error-boundary",
        actions: [Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
          key: "recovery",
          onClick: this.reboot,
          isSecondary: true
        }, Object(external_mt_i18n_["__"])('Attempt Recovery')), Object(external_mt_element_["createElement"])(external_mt_components_["ClipboardButton"], {
          key: "copy-post",
          text: this.getContent,
          isSecondary: true
        }, Object(external_mt_i18n_["__"])('Copy Post Text')), Object(external_mt_element_["createElement"])(external_mt_components_["ClipboardButton"], {
          key: "copy-error",
          text: error.stack,
          isSecondary: true
        }, Object(external_mt_i18n_["__"])('Copy Error'))]
      }, Object(external_mt_i18n_["__"])('The editor has encountered an unexpected error.'));
    }
  }]);
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/local-autosave-monitor/index.js
...
var hasSessionStorageSupport = Object(external_lodash_["once"])(function () {
  try {
    ...
    window.sessionStorage.setItem('__mtEditorTestSessionStorage', '');
    window.sessionStorage.removeItem('__mtEditorTestSessionStorage');
    return true;
  } catch (error) {
    return false;
  }
...
function useAutosaveNotice() {
  ...
  var _useDispatch = Object(external_mt_data_["useDispatch"])(external_mt_notices_["store"]),
      createWarningNotice = _useDispatch.createWarningNotice,
      removeNotice = _useDispatch.removeNotice;

  var _useDispatch2 = Object(external_mt_data_["useDispatch"])('core/editor'),
  ...
  Object(external_mt_element_["useEffect"])(function () {
    ...
    var noticeId = Object(external_lodash_["uniqueId"])('mtEditorAutosaveRestore');
    createWarningNotice(Object(external_mt_i18n_["__"])('The backup of this post in your browser is different from the version below.'), {
      id: noticeId,
      actions: [{
        label: Object(external_mt_i18n_["__"])('Restore the backup'),
        onClick: function onClick() {
          editPost(Object(external_lodash_["omit"])(edits, ['content']));
          resetEditorBlocks(Object(external_mt_blocks_["parse"])(edits.content));
...
function useAutosavePurge() {
  ...
  var lastIsDirty = Object(external_mt_element_["useRef"])(isDirty);
  var lastIsAutosaving = Object(external_mt_element_["useRef"])(isAutosaving);
  Object(external_mt_element_["useEffect"])(function () {
  ...
  var wasEditedPostNew = Object(external_mt_compose_["usePrevious"])(isEditedPostNew);
  var prevPostId = Object(external_mt_compose_["usePrevious"])(postId);
  Object(external_mt_element_["useEffect"])(function () {
...
function LocalAutosaveMonitor() {
  var _useDispatch3 = Object(external_mt_data_["useDispatch"])('core/editor'),
      autosave = _useDispatch3.autosave;

  var deferedAutosave = Object(external_mt_element_["useCallback"])(function () {
  ...
  var _useSelect3 = Object(external_mt_data_["useSelect"])(function (select) {
    return {
  ...
  return Object(external_mt_element_["createElement"])(autosave_monitor, {
    interval: localAutosaveInterval,
    autosave: deferedAutosave
  });
}

/* harmony default export */ var local_autosave_monitor = (Object(external_mt_compose_["ifCondition"])(hasSessionStorageSupport)(LocalAutosaveMonitor));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/page-attributes/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var page_attributes_check = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-type-support-check/index.js
/**
 * External dependencies
 */
 ...
 * @param {MTElement} props.children    Children to be rendered if post
 *                                                                   type supports.
...
/* harmony default export */ var post_type_support_check = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getEditedPostAttribute = _select.getEditedPostAttribute;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/page-attributes/order.js
...
var PageAttributesOrder = Object(external_mt_compose_["withState"])({
  orderInput: null
})(function (_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["TextControl"], {
    className: "editor-page-attributes__order",
    type: "number",
    label: Object(external_mt_i18n_["__"])('Order'),
    value: value,
...
function PageAttributesOrderWithChecks(props) {
  return Object(external_mt_element_["createElement"])(post_type_support_check, {
    supportKeys: "page-attributes"
  }, Object(external_mt_element_["createElement"])(PageAttributesOrder, props));
}

/* harmony default export */ var page_attributes_order = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/utils/terms.js
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/page-attributes/parent.js
...
function getTitle(post) {
  ...
  return post !== null && post !== void 0 && (_post$title = post.title) !== null && _post$title !== void 0 && _post$title.rendered ? post.title.rendered : "#".concat(post.id, " (").concat(Object(external_mt_i18n_["__"])('no title'), ")");
}
...
function PageAttributesParent() {
  ...
  var parentOptions = Object(external_mt_element_["useMemo"])(function () {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["ComboboxControl"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/page-attributes/template.js
...
function PageTemplate(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["SelectControl"], {
    label: Object(external_mt_i18n_["__"])('Template:'),
...
/* harmony default export */ var page_attributes_template = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getEditedPostAttribute = _select.getEditedPostAttribute,
      getEditorSettings = _select.getEditorSettings;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-author/combobox.js
...
function PostAuthorCombobox() {
  ...
  var authorOptions = Object(external_mt_element_["useMemo"])(function () {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["ComboboxControl"], {
    label: Object(external_mt_i18n_["__"])('Author'),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-author/select.js
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    return {
      ...
      authors: authorsFromAPI.map(function (author) {
        return {
          label: Object(external_mt_htmlEntities_["decodeEntities"])(author.name),
          value: author.id
        };
      })
    };
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-author/index.js
...
function PostAuthor() {
  var showCombobox = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  if (showCombobox) {
    return Object(external_mt_element_["createElement"])(combobox, null);
  }

  return Object(external_mt_element_["createElement"])(post_author_select, null);
}

/* harmony default export */ var post_author = (PostAuthor);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-author/check.js
...
/* harmony default export */ var post_author_check = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var post = select('core/editor').getCurrentPost();
  return {
    hasAssignAuthorAction: Object(external_lodash_["get"])(post, ['_links', 'mt:action-assign-author'], false),
    postType: select('core/editor').getCurrentPostType(),
    authors: select('core').getAuthors()
  };
}), external_mt_compose_["withInstanceId"]])(PostAuthorCheck));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-comments/index.js
...
function PostComments(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
    label: Object(external_mt_i18n_["__"])('Allow comments'),
    checked: commentStatus === 'open',
    onChange: onToggleComments
  });
}

/* harmony default export */ var post_comments = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-excerpt/index.js
...
function PostExcerpt(_ref) {
  ...
  }, Object(external_mt_element_["createElement"])(external_mt_components_["TextareaControl"], {
    label: Object(external_mt_i18n_["__"])('Write an excerpt (optional)'),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-excerpt/check.js
...
function PostExcerptCheck(props) {
  return Object(external_mt_element_["createElement"])(post_type_support_check, Object(esm_extends["a" /* default */])({}, props, {
    supportKeys: "excerpt"
  }));
}
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/theme-support-check/index.js
/**
 * External dependencies
 */
...
/* harmony default export */ var theme_support_check = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core'),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-featured-image/check.js
...
function PostFeaturedImageCheck(props) {
  return Object(external_mt_element_["createElement"])(theme_support_check, {
    supportKeys: "post-thumbnails"
  }, Object(external_mt_element_["createElement"])(post_type_support_check, Object(esm_extends["a" /* default */])({}, props, {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-featured-image/index.js
...
var DEFAULT_FEATURE_IMAGE_LABEL = Object(external_mt_i18n_["__"])('Featured image');

var DEFAULT_SET_FEATURE_IMAGE_LABEL = Object(external_mt_i18n_["__"])('Set featured image');

var DEFAULT_REMOVE_FEATURE_IMAGE_LABEL = Object(external_mt_i18n_["__"])('Remove image');
...
function PostFeaturedImage(_ref) {
  ...
  var instructions = Object(external_mt_element_["createElement"])("p", null, Object(external_mt_i18n_["__"])('To edit the featured image, you need permission to upload media.'));
  var mediaWidth, mediaHeight, mediaSourceUrl;

  if (media) {
    var mediaSize = Object(external_mt_hooks_["applyFilters"])('editor.PostFeaturedImage.imageSize', 'post-thumbnail', media.id, currentPostId);
    ...
    if (Object(external_lodash_["has"])(media, ['media_details', 'sizes', mediaSize])) {
      ...
      var fallbackMediaSize = Object(external_mt_hooks_["applyFilters"])('editor.PostFeaturedImage.imageSize', 'thumbnail', media.id, currentPostId);
  ...
  return Object(external_mt_element_["createElement"])(post_featured_image_check, null, noticeUI, Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-featured-image"
  }, media && Object(external_mt_element_["createElement"])("div", {
    id: "editor-post-featured-image-".concat(featuredImageId, "-describedby"),
    className: "hidden"
  }, media.alt_text && Object(external_mt_i18n_["sprintf"])( // Translators: %s: The selected image alt text.
  Object(external_mt_i18n_["__"])('Current image: %s'), media.alt_text), !media.alt_text && Object(external_mt_i18n_["sprintf"])( // Translators: %s: The selected image filename.
  Object(external_mt_i18n_["__"])('The current image has no alternative text. The file name is: %s'), ((_media$media_details$ = media.media_details.sizes) === null || _media$media_details$ === void 0 ? void 0 : (_media$media_details$2 = _media$media_details$.full) === null || _media$media_details$2 === void 0 ? void 0 : _media$media_details$2.file) || media.slug)), Object(external_mt_element_["createElement"])(external_mt_blockEditor_["MediaUploadCheck"], {
    fallback: instructions
  }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["MediaUpload"], {
    ...
    render: function render(_ref2) {
      ...
      return Object(external_mt_element_["createElement"])("div", {
        ...
        onClick: open,
        "aria-label": !featuredImageId ? null : Object(external_mt_i18n_["__"])('Edit or update the image'),
        "aria-describedby": !featuredImageId ? null : "editor-post-featured-image-".concat(featuredImageId, "-describedby")
      }, !!featuredImageId && media && Object(external_mt_element_["createElement"])(external_mt_components_["ResponsiveWrapper"], {
        naturalWidth: mediaWidth,
        naturalHeight: mediaHeight,
        isInline: true
      }, Object(external_mt_element_["createElement"])("img", {
        src: mediaSourceUrl,
        alt: ""
      })), !!featuredImageId && !media && Object(external_mt_element_["createElement"])(external_mt_components_["Spinner"], null), !featuredImageId && (postLabel.set_featured_image || DEFAULT_SET_FEATURE_IMAGE_LABEL)), Object(external_mt_element_["createElement"])(external_mt_components_["DropZone"], {
        onFilesDrop: onDropImage
      }));
    },
    value: featuredImageId
  })), !!featuredImageId && media && !media.isLoading && Object(external_mt_element_["createElement"])(external_mt_blockEditor_["MediaUploadCheck"], null, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["MediaUpload"], {
    title: postLabel.featured_image || DEFAULT_FEATURE_IMAGE_LABEL,
    onSelect: onUpdateImage,
    unstableFeaturedImageFlow: true,
    allowedTypes: ALLOWED_MEDIA_TYPES,
    ...
    render: function render(_ref3) {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        onClick: open,
        isSecondary: true
      }, Object(external_mt_i18n_["__"])('Replace Image'));
    }
  })), !!featuredImageId && Object(external_mt_element_["createElement"])(external_mt_blockEditor_["MediaUploadCheck"], null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
...
var applyWithDispatch = Object(external_mt_data_["withDispatch"])(function (dispatch, _ref4, _ref5) {
...
/* harmony default export */ var post_featured_image = (Object(external_mt_compose_["compose"])(external_mt_components_["withNotices"], applyWithSelect, applyWithDispatch, Object(external_mt_components_["withFilters"])('editor.PostFeaturedImage'))(PostFeaturedImage));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-format/check.js
...
function PostFormatCheck(_ref) {
  ...
  return !disablePostFormats && Object(external_mt_element_["createElement"])(post_type_support_check, Object(esm_extends["a" /* default */])({}, props, {
    supportKeys: "post-formats"
  }));
}

/* harmony default export */ var post_format_check = (Object(external_mt_data_["withSelect"])(function (select) {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-format/index.js
 ...
 */
 ...
 // All MT post formats, sorted alphabetically by translated name.

var POST_FORMATS = [{
  id: 'aside',
  caption: Object(external_mt_i18n_["__"])('Aside')
}, {
  id: 'audio',
  caption: Object(external_mt_i18n_["__"])('Audio')
}, {
  id: 'chat',
  caption: Object(external_mt_i18n_["__"])('Chat')
}, {
  id: 'gallery',
  caption: Object(external_mt_i18n_["__"])('Gallery')
}, {
  id: 'image',
  caption: Object(external_mt_i18n_["__"])('Image')
}, {
  id: 'link',
  caption: Object(external_mt_i18n_["__"])('Link')
}, {
  id: 'quote',
  caption: Object(external_mt_i18n_["__"])('Quote')
}, {
  id: 'standard',
  caption: Object(external_mt_i18n_["__"])('Standard')
}, {
  id: 'status',
  caption: Object(external_mt_i18n_["__"])('Status')
}, {
  id: 'video',
  caption: Object(external_mt_i18n_["__"])('Video')
}].sort(function (a, b) {
...
function PostFormat() {
  var instanceId = Object(external_mt_compose_["useInstanceId"])(PostFormat);
  ...
  return Object(external_mt_element_["createElement"])(post_format_check, null, Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-format"
  }, Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-format__content"
  }, Object(external_mt_element_["createElement"])("label", {
    htmlFor: postFormatSelectorId
  }, Object(external_mt_i18n_["__"])('Post Format')), Object(external_mt_element_["createElement"])(external_mt_components_["SelectControl"], {
    value: postFormat,
  ...
  })), suggestion && suggestion.id !== postFormat && Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-format__suggestion"
  }, Object(external_mt_i18n_["__"])('Suggestion:'), ' ', Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    isLink: true,
    onClick: function onClick() {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/backup.js
...
var backup = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-last-revision/check.js
...
/* harmony default export */ var post_last_revision_check = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-last-revision/index.js
...
function LastRevision(_ref) {
  var lastRevisionId = _ref.lastRevisionId,
      revisionsCount = _ref.revisionsCount;
  return Object(external_mt_element_["createElement"])(post_last_revision_check, null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    href: getMTAdminURL('revision.php', {
  ...
  Object(external_mt_i18n_["_n"])('%d Revision', '%d Revisions', revisionsCount), revisionsCount)));
}

/* harmony default export */ var post_last_revision = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getCurrentPostLastRevisionId = _select.getCurrentPostLastRevisionId,
      getCurrentPostRevisionsCount = _select.getCurrentPostRevisionsCount;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-preview-button/index.js
...
function writeInterstitialMessage(targetDocument) {
  var markup = Object(external_mt_element_["renderToString"])(Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-preview-button__interstitial-message"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["SVG"], {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 96 96"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["Path"], {
    className: "outer",
    ...
    fill: "none"
  })), Object(external_mt_element_["createElement"])("p", null, Object(external_mt_i18n_["__"])('Generating preview…'))));
  ...
  markup = Object(external_mt_hooks_["applyFilters"])('editor.PostPreview.interstitialMarkup', markup);
  targetDocument.write(markup);
  targetDocument.title = Object(external_mt_i18n_["__"])('Generating preview…');
...
var post_preview_button_PostPreviewButton = /*#__PURE__*/function (_Component) {
  ...
  function PostPreviewButton() {
    ...
    _this = _super.apply(this, arguments);
    _this.buttonRef = Object(external_mt_element_["createRef"])();
  ...
  Object(createClass["a" /* default */])(PostPreviewButton, [{
    ...
    value: function getWindowTarget() {
      ...
      return "mt-preview-".concat(postId);
    }
  }, {
    ...
    value: function openPreviewWindow(event) {
      ...
      // the existing one.
      // https://github.com/paCMec/gutenberg/pull/8330
    ...
    value: function render() {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        ...
        ref: this.buttonRef,
        role: role
      }, this.props.textContent ? this.props.textContent : Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_i18n_["_x"])('Preview', 'imperative verb'), Object(external_mt_element_["createElement"])(external_mt_components_["VisuallyHidden"], {
        as: "span"
      },
...
/* harmony default export */ var post_preview_button = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select, _ref) {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-locked-modal/index.js
...
function PostLockedModal() {
  var instanceId = Object(external_mt_compose_["useInstanceId"])(PostLockedModal);
  ...
  Object(external_mt_element_["useEffect"])(function () {
    ...
    function receivePostLock(data) {
      if (!data['mt-refresh-post-lock']) {
        return;
      }

      var received = data['mt-refresh-post-lock'];
    ...
    function releasePostLock() {
      ...
      data.append('action', 'mt-remove-post-lock');
      data.append('_mtnonce', postLockUtils.unlockNonce);
    ...
    Object(external_mt_hooks_["addAction"])('heartbeat.tick', hookName, receivePostLock);
    window.addEventListener('beforeunload', releasePostLock);
    return function () {
      Object(external_mt_hooks_["removeAction"])('heartbeat.send', hookName);
      Object(external_mt_hooks_["removeAction"])('heartbeat.tick', hookName);
  ...
  var unlockUrl = Object(external_mt_url_["addQueryArgs"])('post.php', {
    'get-post-lock': '1',
    lockKey: true,
    post: postId,
    action: 'edit',
    _mtnonce: postLockUtils.nonce
  });
  var allPostsUrl = getMTAdminURL('edit.php', {
    post_type: Object(external_lodash_["get"])(postType, ['slug'])
  });

  var allPostsLabel = Object(external_mt_i18n_["__"])('Exit the Editor');

  return Object(external_mt_element_["createElement"])(external_mt_components_["Modal"], {
    title: isTakeover ? Object(external_mt_i18n_["__"])('Someone else has taken over this post.') : Object(external_mt_i18n_["__"])('This post is already being edited.'),
    focusOnMount: true,
    shouldCloseOnClickOutside: false,
    shouldCloseOnEsc: false,
    isDismissible: false,
    className: "editor-post-locked-modal"
  }, !!userAvatar && Object(external_mt_element_["createElement"])("img", {
    src: userAvatar,
    alt: Object(external_mt_i18n_["__"])('Avatar'),
    className: "editor-post-locked-modal__avatar"
  }), !!isTakeover && Object(external_mt_element_["createElement"])("div", null, Object(external_mt_element_["createElement"])("div", null, userDisplayName ? Object(external_mt_i18n_["sprintf"])(
  /* translators: %s: user's display name */
  Object(external_mt_i18n_["__"])('%s now has editing control of this post. Don’t worry, your changes up to this moment have been saved.'), userDisplayName) : Object(external_mt_i18n_["__"])('Another user now has editing control of this post. Don’t worry, your changes up to this moment have been saved.')), Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-locked-modal__buttons"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    isPrimary: true,
    href: allPostsUrl
  }, allPostsLabel))), !isTakeover && Object(external_mt_element_["createElement"])("div", null, Object(external_mt_element_["createElement"])("div", null, userDisplayName ? Object(external_mt_i18n_["sprintf"])(
  /* translators: %s: user's display name */
  Object(external_mt_i18n_["__"])('%s is currently working on this post, which means you cannot make changes, unless you take over.'), userDisplayName) : Object(external_mt_i18n_["__"])('Another user is currently working on this post, which means you cannot make changes, unless you take over.')), Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-locked-modal__buttons"
  }, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    isSecondary: true,
    href: allPostsUrl
  }, allPostsLabel), Object(external_mt_element_["createElement"])(post_preview_button, null), Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    isPrimary: true,
    href: unlockUrl
  }, Object(external_mt_i18n_["__"])('Take Over')))));
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-pending-status/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var post_pending_status_check = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
  ...
  return {
    hasPublishAction: Object(external_lodash_["get"])(getCurrentPost(), ['_links', 'mt:action-publish'], false),
    isPublished: isCurrentPostPublished(),
    postType: getCurrentPostType()
  };
}))(PostPendingStatusCheck));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-pending-status/index.js
...
function PostPendingStatus(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(post_pending_status_check, null, Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
    label: Object(external_mt_i18n_["__"])('Pending review'),
    checked: status === 'pending',
    onChange: togglePendingStatus
  }));
}
/* harmony default export */ var post_pending_status = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-pingbacks/index.js
...
function PostPingbacks(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
    label: Object(external_mt_i18n_["__"])('Allow pingbacks & trackbacks'),
    checked: pingStatus === 'open',
    onChange: onTogglePingback
  });
}

/* harmony default export */ var post_pingbacks = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-button/label.js
/**
 * External dependencies
 */
...
function PublishButtonLabel(_ref) {
  ...
  if (isPublishing) {
    /* translators: button label text should, if possible, be under 16 characters. */
    return Object(external_mt_i18n_["__"])('Publishing…');
  } else if (isPublished && isSaving && !isAutosaving) {
    /* translators: button label text should, if possible, be under 16 characters. */
    return Object(external_mt_i18n_["__"])('Updating…');
  } else if (isBeingScheduled && isSaving && !isAutosaving) {
    /* translators: button label text should, if possible, be under 16 characters. */
    return Object(external_mt_i18n_["__"])('Scheduling…');
  }

  if (!hasPublishAction) {
    return hasNonPostEntityChanges ? Object(external_mt_i18n_["__"])('Submit for Review…') : Object(external_mt_i18n_["__"])('Submit for Review');
  } else if (isPublished) {
    return hasNonPostEntityChanges ? Object(external_mt_i18n_["__"])('Update…') : Object(external_mt_i18n_["__"])('Update');
  } else if (isBeingScheduled) {
    return hasNonPostEntityChanges ? Object(external_mt_i18n_["__"])('Schedule…') : Object(external_mt_i18n_["__"])('Schedule');
  }

  return Object(external_mt_i18n_["__"])('Publish');
}
/* harmony default export */ var post_publish_button_label = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select, _ref2) {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-button/index.js
...
var post_publish_button_PostPublishButton = /*#__PURE__*/function (_Component) {
  ...
  function PostPublishButton(props) {
    ...
    _this = _super.call(this, props);
    _this.buttonNode = Object(external_mt_element_["createRef"])();
  ...
  Object(createClass["a" /* default */])(PostPublishButton, [{
    ...
    value: function render() {
      ...
      var toggleChildren = isBeingScheduled ? Object(external_mt_i18n_["__"])('Schedule…') : Object(external_mt_i18n_["__"])('Publish');
      var buttonChildren = Object(external_mt_element_["createElement"])(post_publish_button_label, {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["Button"], Object(esm_extends["a" /* default */])({
        ref: this.buttonNode
      }, componentProps, {
...
/* harmony default export */ var post_publish_button = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      isSavingPost = _select.isSavingPost,
      isAutosavingPost = _select.isAutosavingPost,
      isEditedPostBeingScheduled = _select.isEditedPostBeingScheduled,
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-visibility/utils.js
/**
 * paCMec dependencies
 */
...
var visibilityOptions = [{
  value: 'public',
  label: Object(external_mt_i18n_["__"])('Public'),
  info: Object(external_mt_i18n_["__"])('Visible to everyone.')
}, {
  value: 'private',
  label: Object(external_mt_i18n_["__"])('Private'),
  info: Object(external_mt_i18n_["__"])('Only visible to site admins and editors.')
}, {
  value: 'password',
  label: Object(external_mt_i18n_["__"])('Password Protected'),
  info: Object(external_mt_i18n_["__"])('Protected with a password you choose. Only those with the password can view this post.')
}];

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-visibility/index.js
...
var post_visibility_PostVisibility = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(PostVisibility, [{
    ...
    value: function setPrivate() {
      if ( // eslint-disable-next-line no-alert
      !window.confirm(Object(external_mt_i18n_["__"])('Would you like to privately publish this post now?'))) {
        return;
      }
    ...
    value: function render() {
      ...
      return [Object(external_mt_element_["createElement"])("fieldset", {
        key: "visibility-selector",
        className: "editor-post-visibility__dialog-fieldset"
      }, Object(external_mt_element_["createElement"])("legend", {
        className: "editor-post-visibility__dialog-legend"
      }, Object(external_mt_i18n_["__"])('Post Visibility')), visibilityOptions.map(function (_ref) {
        var value = _ref.value,
            label = _ref.label,
            info = _ref.info;
        return Object(external_mt_element_["createElement"])("div", {
        ...
        }, Object(external_mt_element_["createElement"])("input", {
          type: "radio",
        ...
        }, label), Object(external_mt_element_["createElement"])("p", {
          id: "editor-post-".concat(value, "-").concat(instanceId, "-description"),
          className: "editor-post-visibility__dialog-info"
        }, info));
      })), this.state.hasPassword && Object(external_mt_element_["createElement"])("div", {
        className: "editor-post-visibility__dialog-password",
        key: "password-selector"
      }, Object(external_mt_element_["createElement"])(external_mt_components_["VisuallyHidden"], {
        as: "label",
        htmlFor: "editor-post-visibility__dialog-password-input-".concat(instanceId)
      }, Object(external_mt_i18n_["__"])('Create password')), Object(external_mt_element_["createElement"])("input", {
        className: "editor-post-visibility__dialog-password-input",
        id: "editor-post-visibility__dialog-password-input-".concat(instanceId),
        type: "text",
        onChange: this.updatePassword,
        value: password,
        placeholder: Object(external_mt_i18n_["__"])('Use a secure password')
      }))];
    }
  }]);
...
/* harmony default export */ var post_visibility = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getEditedPostAttribute = _select.getEditedPostAttribute,
      getEditedPostVisibility = _select.getEditedPostVisibility;
...
}), external_mt_compose_["withInstanceId"]])(post_visibility_PostVisibility));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-visibility/label.js
/**
 * External dependencies
 */
...
/* harmony default export */ var post_visibility_label = (Object(external_mt_data_["withSelect"])(function (select) {
  return {
    visibility: select('core/editor').getEditedPostVisibility()
  };
})(PostVisibilityLabel));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-schedule/index.js
...
function PostSchedule(_ref) {
  ...
  var settings = Object(external_mt_date_["__experimentalGetSettings"])(); // To know if the current timezone is a 12 hour time with look for "a" in the time format
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["DateTimePicker"], {
    ref: ref,
    currentDate: date,
    onChange: onChange,
...
/* harmony default export */ var post_schedule = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-schedule/label.js
/**
 * paCMec dependencies
 */
...
function PostScheduleLabel(_ref) {
  ...
  var settings = Object(external_mt_date_["__experimentalGetSettings"])();

  return date && !isFloating ? Object(external_mt_date_["format"])("".concat(settings.formats.date, " ").concat(settings.formats.time), date) : Object(external_mt_i18n_["__"])('Immediately');
}
/* harmony default export */ var post_schedule_label = (Object(external_mt_data_["withSelect"])(function (select) {
  return {
    date: select('core/editor').getEditedPostAttribute('date'),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-taxonomies/flat-term-selector.js
...
var flat_term_selector_FlatTermSelector = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(FlatTermSelector, [{
    ...
    value: function fetchTerms() {
      ...
      var request = external_mt_apiFetch_default()({
        path: Object(external_mt_url_["addQueryArgs"])("/mt/v2/".concat(taxonomy.rest_base), query)
      });
    ...
    value: function findOrCreateTerm(termName) {
      ...
      return external_mt_apiFetch_default()({
        path: "/mt/v2/".concat(taxonomy.rest_base),
        method: 'POST',
        data: {
        ...
        if (errorCode === 'term_exists') {
          ...
          _this5.addRequest = external_mt_apiFetch_default()({
            path: Object(external_mt_url_["addQueryArgs"])("/mt/v2/".concat(taxonomy.rest_base), flat_term_selector_objectSpread(flat_term_selector_objectSpread({}, DEFAULT_QUERY), {}, {
    ...
    value: function render() {
      ...
      var newTermLabel = Object(external_lodash_["get"])(taxonomy, ['labels', 'add_new_item'], slug === 'post_tag' ? Object(external_mt_i18n_["__"])('Add new tag') : Object(external_mt_i18n_["__"])('Add new Term'));
      var singularName = Object(external_lodash_["get"])(taxonomy, ['labels', 'singular_name'], slug === 'post_tag' ? Object(external_mt_i18n_["__"])('Tag') : Object(external_mt_i18n_["__"])('Term'));
      var termAddedLabel = Object(external_mt_i18n_["sprintf"])(
      /* translators: %s: term name. */
      Object(external_mt_i18n_["_x"])('%s added', 'term'), singularName);
      var termRemovedLabel = Object(external_mt_i18n_["sprintf"])(
      /* translators: %s: term name. */
      Object(external_mt_i18n_["_x"])('%s removed', 'term'), singularName);
      var removeTermLabel = Object(external_mt_i18n_["sprintf"])(
      /* translators: %s: term name. */
      Object(external_mt_i18n_["_x"])('Remove %s', 'term'), singularName);
      return Object(external_mt_element_["createElement"])(external_mt_components_["FormTokenField"], {
        value: selectedTerms,
...
/* harmony default export */ var flat_term_selector = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select, _ref) {
  var slug = _ref.slug;
  ...
  return {
    hasCreateAction: taxonomy ? Object(external_lodash_["get"])(getCurrentPost(), ['_links', 'mt:action-create-' + taxonomy.rest_base], false) : false,
    hasAssignAction: taxonomy ? Object(external_lodash_["get"])(getCurrentPost(), ['_links', 'mt:action-assign-' + taxonomy.rest_base], false) : false,
...
}), Object(external_mt_components_["withFilters"])('editor.PostTaxonomyType'))(flat_term_selector_FlatTermSelector));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-panel/maybe-tags-panel.js
...
var maybe_tags_panel_TagsPanel = function TagsPanel() {
  var panelBodyTitle = [Object(external_mt_i18n_["__"])('Suggestion:'), Object(external_mt_element_["createElement"])("span", {
    className: "editor-post-publish-panel__link",
    key: "label"
  }, Object(external_mt_i18n_["__"])('Add tags'))];
  return Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    initialOpen: false,
    title: panelBodyTitle
  }, Object(external_mt_element_["createElement"])("p", null, Object(external_mt_i18n_["__"])('Tags help users and search engines navigate your site and find your content. Add a few keywords to describe your post.')), Object(external_mt_element_["createElement"])(flat_term_selector, {
    slug: 'post_tag'
  }));
};
  ...
  Object(createClass["a" /* default */])(MaybeTagsPanel, [{
    ...
    value: function render() {
      if (!this.state.hadTagsWhenOpeningThePanel) {
        return Object(external_mt_element_["createElement"])(maybe_tags_panel_TagsPanel, null);
      }
...
/* harmony default export */ var maybe_tags_panel = (Object(external_mt_compose_["compose"])(Object(external_mt_data_["withSelect"])(function (select) {
...
}), Object(external_mt_compose_["ifCondition"])(function (_ref) {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-panel/maybe-post-format-panel.js
...
function PostFormatPanel() {
  ...
  var panelBodyTitle = [Object(external_mt_i18n_["__"])('Suggestion:'), Object(external_mt_element_["createElement"])("span", {
    className: "editor-post-publish-panel__link",
    key: "label"
  }, Object(external_mt_i18n_["__"])('Use a post format'))];
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    initialOpen: false,
    title: panelBodyTitle
  }, Object(external_mt_element_["createElement"])("p", null, Object(external_mt_i18n_["__"])('Your theme uses post formats to highlight different kinds of content, like images or videos. Apply a post format to see this special styling.')), Object(external_mt_element_["createElement"])("p", null, Object(external_mt_element_["createElement"])(maybe_post_format_panel_PostFormatSuggestion, {
    onUpdatePostFormat: onUpdatePostFormat,
    suggestedPostFormat: suggestion.id,
    suggestionText: Object(external_mt_i18n_["sprintf"])(
    /* translators: %s: post format */
    Object(external_mt_i18n_["__"])('Apply the "%1$s" format.'), suggestion.caption)
  })));
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-panel/prepublish.js
...
function PostPublishPanelPrepublish(_ref) {
  ...
  if (!hasPublishAction) {
    prePublishTitle = Object(external_mt_i18n_["__"])('Are you ready to submit for review?');
    prePublishBodyText = Object(external_mt_i18n_["__"])('When you’re ready, submit your work for review, and an Editor will be able to approve it for you.');
  } else if (isBeingScheduled) {
    prePublishTitle = Object(external_mt_i18n_["__"])('Are you ready to schedule?');
    prePublishBodyText = Object(external_mt_i18n_["__"])('Your work will be published at the specified date and time.');
  } else {
    prePublishTitle = Object(external_mt_i18n_["__"])('Are you ready to publish?');
    prePublishBodyText = Object(external_mt_i18n_["__"])('Double-check your settings before publishing.');
  }

  return Object(external_mt_element_["createElement"])("div", {
    className: "editor-post-publish-panel__prepublish"
  }, Object(external_mt_element_["createElement"])("div", null, Object(external_mt_element_["createElement"])("strong", null, prePublishTitle)), Object(external_mt_element_["createElement"])("p", null, prePublishBodyText), hasPublishAction && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    initialOpen: false,
    title: [Object(external_mt_i18n_["__"])('Visibility:'), Object(external_mt_element_["createElement"])("span", {
      className: "editor-post-publish-panel__link",
      key: "label"
    }, Object(external_mt_element_["createElement"])(post_visibility_label, null))]
  }, Object(external_mt_element_["createElement"])(post_visibility, null)), Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], {
    initialOpen: false,
    title: [Object(external_mt_i18n_["__"])('Publish:'), Object(external_mt_element_["createElement"])("span", {
      className: "editor-post-publish-panel__link",
      key: "label"
    }, Object(external_mt_element_["createElement"])(post_schedule_label, null))]
  }, Object(external_mt_element_["createElement"])(post_schedule, null))), Object(external_mt_element_["createElement"])(PostFormatPanel, null), Object(external_mt_element_["createElement"])(maybe_tags_panel, null), children);
}

/* harmony default export */ var prepublish = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getCurrentPost = _select.getCurrentPost,
      isEditedPostBeingScheduled = _select.isEditedPostBeingScheduled;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-panel/postpublish.js
...
var postpublish_PostPublishPanelPostpublish = /*#__PURE__*/function (_Component) {
  ...
  function PostPublishPanelPostpublish() {
    ...
    _this.postLink = Object(external_mt_element_["createRef"])();
    return _this;
  }
  ...
  Object(createClass["a" /* default */])(PostPublishPanelPostpublish, [{
    ...
    value: function render() {
      ...
      var postPublishNonLinkHeader = isScheduled ? Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_i18n_["__"])('is now scheduled. It will go live on'), ' ', Object(external_mt_element_["createElement"])(post_schedule_label, null), ".") : Object(external_mt_i18n_["__"])('is now live.');
      return Object(external_mt_element_["createElement"])("div", {
        ...
        ref: this.postLink,
        href: link
      }, Object(external_mt_htmlEntities_["decodeEntities"])(post.title) || Object(external_mt_i18n_["__"])('(no title)')), ' ', postPublishNonLinkHeader), Object(external_mt_element_["createElement"])(external_mt_components_["PanelBody"], null, Object(external_mt_element_["createElement"])("p", {
        className: "post-publish-panel__postpublish-subheader"
      }, Object(external_mt_element_["createElement"])("strong", null, Object(external_mt_i18n_["__"])('What’s next?'))), Object(external_mt_element_["createElement"])(external_mt_components_["TextControl"], {
        className: "post-publish-panel__postpublish-post-address",
        readOnly: true,
        label: Object(external_mt_i18n_["sprintf"])(
        /* translators: %s: post type singular name */
        Object(external_mt_i18n_["__"])('%s address'), postLabel),
        value: Object(external_mt_url_["safeDecodeURIComponent"])(link),
        onFocus: this.onSelectInput
      }), Object(external_mt_element_["createElement"])("div", {
        className: "post-publish-panel__postpublish-buttons"
      }, !isScheduled && Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        isSecondary: true,
        href: link
      }, viewPostLabel), Object(external_mt_element_["createElement"])(external_mt_components_["ClipboardButton"], {
        isSecondary: true,
        text: link,
        onCopy: this.onCopy
      }, this.state.showCopyConfirmation ? Object(external_mt_i18n_["__"])('Copied!') : Object(external_mt_i18n_["__"])('Copy Link')))), children);
    }
  }]);
...
/* harmony default export */ var postpublish = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getEditedPostAttribute = _select.getEditedPostAttribute,
      getCurrentPost = _select.getCurrentPost,
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-publish-panel/index.js
...
var post_publish_panel_PostPublishPanel = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(PostPublishPanel, [{
    ...
    value: function render() {
      ...
      return Object(external_mt_element_["createElement"])("div", Object(esm_extends["a" /* default */])({
        className: "editor-post-publish-panel"
      }, propsForPanel), Object(external_mt_element_["createElement"])("div", {
        className: "editor-post-publish-panel__header"
      }, isPostPublish ? Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        onClick: onClose,
        icon: close_small["a" /* default */],
        label: Object(external_mt_i18n_["__"])('Close panel')
      }) : Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("div", {
        className: "editor-post-publish-panel__header-publish-button"
      }, Object(external_mt_element_["createElement"])(post_publish_button, {
        focusOnMount: true,
        ...
        onClick: onClose,
        isSecondary: true
      }, Object(external_mt_i18n_["__"])('Cancel'))))), Object(external_mt_element_["createElement"])("div", {
        className: "editor-post-publish-panel__content"
      }, isPrePublish && Object(external_mt_element_["createElement"])(prepublish, null, PrePublishExtension && Object(external_mt_element_["createElement"])(PrePublishExtension, null)), isPostPublish && Object(external_mt_element_["createElement"])(postpublish, {
        focusOnMount: true
      }, PostPublishExtension && Object(external_mt_element_["createElement"])(PostPublishExtension, null)), isSaving && Object(external_mt_element_["createElement"])(external_mt_components_["Spinner"], null)), Object(external_mt_element_["createElement"])("div", {
        className: "editor-post-publish-panel__footer"
      }, Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
        label: Object(external_mt_i18n_["__"])('Always show pre-publish checks.'),
...
/* harmony default export */ var post_publish_panel = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core'),
      getPostType = _select.getPostType;
...
}), Object(external_mt_data_["withDispatch"])(function (dispatch, _ref) {
...
}), external_mt_components_["withFocusReturn"], external_mt_components_["withConstrainedTabbing"]])(post_publish_panel_PostPublishPanel));
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/cloud.js
...
var cloud = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "-2 -2 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/cloud-upload.js
...
var cloudUpload = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "-2 -2 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-switch-to-draft-button/index.js
...
function PostSwitchToDraftButton(_ref) {
  ...
  var isMobileViemtort = Object(external_mt_compose_["useViemtortMatch"])('small', '<');
  ...
  var onSwitch = function onSwitch() {
    ...
    if (isPublished) {
      alertMessage = Object(external_mt_i18n_["__"])('Are you sure you want to unpublish this post?');
    } else if (isScheduled) {
      alertMessage = Object(external_mt_i18n_["__"])('Are you sure you want to unschedule this post?');
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    ...
    disabled: isSaving,
    isTertiary: true
  }, isMobileViemtort ? Object(external_mt_i18n_["__"])('Draft') : Object(external_mt_i18n_["__"])('Switch to draft'));
}

/* harmony default export */ var post_switch_to_draft_button = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      isSavingPost = _select.isSavingPost,
      isCurrentPostPublished = _select.isCurrentPostPublished,
      isCurrentPostScheduled = _select.isCurrentPostScheduled;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-saved-state/index.js
 ...
 * @return {import('@managertechnology/element').MTComponent} The component.
 */
...
function PostSavedState(_ref) {
  ...
  var isLargeViemtort = Object(external_mt_compose_["useViemtortMatch"])('small');
  ...
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    return {
      ...
      isSaveable: isEditedPostSaveable(),
      isScheduled: isCurrentPostScheduled(),
      hasPublishAction: (_getCurrentPost$_link = (_getCurrentPost = getCurrentPost()) === null || _getCurrentPost === void 0 ? void 0 : (_getCurrentPost$_link2 = _getCurrentPost._links) === null || _getCurrentPost$_link2 === void 0 ? void 0 : _getCurrentPost$_link2['mt:action-publish']) !== null && _getCurrentPost$_link !== void 0 ? _getCurrentPost$_link : false
    };
  ...
  var wasSaving = Object(external_mt_compose_["usePrevious"])(isSaving);
  Object(external_mt_element_["useEffect"])(function () {
    var timeoutId;
  ...
  if (isSaving) {
    ...
    var classes = classnames_default()('editor-post-saved-state', 'is-saving', Object(external_mt_components_["__unstableGetAnimateClassName"])({
      type: 'loading'
    }), {
    ...
    return Object(external_mt_element_["createElement"])("span", {
      className: classes
    }, Object(external_mt_element_["createElement"])(build_module_icon["a" /* default */], {
      icon: library_cloud
    }), isAutosaving ? Object(external_mt_i18n_["__"])('Autosaving') : Object(external_mt_i18n_["__"])('Saving'));
  }

  if (isPublished || isScheduled) {
    return Object(external_mt_element_["createElement"])(post_switch_to_draft_button, null);
  }
  ...
  if (forceSavedMessage || !isNew && !isDirty) {
    ...
    }), Object(external_mt_i18n_["__"])('Saved'));
  ...
  var label = isPending ? Object(external_mt_i18n_["__"])('Save as pending') : Object(external_mt_i18n_["__"])('Save draft');
  /* translators: button label text should, if possible, be under 16 characters. */

  var shortLabel = Object(external_mt_i18n_["__"])('Save');
  ...
  if (!isLargeViemtort) {
    return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
      ...
      shortcut: external_mt_keycodes_["displayShortcut"].primary('s'),
      icon: cloud_upload
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-schedule/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var post_schedule_check = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getCurrentPost = _select.getCurrentPost,
      getCurrentPostType = _select.getCurrentPostType;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-slug/check.js
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-slug/index.js
...
var post_slug_PostSlug = /*#__PURE__*/function (_Component) {
  ...
  function PostSlug(_ref) {
    ...
    _this = _super.apply(this, arguments);
    _this.state = {
      editedSlug: Object(external_mt_url_["safeDecodeURIComponent"])(postSlug) || cleanForSlug(postTitle) || postID
    };
  ...
  Object(createClass["a" /* default */])(PostSlug, [{
    ...
    value: function render() {
      ...
      return Object(external_mt_element_["createElement"])(PostSlugCheck, null, Object(external_mt_element_["createElement"])("label", {
        htmlFor: inputId
      }, Object(external_mt_i18n_["__"])('Slug')), Object(external_mt_element_["createElement"])("input", {
        type: "text",
        id: inputId,
        value: editedSlug,
...
/* harmony default export */ var post_slug = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getCurrentPost = _select.getCurrentPost,
      getEditedPostAttribute = _select.getEditedPostAttribute;
...
}), external_mt_compose_["withInstanceId"]])(post_slug_PostSlug));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-sticky/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var post_sticky_check = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var post = select('core/editor').getCurrentPost();
  return {
    hasStickyAction: Object(external_lodash_["get"])(post, ['_links', 'mt:action-sticky'], false),
    postType: select('core/editor').getCurrentPostType()
  };
})])(PostStickyCheck));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-sticky/index.js
...
function PostSticky(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(post_sticky_check, null, Object(external_mt_element_["createElement"])(external_mt_components_["CheckboxControl"], {
    label: Object(external_mt_i18n_["__"])('Stick to the top of the blog'),
    checked: postSticky,
...
/* harmony default export */ var post_sticky = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-taxonomies/hierarchical-term-selector.js
...
var hierarchical_term_selector_HierarchicalTermSelector = /*#__PURE__*/function (_Component) {
  ...
  Object(createClass["a" /* default */])(HierarchicalTermSelector, [{
    ...
    value: function onAddTerm(event) {
      ...
      this.addRequest = external_mt_apiFetch_default()({
        path: "/mt/v2/".concat(taxonomy.rest_base),
        method: 'POST',
        data: {
          name: formName,
      ...
      var findOrCreatePromise = this.addRequest.catch(function (error) {
        ...
        if (errorCode === 'term_exists') {
          ...
          _this2.addRequest = external_mt_apiFetch_default()({
            path: Object(external_mt_url_["addQueryArgs"])("/mt/v2/".concat(taxonomy.rest_base), hierarchical_term_selector_objectSpread(hierarchical_term_selector_objectSpread({}, hierarchical_term_selector_DEFAULT_QUERY), {}, {
              parent: formParent || 0,
              search: formName
            }))
          });
      ...
      findOrCreatePromise.then(function (term) {
        ...
        var termAddedMessage = Object(external_mt_i18n_["sprintf"])(
        /* translators: %s: taxonomy name */
        Object(external_mt_i18n_["_x"])('%s added', 'term'), Object(external_lodash_["get"])(_this2.props.taxonomy, ['labels', 'singular_name'], slug === 'category' ? Object(external_mt_i18n_["__"])('Category') : Object(external_mt_i18n_["__"])('Term')));
    ...
    value: function fetchTerms() {
      ...
      this.fetchRequest = external_mt_apiFetch_default()({
        path: Object(external_mt_url_["addQueryArgs"])("/mt/v2/".concat(taxonomy.rest_base), hierarchical_term_selector_DEFAULT_QUERY)
      });
    ...
    value: function setFilterValue(event) {
      ...
      var resultsFoundMessage = Object(external_mt_i18n_["sprintf"])(
      /* translators: %d: number of results */
      Object(external_mt_i18n_["_n"])('%d result found.', '%d results found.', resultCount), resultCount);
    ...
    value: function renderTerms(renderedTerms) {
      ...
      return renderedTerms.map(function (term) {
        ...
        }), !!term.children.length && Object(external_mt_element_["createElement"])("div", {
    ...
    value: function render() {
      ...
      var newTermButtonLabel = labelWithFallback('add_new_item', Object(external_mt_i18n_["__"])('Add new category'), Object(external_mt_i18n_["__"])('Add new term'));
      var newTermLabel = labelWithFallback('new_item_name', Object(external_mt_i18n_["__"])('Add new category'), Object(external_mt_i18n_["__"])('Add new term'));
      var parentSelectLabel = labelWithFallback('parent_item', Object(external_mt_i18n_["__"])('Parent Category'), Object(external_mt_i18n_["__"])('Parent Term'));
      ...
      var filterLabel = Object(external_lodash_["get"])(this.props.taxonomy, ['labels', 'search_items'], Object(external_mt_i18n_["__"])('Search Terms'));
      var groupLabel = Object(external_lodash_["get"])(this.props.taxonomy, ['name'], Object(external_mt_i18n_["__"])('Terms'));
      var showFilter = availableTerms.length >= MIN_TERMS_COUNT_FOR_FILTER;
      return [showFilter && Object(external_mt_element_["createElement"])("label", {
        key: "filter-label",
        htmlFor: filterInputId
      }, filterLabel), showFilter && Object(external_mt_element_["createElement"])("input", {
        type: "search",
        id: filterInputId,
        value: filterValue,
      ...
      }, this.renderTerms('' !== filterValue ? filteredTermsTree : availableTermsTree)), !loading && hasCreateAction && Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
        key: "term-add-button",
        onClick: this.onToggleForm,
        className: "editor-post-taxonomies__hierarchical-terms-add",
        "aria-expanded": showForm,
        isLink: true
      }, newTermButtonLabel), showForm && Object(external_mt_element_["createElement"])("form", {
        onSubmit: this.onAddTerm,
        key: "hierarchical-terms-form"
      }, Object(external_mt_element_["createElement"])("label", {
        htmlFor: inputId,
        className: "editor-post-taxonomies__hierarchical-terms-label"
      }, newTermLabel), Object(external_mt_element_["createElement"])("input", {
        type: "text",
        id: inputId,
        ...
        required: true
      }), !!availableTerms.length && Object(external_mt_element_["createElement"])(external_mt_components_["TreeSelect"], {
...
/* harmony default export */ var hierarchical_term_selector = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select, _ref) {
  var slug = _ref.slug;
...
}), external_mt_components_["withSpokenMessages"], external_mt_compose_["withInstanceId"], Object(external_mt_components_["withFilters"])('editor.PostTaxonomyType')])(hierarchical_term_selector_HierarchicalTermSelector));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-taxonomies/index.js
...
function PostTaxonomies(_ref) {
  ...
  return visibleTaxonomies.map(function (taxonomy) {
    ...
    }, taxonomyWrapper(Object(external_mt_element_["createElement"])(TaxonomyComponent, {
      slug: taxonomy.slug
    }), taxonomy));
  });
}
/* harmony default export */ var post_taxonomies = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
    postType: select('core/editor').getCurrentPostType(),
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-taxonomies/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var post_taxonomies_check = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  return {
    postType: select('core/editor').getCurrentPostType(),
    taxonomies: select('core').getTaxonomies({
      per_page: -1
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-text-editor/index.js
...
function PostTextEditor() {
  var postContent = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  var _useState = Object(external_mt_element_["useState"])(postContent),
      _useState2 = Object(slicedToArray["a" /* default */])(_useState, 2),
      value = _useState2[0],
      setValue = _useState2[1];

  var _useState3 = Object(external_mt_element_["useState"])(false),
      _useState4 = Object(slicedToArray["a" /* default */])(_useState3, 2),
      isDirty = _useState4[0],
      setIsDirty = _useState4[1];

  var instanceId = Object(external_mt_compose_["useInstanceId"])(PostTextEditor);
  ...
  var saveText = function saveText() {
    var blocks = Object(external_mt_blocks_["parse"])(value);
    resetEditorBlocks(blocks);
  };
  ...
  return Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])(external_mt_components_["VisuallyHidden"], {
    as: "label",
    htmlFor: "post-content-".concat(instanceId)
  }, Object(external_mt_i18n_["__"])('Type text or HTML')), Object(external_mt_element_["createElement"])(lib_default.a, {
    autoComplete: "off",
    dir: "auto",
    value: value,
    onChange: onChange,
    ...
    placeholder: Object(external_mt_i18n_["__"])('Start writing with text or HTML')
  }));
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-title/index.js
...
var REGEXP_NEWLINES = /[\r\n]+/g;
function PostTitle() {
  var instanceId = Object(external_mt_compose_["useInstanceId"])(PostTitle);
  var ref = Object(external_mt_element_["useRef"])();
  ...
  function onKeyDown(event) {
    if (event.keyCode === external_mt_keycodes_["ENTER"]) {
      event.preventDefault();
      onEnterPress();
    }
  }
  ...
  function onPaste(event) {
    ...
    var content = Object(external_mt_blocks_["pasteHandler"])({
      HTML: html,
      plainText: plainText
    });
  ...
  } // The mt-block className is important for editor styles.
  // This same block is used in both the visual and the code editor.


  var className = classnames_default()('mt-block editor-post-title editor-post-title__block', {
    'is-selected': isSelected,
    'is-focus-mode': isFocusMode,
    'has-fixed-toolbar': hasFixedToolbar
  });
  var decodedPlaceholder = Object(external_mt_htmlEntities_["decodeEntities"])(placeholder);
  return Object(external_mt_element_["createElement"])(post_type_support_check, {
    supportKeys: "title"
  }, Object(external_mt_element_["createElement"])("div", {
    className: className
  ...
  }, decodedPlaceholder || Object(external_mt_i18n_["__"])('Add title')), Object(external_mt_element_["createElement"])(lib_default.a, {
    ref: ref,
    id: "post-title-".concat(instanceId),
    className: "editor-post-title__input",
    value: title,
    onChange: onChange,
    placeholder: decodedPlaceholder || Object(external_mt_i18n_["__"])('Add title'),
    onFocus: onSelect,
    onBlur: onUnselect,
    onKeyDown: onKeyDown,
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-trash/index.js
...
function PostTrash(_ref) {
  ...
  return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], {
    ...
    isTertiary: true,
    onClick: onClick
  }, Object(external_mt_i18n_["__"])('Move to trash'));
}

/* harmony default export */ var post_trash = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      isEditedPostNew = _select.isEditedPostNew,
      getCurrentPostId = _select.getCurrentPostId,
      getCurrentPostType = _select.getCurrentPostType;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-trash/check.js
/**
 * paCMec dependencies
 */
...
/* harmony default export */ var post_trash_check = (Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      isEditedPostNew = _select.isEditedPostNew,
      getCurrentPostId = _select.getCurrentPostId,
      getCurrentPostType = _select.getCurrentPostType;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/post-visibility/check.js
/**
 * External dependencies
 */
...
/* harmony default export */ var post_visibility_check = (Object(external_mt_compose_["compose"])([Object(external_mt_data_["withSelect"])(function (select) {
  var _select = select('core/editor'),
      getCurrentPost = _select.getCurrentPost,
      getCurrentPostType = _select.getCurrentPostType;
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/icons/build-module/library/info.js
...
var info_info = Object(external_mt_element_["createElement"])(external_mt_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Object(external_mt_element_["createElement"])(external_mt_primitives_["Path"], {
...
// EXTERNAL MODULE: external ["mt","wordcount"]
var external_mt_wordcount_ = __webpack_require__(126);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/word-count/index.js
...
function WordCount() {
  var content = Object(external_mt_data_["useSelect"])(function (select) {
  ...
  var wordCountType = Object(external_mt_i18n_["_x"])('words', 'Word count type. Do not translate!');

  return Object(external_mt_element_["createElement"])("span", {
    className: "word-count"
  }, Object(external_mt_wordcount_["count"])(content, wordCountType));
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/character-count/index.js
/**
 * paCMec dependencies
 */
...
function CharacterCount() {
  ...
  return Object(external_mt_wordcount_["count"])(content, 'characters_including_spaces');
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/table-of-contents/panel.js
...
function TableOfContentsPanel(_ref) {
  ...
  return (
    ...
    Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("div", {
      ...
      role: "note",
      "aria-label": Object(external_mt_i18n_["__"])('Document Statistics'),
      tabIndex: "0"
    }, Object(external_mt_element_["createElement"])("ul", {
      role: "list",
      className: "table-of-contents__counts"
    }, Object(external_mt_element_["createElement"])("li", {
      className: "table-of-contents__count"
    }, Object(external_mt_i18n_["__"])('Characters'), Object(external_mt_element_["createElement"])("span", {
      className: "table-of-contents__number"
    }, Object(external_mt_element_["createElement"])(CharacterCount, null))), Object(external_mt_element_["createElement"])("li", {
      className: "table-of-contents__count"
    }, Object(external_mt_i18n_["__"])('Words'), Object(external_mt_element_["createElement"])(WordCount, null)), Object(external_mt_element_["createElement"])("li", {
      className: "table-of-contents__count"
    }, Object(external_mt_i18n_["__"])('Headings'), Object(external_mt_element_["createElement"])("span", {
      className: "table-of-contents__number"
    }, headingCount)), Object(external_mt_element_["createElement"])("li", {
      className: "table-of-contents__count"
    }, Object(external_mt_i18n_["__"])('Paragraphs'), Object(external_mt_element_["createElement"])("span", {
      className: "table-of-contents__number"
    }, paragraphCount)), Object(external_mt_element_["createElement"])("li", {
      className: "table-of-contents__count"
    }, Object(external_mt_i18n_["__"])('Blocks'), Object(external_mt_element_["createElement"])("span", {
      className: "table-of-contents__number"
    }, numberOfBlocks)))), headingCount > 0 && Object(external_mt_element_["createElement"])(external_mt_element_["Fragment"], null, Object(external_mt_element_["createElement"])("hr", null), Object(external_mt_element_["createElement"])("h2", {
      className: "table-of-contents__title"
    }, Object(external_mt_i18n_["__"])('Document Outline')), Object(external_mt_element_["createElement"])(document_outline, {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/table-of-contents/index.js
...
function TableOfContents(_ref, ref) {
  ...
  var hasBlocks = Object(external_mt_data_["useSelect"])(function (select) {
    return !!select('core/block-editor').getBlockCount();
  }, []);
  return Object(external_mt_element_["createElement"])(external_mt_components_["Dropdown"], {
    ...
    renderToggle: function renderToggle(_ref2) {
      ...
      return Object(external_mt_element_["createElement"])(external_mt_components_["Button"], Object(esm_extends["a" /* default */])({}, props, {
        ...
        /* translators: button label text should, if possible, be under 16 characters. */
        ,
        label: Object(external_mt_i18n_["__"])('Details'),
    ...
    renderContent: function renderContent(_ref3) {
      ...
      return Object(external_mt_element_["createElement"])(panel, {
...
/* harmony default export */ var table_of_contents = (Object(external_mt_element_["forwardRef"])(TableOfContents));

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/unsaved-changes-warning/index.js
/**
 * paCMec dependencies
 */
 ...
 *
 * @return {MTComponent} The component.
 */

function UnsavedChangesWarning() {
  var isDirty = Object(external_mt_data_["useSelect"])(function (select) {
    return function () {
      var _select = select('core'),
  ...
  var warnIfUnsavedChanges = function warnIfUnsavedChanges(event) {
    ...
    if (isDirty()) {
      event.returnValue = Object(external_mt_i18n_["__"])('You have unsaved changes. If you proceed, they will be lost.');
...
// EXTERNAL MODULE: external ["mt","reusableBlocks"]
var external_mt_reusableBlocks_ = __webpack_require__(146);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/provider/with-registry-provider.js
...
var withRegistryProvider = Object(external_mt_compose_["createHigherOrderComponent"])(function (WrappedComponent) {
  return Object(external_mt_data_["withRegistry"])(function (props) {
    ...
    if (!useSubRegistry) {
      return Object(external_mt_element_["createElement"])(WrappedComponent, additionalProps);
    }

    var _useState = Object(external_mt_element_["useState"])(null),
        _useState2 = Object(slicedToArray["a" /* default */])(_useState, 2),
        subRegistry = _useState2[0],
        setSubRegistry = _useState2[1];

    Object(external_mt_element_["useEffect"])(function () {
      var newRegistry = Object(external_mt_data_["createRegistry"])({
        'core/block-editor': external_mt_blockEditor_["storeConfig"]
      }, registry);
    ...
    return Object(external_mt_element_["createElement"])(external_mt_data_["RegistryProvider"], {
      value: subRegistry
    }, Object(external_mt_element_["createElement"])(WrappedComponent, additionalProps));
  });
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/utils/media-upload/index.js
...
function mediaUpload(_ref) {
  ...
  var _select = Object(external_mt_data_["select"])('core/editor'),
      getCurrentPostId = _select.getCurrentPostId,
      getEditorSettings = _select.getEditorSettings;

  var mtAllowedMimeTypes = getEditorSettings().allowedMimeTypes;
  maxUploadFileSize = maxUploadFileSize || getEditorSettings().maxUploadFileSize;
  Object(external_mt_mediaUtils_["uploadMedia"])({
    ...
    mtAllowedMimeTypes: mtAllowedMimeTypes
  });
}

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/provider/use-block-editor-settings.js
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!type || type === 'post') {
              queries.push(external_mt_apiFetch_default()({
                path: Object(external_mt_url_["addQueryArgs"])('/mt/v2/search', {
                  search: search,
                  page: page,
                  per_page: perPage,
                  type: 'post',
            ...
            return _context.abrupt("return", Promise.all(queries).then(function (results) {
              return Object(external_lodash_["map"])(Object(external_lodash_["flatten"])(results).filter(function (result) {
                ...
                return {
                  id: result.id,
                  url: result.url,
                  title: Object(external_mt_htmlEntities_["decodeEntities"])(result.title) || Object(external_mt_i18n_["__"])('(no title)'),
...
function useBlockEditorSettings(settings, hasTemplate) {
  var _useSelect = Object(external_mt_data_["useSelect"])(function (select) {
    ...
    return {
      ...
      reusableBlocks: select('core').getEntityRecords('postType', 'mt_block',
      /**
       * Unbounded queries are not supported on native so as a workaround we set per_page with the maximum value.
       * Related issue: https://github.com/managertechnology-mobile/gutenberg-mobile/issues/2661
       */
      {
        per_page: external_mt_element_["Platform"].select({
          web: -1,
          native: 100
        })
      }),
  ...
  return Object(external_mt_element_["useMemo"])(function () {
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/provider/index.js
...
function EditorProvider(_ref) {
  var __unstableTemplate = _ref.__unstableTemplate,
      ...
      children = _ref.children;
  var defaultBlockContext = Object(external_mt_element_["useMemo"])(function () {
    if (post.type === 'mt_template') {
      return {};
    }
  ...
  var _useEntityBlockEditor = Object(external_mt_coreData_["useEntityBlockEditor"])('postType', type, {
    id: id
  }),
  ...
  Object(external_mt_element_["useLayoutEffect"])(function () {
    ...
    if (settings.autosave) {
      createWarningNotice(Object(external_mt_i18n_["__"])('There is an autosave of this post that is more recent than the version below.'), {
        id: 'autosave-exists',
        actions: [{
          label: Object(external_mt_i18n_["__"])('View the autosave'),
  ...
  return Object(external_mt_element_["createElement"])(external_mt_coreData_["EntityProvider"], {
    kind: "root",
    type: "site"
  }, Object(external_mt_element_["createElement"])(external_mt_coreData_["EntityProvider"], {
    kind: "postType",
    type: post.type,
    id: post.id
  }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockContextProvider"], {
    value: defaultBlockContext
  }, Object(external_mt_element_["createElement"])(external_mt_blockEditor_["BlockEditorProvider"], {
    value: blocks,
    onChange: onChange,
    onInput: onInput,
    selectionStart: selectionStart,
  ...
  }, children, Object(external_mt_element_["createElement"])(external_mt_reusableBlocks_["ReusableBlocksMenuItems"], null)))));
}

/* harmony default export */ var provider = (with_registry_provider(EditorProvider));

// EXTERNAL MODULE: external ["mt","serverSideRender"]
var external_mt_serverSideRender_ = __webpack_require__(80);
var external_mt_serverSideRender_default = /*#__PURE__*/__webpack_require__.n(external_mt_serverSideRender_);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/deprecated.js
...
function deprecateComponent(name, Wrapped) {
  ...
  var Component = Object(external_mt_element_["forwardRef"])(function (props, ref) {
    external_mt_deprecated_default()('mt.editor.' + name, {
      alternative: 'mt.blockEditor.' + name
    });
    return Object(external_mt_element_["createElement"])(Wrapped, Object(esm_extends["a" /* default */])({
      ref: ref
    }, props));
  });
...
var RichText = deprecateComponent('RichText', external_mt_blockEditor_["RichText"], ['Content']);
RichText.isEmpty = deprecateFunction('RichText.isEmpty', external_mt_blockEditor_["RichText"].isEmpty);

var Autocomplete = deprecateComponent('Autocomplete', external_mt_blockEditor_["Autocomplete"]);
var AlignmentToolbar = deprecateComponent('AlignmentToolbar', external_mt_blockEditor_["AlignmentToolbar"]);
var BlockAlignmentToolbar = deprecateComponent('BlockAlignmentToolbar', external_mt_blockEditor_["BlockAlignmentToolbar"]);
var BlockControls = deprecateComponent('BlockControls', external_mt_blockEditor_["BlockControls"], ['Slot']);
var deprecated_BlockEdit = deprecateComponent('BlockEdit', external_mt_blockEditor_["BlockEdit"]);
var BlockEditorKeyboardShortcuts = deprecateComponent('BlockEditorKeyboardShortcuts', external_mt_blockEditor_["BlockEditorKeyboardShortcuts"]);
var BlockFormatControls = deprecateComponent('BlockFormatControls', external_mt_blockEditor_["BlockFormatControls"], ['Slot']);
var BlockIcon = deprecateComponent('BlockIcon', external_mt_blockEditor_["BlockIcon"]);
var BlockInspector = deprecateComponent('BlockInspector', external_mt_blockEditor_["BlockInspector"]);
var BlockList = deprecateComponent('BlockList', external_mt_blockEditor_["BlockList"]);
var BlockMover = deprecateComponent('BlockMover', external_mt_blockEditor_["BlockMover"]);
var BlockNavigationDropdown = deprecateComponent('BlockNavigationDropdown', external_mt_blockEditor_["BlockNavigationDropdown"]);
var BlockSelectionClearer = deprecateComponent('BlockSelectionClearer', external_mt_blockEditor_["BlockSelectionClearer"]);
var BlockSettingsMenu = deprecateComponent('BlockSettingsMenu', external_mt_blockEditor_["BlockSettingsMenu"]);
var BlockTitle = deprecateComponent('BlockTitle', external_mt_blockEditor_["BlockTitle"]);
var BlockToolbar = deprecateComponent('BlockToolbar', external_mt_blockEditor_["BlockToolbar"]);
var ColorPalette = deprecateComponent('ColorPalette', external_mt_blockEditor_["ColorPalette"]);
var ContrastChecker = deprecateComponent('ContrastChecker', external_mt_blockEditor_["ContrastChecker"]);
var CopyHandler = deprecateComponent('CopyHandler', external_mt_blockEditor_["CopyHandler"]);
var DefaultBlockAppender = deprecateComponent('DefaultBlockAppender', external_mt_blockEditor_["DefaultBlockAppender"]);
var FontSizePicker = deprecateComponent('FontSizePicker', external_mt_blockEditor_["FontSizePicker"]);
var Inserter = deprecateComponent('Inserter', external_mt_blockEditor_["Inserter"]);
var InnerBlocks = deprecateComponent('InnerBlocks', external_mt_blockEditor_["InnerBlocks"], ['ButtonBlockAppender', 'DefaultBlockAppender', 'Content']);
var InspectorAdvancedControls = deprecateComponent('InspectorAdvancedControls', external_mt_blockEditor_["InspectorAdvancedControls"], ['Slot']);
var InspectorControls = deprecateComponent('InspectorControls', external_mt_blockEditor_["InspectorControls"], ['Slot']);
var PanelColorSettings = deprecateComponent('PanelColorSettings', external_mt_blockEditor_["PanelColorSettings"]);
var PlainText = deprecateComponent('PlainText', external_mt_blockEditor_["PlainText"]);
var RichTextShortcut = deprecateComponent('RichTextShortcut', external_mt_blockEditor_["RichTextShortcut"]);
var RichTextToolbarButton = deprecateComponent('RichTextToolbarButton', external_mt_blockEditor_["RichTextToolbarButton"]);
var __unstableRichTextInputEvent = deprecateComponent('__unstableRichTextInputEvent', external_mt_blockEditor_["__unstableRichTextInputEvent"]);
var MediaPlaceholder = deprecateComponent('MediaPlaceholder', external_mt_blockEditor_["MediaPlaceholder"]);
var MediaUpload = deprecateComponent('MediaUpload', external_mt_blockEditor_["MediaUpload"]);
var MediaUploadCheck = deprecateComponent('MediaUploadCheck', external_mt_blockEditor_["MediaUploadCheck"]);
var MultiSelectScrollIntoView = deprecateComponent('MultiSelectScrollIntoView', external_mt_blockEditor_["MultiSelectScrollIntoView"]);
var NavigableToolbar = deprecateComponent('NavigableToolbar', external_mt_blockEditor_["NavigableToolbar"]);
var ObserveTyping = deprecateComponent('ObserveTyping', external_mt_blockEditor_["ObserveTyping"]);
var PreserveScrollInReorder = deprecateComponent('PreserveScrollInReorder', external_mt_blockEditor_["PreserveScrollInReorder"]);
var SkipToSelectedBlock = deprecateComponent('SkipToSelectedBlock', external_mt_blockEditor_["SkipToSelectedBlock"]);
var URLInput = deprecateComponent('URLInput', external_mt_blockEditor_["URLInput"]);
var URLInputButton = deprecateComponent('URLInputButton', external_mt_blockEditor_["URLInputButton"]);
var URLPopover = deprecateComponent('URLPopover', external_mt_blockEditor_["URLPopover"]);
var Warning = deprecateComponent('Warning', external_mt_blockEditor_["Warning"]);
var WritingFlow = deprecateComponent('WritingFlow', external_mt_blockEditor_["WritingFlow"]);
var createCustomColorsHOC = deprecateFunction('createCustomColorsHOC', external_mt_blockEditor_["createCustomColorsHOC"]);
var getColorClassName = deprecateFunction('getColorClassName', external_mt_blockEditor_["getColorClassName"]);
var getColorObjectByAttributeValues = deprecateFunction('getColorObjectByAttributeValues', external_mt_blockEditor_["getColorObjectByAttributeValues"]);
var getColorObjectByColorValue = deprecateFunction('getColorObjectByColorValue', external_mt_blockEditor_["getColorObjectByColorValue"]);
var getFontSize = deprecateFunction('getFontSize', external_mt_blockEditor_["getFontSize"]);
var getFontSizeClass = deprecateFunction('getFontSizeClass', external_mt_blockEditor_["getFontSizeClass"]);
var withColorContext = deprecateFunction('withColorContext', external_mt_blockEditor_["withColorContext"]);
var withColors = deprecateFunction('withColors', external_mt_blockEditor_["withColors"]);
var withFontSizes = deprecateFunction('withFontSizes', external_mt_blockEditor_["withFontSizes"]);

// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/components/index.js
// Block Creation Components
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/utils/index.js
/**
 * Internal dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@managertechnology/editor/build-module/index.js
/**
 * paCMec dependencies
 */
...
(function() { module.exports = window["mt"]["apiFetch"]; }());
...
(function() { module.exports = window["mt"]["htmlEntities"]; }());
...
(function() { module.exports = window["mt"]["date"]; }());
...
(function() { module.exports = window["mt"]["serverSideRender"]; }());
