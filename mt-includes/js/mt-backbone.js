/**
 * @output mt-includes/js/mt-backbone.js
 */
...
(function ($) {
	/**
	 * Create the paCMec Backbone namespace.
	 *
	 * @namespace mt.Backbone
	 */
	mt.Backbone = {};
	 ...
	 *
	 * @since 3.5.0
	 * @since 3.6.0 Moved mt.media.Views to mt.Backbone.Subviews.
	 *
	 * @memberOf mt.Backbone
	 *
	 * @class
	 *
	 * @param {mt.Backbone.View} view  The main view.
	 * @param {Array|Object}     views The subviews for the main view.
	 */
	mt.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	mt.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( mt.Backbone.Subviews.prototype, {
		/**
		 ...
		 *
		 * @return {mt.Backbone.Subviews} The current Subviews instance.
		 */
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || mt.Backbone.Subviews,
	...
	mt.Backbone.View = Backbone.View.extend({

		// The constructor for the `Views` manager.
		Subviews: mt.Backbone.Subviews,
		 ...
		 *
		 * @since 3.5.0
		 * @since 3.6.0 Moved mt.media.View to mt.Backbone.View
		 *
		 * @constructs
		 ...
		 * @since 3.5.0
		 *
		 * @return {mt.Backbone.View} The current instance of the view.
		 */
		render: function() {
			var options;
