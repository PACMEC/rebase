/**
 * @output mt-includes/js/customize-preview-widgets.js
 */

/* global _mtWidgetCustomizerPreviewSettings */
 ...
 * @since 4.5.0
 *
 * @namespace mt.customize.widgetsPreview
 *
 * @param {jQuery} $   The jQuery object.
 * @param {Object} _   The utilities library.
 * @param {Object} mt  Current paCMec environment instance.
 * @param {Object} api Information from the API.
 *
 * @return {Object} Widget-related variables.
 */
mt.customize.widgetsPreview = mt.customize.WidgetCustomizerPreview = (function( $, _, mt, api ) {
	 ...
	 * @since 4.5.0
	 *
	 * @memberOf mt.customize.widgetsPreview
	 *
	 * @return {void}
	 */
	self.init = function() {
	...
	self.WidgetPartial = api.selectiveRefresh.Partial.extend(/** @lends mt.customize.widgetsPreview.WidgetPartial.prototype */{
		 ...
		 *
		 * @alias mt.customize.widgetsPreview.WidgetPartial
		 * @memberOf mt.customize.widgetsPreview
		 *
		 ...
		 *
		 * @inheritDoc
		 * @param {mt.customize.selectiveRefresh.Placement} placement The placement
		 *                                                            function.
		 *
		 * @return {void}
		 */
	...
	self.SidebarPartial = api.selectiveRefresh.Partial.extend(/** @lends mt.customize.widgetsPreview.SidebarPartial.prototype */{
		 ...
		 *
		 * @memberOf mt.customize.widgetsPreview
		 * @alias mt.customize.widgetsPreview.SidebarPartial
		 *
		 * @param {string} id             The partial's ID.
		 ...
		 * @since 4.5.0
		 *
		 * @return {Array.<mt.customize.selectiveRefresh.Placement>} List of placements
		 *                                                           that were reflowed.
		 */
		 ...
		 *
		 * @return {mt.customize.selectiveRefresh.Partial} The widget instance partial.
		 */
	...
	api.bind( 'preview-ready', function() {
		$.extend( self, _mtWidgetCustomizerPreviewSettings );
		self.init();
	});
