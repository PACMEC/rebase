/**
 * @output mt-includes/js/customize-base.js
 */
...
(function( exports, $ ){
	 ...
	 *
	 * @memberOf mt.customize
	 * @alias mt.customize.Value
	 *
	 * @constructor
	 */
	api.Value = api.Class.extend(/** @lends mt.customize.Value.prototype */{
		/**
	 ...
	 *
	 * @memberOf mt.customize
	 * @alias mt.customize.Values
	 *
	 * @constructor
	 * @augments mt.customize.Class
	 * @mixes mt.customize.Events
	 */
	api.Values = api.Class.extend(/** @lends mt.customize.Values.prototype */{
		 ...
		 *
		 * @param {string|mt.customize.Class} item - The item instance to add, or the ID for the instance to add. When an ID string is supplied, then itemObject must be provided.
		 * @param {mt.customize.Class}        [itemObject] - The item instance when the first argument is a ID string.
		 * @return {mt.customize.Class} The new item's instance, or an existing instance if already added.
		 */
	 ...
	 *
	 * @memberOf mt.customize
	 * @alias mt.customize.Element
	 *
	 * @constructor
	 * @augments mt.customize.Value
	 * @augments mt.customize.Class
	 */
	api.Element = api.Value.extend(/** @lends mt.customize.Element */{
	 ...
	 *
	 * @memberOf mt.customize
	 * @alias mt.customize.Messenger
	 *
	 * @constructor
	 * @augments mt.customize.Class
	 * @mixes mt.customize.Events
	 */
	api.Messenger = api.Class.extend(/** @lends mt.customize.Messenger.prototype */{
		/**
		 * Create a new Value.
		 *
	 ...
	 *
	 * @memberOf mt.customize
	 * @alias mt.customize.Notification
	 *
	 ...
	 */
	api.Notification = api.Class.extend(/** @lends mt.customize.Notification.prototype */{
		...
		render: function() {
			...
			if ( ! notification.template ) {
				notification.template = mt.template( notification.templateId );
			}
	 ...
	 * @access public
	 *
	 * @alias mt.customize.utils.parseQueryString
	 *
	...
	/**
	 * Expose the API publicly on window.mt.customize
	 *
	 * @namespace mt.customize
	 */
