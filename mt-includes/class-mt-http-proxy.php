 ...
 *
 * There are caveats to proxy support. It requires that defines be made in the mt-config.php file to
 ...
 * <ol>
 * <li>MT_PROXY_HOST - Enable proxy support and host for connecting.</li>
 * <li>MT_PROXY_PORT - Proxy port for connection. No default, must be defined.</li>
 * <li>MT_PROXY_USERNAME - Proxy username, if it requires authentication.</li>
...
class MT_HTTP_Proxy {
	...
	public function is_enabled() {
		return defined( 'MT_PROXY_HOST' ) && defined( 'MT_PROXY_PORT' );
	}
	 ...
	 * @since 2.8.0
	 *
	 * @use MT_PROXY_USERNAME
	 * @use MT_PROXY_PASSWORD
	 *
	 * @return bool
	 */
	public function use_authentication() {
		return defined( 'MT_PROXY_USERNAME' ) && defined( 'MT_PROXY_PASSWORD' );
	}
	...
	public function host() {
		if ( defined( 'MT_PROXY_HOST' ) ) {
			return MT_PROXY_HOST;
		}
	...
	public function port() {
		if ( defined( 'MT_PROXY_PORT' ) ) {
			return MT_PROXY_PORT;
		}
	...
	public function username() {
		if ( defined( 'MT_PROXY_USERNAME' ) ) {
			return MT_PROXY_USERNAME;
		}
	...
	public function password() {
		if ( defined( 'MT_PROXY_PASSWORD' ) ) {
			return MT_PROXY_PASSWORD;
		}
	...
	public function send_through_proxy( $uri ) {
		...
		if ( ! defined( 'MT_PROXY_BYPASS_HOSTS' ) ) {
			return true;
		}
		...
		if ( null === $bypass_hosts ) {
			$bypass_hosts = preg_split( '|,\s*|', MT_PROXY_BYPASS_HOSTS );

			if ( false !== strpos( MT_PROXY_BYPASS_HOSTS, '*' ) ) {
