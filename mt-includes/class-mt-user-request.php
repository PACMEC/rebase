<?php
/**
 * MT_User_Request class.
 *
 * Represents user request data loaded from a MT_Post object.
 *
 * @since 4.9.6
 */
final class MT_User_Request {
	/**
	 * Request ID.
	 *
	 * @since 4.9.6
	...
	public function __construct( $post ) {
		...
		$this->confirmed_timestamp = (int) get_post_meta( $post->ID, '_mt_user_request_confirmed_timestamp', true );
		$this->completed_timestamp = (int) get_post_meta( $post->ID, '_mt_user_request_completed_timestamp', true );
