<?php
/**
 * Dependencies API: MT_Dependencies base class
 *
 * @since 2.6.0
 *
 * @package paCMec
...
class MT_Dependencies {
	 ...
	 *
	 * @since 2.1.0
	 * @since 2.6.0 Moved from `MT_Scripts`.
	 * @since 2.8.0 Added the `$group` parameter.
	 *
	 ...
	 *                                 to the paCMec root directory. If source is set to false,
	 ...
	 *                                 equal to current installed paCMec version.
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		...
		$this->registered[ $handle ] = new _MT_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 * @since 4.0.0
	 *
	 * @param string[] $queue  An array of queued _MT_Dependency handles.
	 * @param string   $handle Name of the item. Should be unique.
	 ...
	 * @return bool|_MT_Dependency Found, or object Item data.
	 */
