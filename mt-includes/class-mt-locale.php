 ...
 *
 * @since 2.1.0
 * @since 4.6.0 Moved to its own file from mt-includes/locale.php.
 */
class MT_Locale {
	/**
	 ...
	 *
	 * @see MT_Locale::init() for how to handle the hack.
	 *
	 * @since 2.1.0
	 * @var array
	 */
	...
	public function init() {
		...
		if ( isset( $GLOBALS['text_direction'] ) ) {
			...
			/* translators: 'rtl' or 'ltr'. This sets the text direction for paCMec. */
	 ...
	 * on mt-admin/options-general.php to the general POT that would
