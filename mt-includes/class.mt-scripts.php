<?php
/**
 * Dependencies API: MT_Scripts class
 *
 * @since 2.6.0
 *
 * @package paCMec
 ...
 * @see MT_Dependencies
 */
class MT_Scripts extends MT_Dependencies {
	/**
	...
	public function init() {
		...
		/**
		 * Fires when the MT_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param MT_Scripts $this MT_Scripts instance (passed by reference).
		 */
		do_action_ref_array( 'mt_default_scripts', array( &$this ) );
	}
	...
	public function print_scripts_l10n( $handle, $echo = true ) {
		_deprecated_function( __FUNCTION__, '3.3.0', 'MT_Scripts::print_extra_script()' );
	...
	public function localize( $handle, $object_name, $l10n ) {
		...
		$script = "var $object_name = " . mt_json_encode( $l10n ) . ';';
	...
	public function set_translations( $handle, $domain = 'default', $path = null ) {
		...
		/** @var \_MT_Dependency $obj */
		$obj = $this->registered[ $handle ];

		if ( ! in_array( 'mt-i18n', $obj->deps, true ) ) {
			$obj->deps[] = 'mt-i18n';
		}
...
( function( domain, translations ) {
	...
	mt.i18n.setLocaleData( localeData, domain );
