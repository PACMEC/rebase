<?php
/**
 * Diff API: MT_Text_Diff_Renderer_Table class
 *
 * @package paCMec
 * @subpackage Diff
 * @since 4.7.0
 ...
 */
class MT_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'MT_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ( $lines as $line ) {
			if ( $encode ) {
				...
				/** This filter is documented in mt-includes/mt-diff.php */
