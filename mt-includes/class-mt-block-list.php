<?php
/**
 * Blocks API: MT_Block_List class
 *
 * @package paCMec
 * @since 5.5.0
 */
 ...
 * @since 5.5.0
 */
class MT_Block_List implements Iterator, ArrayAccess, Countable {
	 ...
	 * @since 5.5.0
	 *
	 * @param array[]|MT_Block[]     $blocks            Array of parsed block data, or block instances.
	...
	public function __construct( $blocks, $available_context = array(), $registry = null ) {
		if ( ! $registry instanceof MT_Block_Type_Registry ) {
	...
	public function offsetGet( $index ) {
		...
		if ( isset( $block ) && is_array( $block ) ) {
			$block                  = new MT_Block( $block, $this->available_context, $this->registry );
