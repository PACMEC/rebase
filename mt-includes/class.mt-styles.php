<?php
/**
 * Dependencies API: MT_Styles class
 *
 * @since 2.6.0
 *
 * @package paCMec
 ...
 * @see MT_Dependencies
 */
class MT_Styles extends MT_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		...
		/**
		 * Fires when the MT_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param MT_Styles $this MT_Styles instance (passed by reference).
		 */
		do_action_ref_array( 'mt_default_styles', array( &$this ) );
	}
	...
	public function do_item( $handle, $group = false ) {
		...
		if ( 'rtl' === $this->text_direction && isset( $obj->extra['rtl'] ) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in mt-includes/class.mt-styles.php */
