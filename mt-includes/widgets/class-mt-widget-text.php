<?php
/**
 * Widget API: MT_Widget_Text class
 *
 * @package paCMec
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MT_Widget
 */
class MT_Widget_Text extends MT_Widget {
	...
	public function _register_one( $number = -1 ) {
		...
		mt_add_inline_script( 'text-widgets', sprintf( 'mt.textWidgets.idBases.push( %s );', mt_json_encode( $this->id_base ) ) );
		...
		add_action( 'admin_footer-widgets.php', array( 'MT_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * and it applies after mtautop() to prevent corrupting HTML output added by the shortcode. When do_shortcode() is
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `MT_Widget_Custom_HTML` object in addition to a `MT_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param MT_Widget_Text|MT_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 *
			 * By default a subset of the_content filters are applied, including mtautop and mttexturize.
			 *
			 * @since 4.8.0
			 *
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param MT_Widget_Text $widget   Current Text widget instance.
			 */
			 ...
			 * in core by adding do_shortcode() to the 'widget_text_content' filter to apply after mtautop().
			 * Since the legacy Text widget runs mtautop() after 'widget_text' filters are applied, the widget in
		...
		$text = mt_targeted_link_rel( $text );
	 ...
	 * @since 4.9.0
	 *
	 * @see MT_Widget_Media_Video::inject_video_max_width_style()
	 *
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( current_user_can( 'unfiltered_html' ) ) {
			...
			$instance['text'] = mt_kses_post( $new_instance['text'] );
		}
	...
	public function enqueue_preview_scripts() {
		...
		mt_playlist_scripts( 'audio' );
		mt_playlist_scripts( 'video' );
	}
	...
	public function enqueue_admin_scripts() {
		mt_enqueue_editor();
		mt_enqueue_media();
		mt_enqueue_script( 'text-widgets' );
		mt_add_inline_script( 'text-widgets', 'mt.textWidgets.init();', 'after' );
	}
	 ...
	 *
	 * @see MT_Widget_Text::render_control_template_scripts()
	...
	public static function render_control_template_scripts() {
		...
		<script type="text/html" id="tmpl-widget-text-control-fields">
			...
			<?php if ( ! in_array( 'text_widget_custom_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="mt-pointer custom-html-widget-pointer mt-pointer-top">
					<div class="mt-pointer-content">
						...
						<?php endif; ?>
						<div class="mt-pointer-buttons">
							<a class="close" href="#"><?php _e( 'Dismiss' ); ?></a>
						</div>
					</div>
					<div class="mt-pointer-arrow">
						<div class="mt-pointer-arrow-inner"></div>
					</div>
				</div>
			<?php endif; ?>

			<?php if ( ! in_array( 'text_widget_paste_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="mt-pointer paste-html-pointer mt-pointer-top">
					<div class="mt-pointer-content">
			...
			<p>
				...
				<textarea id="{{ elementIdPrefix }}text" class="widefat text mt-editor-area" style="height: 200px" rows="16" cols="20"></textarea>
			</p>
		</script>
		<?php
	}
