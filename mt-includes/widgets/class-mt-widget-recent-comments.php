<?php
/**
 * Widget API: MT_Widget_Recent_Comments class
 *
 * @package paCMec
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MT_Widget
 */
class MT_Widget_Recent_Comments extends MT_Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( 'mt_head', array( $this, 'recent_comments_style' ) );
		}
	}
	...
	public function widget( $args, $instance ) {
		...
		$comments = get_comments(
			 ...
			 *
			 * @see MT_Comment_Query::query() for information on accepted arguments.
			 *
