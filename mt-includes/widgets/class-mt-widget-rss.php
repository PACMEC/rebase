<?php
/**
 * Widget API: MT_Widget_RSS class
 *
 * @package paCMec
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MT_Widget
 */
class MT_Widget_RSS extends MT_Widget {
	...
	public function widget( $args, $instance ) {
		...
		mt_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return mt_widget_rss_process( $new_instance, $testurl );
	}
