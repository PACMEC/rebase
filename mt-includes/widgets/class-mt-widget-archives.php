<?php
/**
 * Widget API: MT_Widget_Archives class
 *
 * @package paCMec
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MT_Widget
 */
class MT_Widget_Archives extends MT_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<select id="<?php echo esc_attr( $dropdown_id ); ?>" name="archive-dropdown">
			...
			<?php mt_get_archives( $dropdown_args ); ?>
...
/* ]]> */
	 ...
	 *                            MT_Widget_Archives::form().
	 * @param array $old_instance Old settings for this instance.
	 * @return array Updated settings to save.
	 */
	public function update( $new_instance, $old_instance ) {
		$instance             = $old_instance;
		$new_instance         = mt_parse_args(
			(array) $new_instance,
			array(
				'title'    => '',
				'count'    => 0,
