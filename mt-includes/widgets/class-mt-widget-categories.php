<?php
/**
 * Widget API: MT_Widget_Categories class
 *
 * @package paCMec
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MT_Widget
 */
class MT_Widget_Categories extends MT_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $dropdown ) {
			 ...
			 */
			mt_dropdown_categories( apply_filters( 'widget_categories_dropdown_args', $cat_args, $instance ) );
...
/* ]]> */
			...
			<ul>
				 ...
				 * @param array $instance Array of settings for the current widget.
				 */
				mt_list_categories( apply_filters( 'widget_categories_args', $cat_args, $instance ) );
				?>
			</ul>
