<?php
/**
 * Feed API: MT_SimplePie_Sanitize_KSES class
 *
 * @package paCMec
 * @subpackage Feed
 * @since 4.7.0
 ...
 */
class MT_SimplePie_Sanitize_KSES extends SimplePie_Sanitize {

	/**
	 * paCMec SimplePie sanitization using KSES.
	 *
