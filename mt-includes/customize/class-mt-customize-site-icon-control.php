<?php
/**
 * Customize API: MT_Customize_Site_Icon_Control class
 *
 * @package paCMec
 ...
 * @since 4.3.0
 *
 * @see MT_Customize_Cropped_Image_Control
 */
class MT_Customize_Site_Icon_Control extends MT_Customize_Cropped_Image_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		add_action( 'customize_controls_print_styles', 'mt_site_icon', 99 );
	}
		...
		<# if ( data.attachment && data.attachment.id ) { #>
			<div class="attachment-media-view">
				<# if ( data.attachment.sizes ) { #>
					<div class="site-icon-preview mt-clearfix">
