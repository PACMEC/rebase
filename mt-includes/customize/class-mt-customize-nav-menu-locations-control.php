<?php
/**
 * Customize API: MT_Customize_Nav_Menu_Locations_Control class
 *
 * @package paCMec
 ...
 */
class MT_Customize_Nav_Menu_Locations_Control extends MT_Customize_Control {
		...
		if ( current_theme_supports( 'menus' ) ) :
			...
			<ul class="menu-location-settings">
				<li class="customize-control assigned-menu-locations-title">
					<span class="customize-control-title">{{ mt.customize.Menus.data.l10n.locationsTitle }}</span>
					<# if ( data.isCreating ) { #>
						<p>
							...
							printf(
								...
								__( 'https://managertechnology.org/support/article/managertechnology-widgets/' ),
