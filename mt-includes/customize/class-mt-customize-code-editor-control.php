<?php
/**
 * Customize API: MT_Customize_Code_Editor_Control class
 *
 * @package paCMec
 ...
 */
class MT_Customize_Code_Editor_Control extends MT_Customize_Control {
	...
	public function enqueue() {
		$this->editor_settings = mt_enqueue_code_editor(
			array_merge(
				array(
					'type'       => $this->code_type,
					'codemirror' => array(
