<?php
/**
 * Customize API: MT_Customize_Header_Image_Control class
 *
 * @package paCMec
 ...
 */
class MT_Customize_Header_Image_Control extends MT_Customize_Image_Control {
	/**
	...
	public function enqueue() {
		mt_enqueue_media();
		mt_enqueue_script( 'customize-views' );
		...
		mt_localize_script(
			...
			array(
				...
				'nonces'   => array(
					'add'    => mt_create_nonce( 'header-add' ),
					'remove' => mt_create_nonce( 'header-remove' ),
				),
