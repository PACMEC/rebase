<?php
/**
 * Customize API: MT_Customize_Partial class
 *
 * @package paCMec
 ...
 * This class is analogous of MT_Customize_Control.
 *
 * @since 4.5.0
 */
class MT_Customize_Partial {
	 ...
	 * @since 4.5.0
	 *
	 * @see MT_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *               MT_Customize_Partial. The callback can either echo the
	 ...
	 * @since 4.5.0
	 *
	 * @param MT_Customize_Selective_Refresh $component Customize Partial Refresh plugin instance.
	 ...
	 *                                           Callback is called with one argument, the instance of MT_Customize_Partial.
	 ...
	 * }
	 */
	public function __construct( MT_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param MT_Customize_Partial $partial           MT_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking MT_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( MT_Customize_Partial $partial, $context = array() ) {
