<?php
/**
 * Customize API: MT_Customize_Date_Time_Control class
 *
 * @package paCMec
 ...
 */
class MT_Customize_Date_Time_Control extends MT_Customize_Control {
	...
	public function content_template() {
		...
		<# _.defaults( data, <?php echo mt_json_encode( $data ); ?> ); #>
	...
	public function get_month_choices() {
		...
		$months = array();
		for ( $i = 1; $i < 13; $i++ ) {
			$month_text = $mt_locale->get_month_abbrev( $mt_locale->get_month( $i ) );
