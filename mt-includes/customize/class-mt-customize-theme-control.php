<?php
/**
 * Customize API: MT_Customize_Theme_Control class
 *
 * @package paCMec
 ...
 */
class MT_Customize_Theme_Control extends MT_Customize_Control {
	...
	public function content_template() {
		...
		<# } #>
			...
			<# if ( 'installed' === data.theme.type && data.theme.hasUpdate ) { #>
				<# if ( data.theme.updateResponse.compatibleMT && data.theme.updateResponse.compatiblePHP ) { #>
					...
					<div class="update-message notice inline notice-error notice-alt" data-slug="{{ data.theme.id }}">
						<p>
							<# if ( ! data.theme.updateResponse.compatibleMT && ! data.theme.updateResponse.compatiblePHP ) { #>
								...
								?>
							<# } else if ( ! data.theme.updateResponse.compatibleMT ) { #>
								<?php
								printf(
									/* translators: %s: Theme name. */
			...
			<# if ( ! data.theme.compatibleMT || ! data.theme.compatiblePHP ) { #>
				<div class="notice notice-error notice-alt"><p>
					<# if ( ! data.theme.compatibleMT && ! data.theme.compatiblePHP ) { #>
						...
						?>
					<# } else if ( ! data.theme.compatibleMT ) { #>
						<?php
