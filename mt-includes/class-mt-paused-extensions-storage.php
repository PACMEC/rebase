<?php
/**
 * Error Protection API: MT_Paused_Extensions_Storage class
 *
 * @package paCMec
 * @since 5.2.0
 */
 ...
 * @since 5.2.0
 */
class MT_Paused_Extensions_Storage {
	...
	protected function get_option_name() {
		if ( ! mt_recovery_mode()->is_active() ) {
			return '';
		}

		$session_id = mt_recovery_mode()->get_session_id();
		if ( empty( $session_id ) ) {
			return '';
		}
