<?php
/**
 * Blocks API: MT_Block_Patterns_Registry class
 *
 * @package paCMec
 * @subpackage Blocks
 * @since 5.5.0
 ...
 * @since 5.5.0
 */
final class MT_Block_Patterns_Registry {
	/**
	 ...
	 *
	 * @since 5.5.0
	 * @var MT_Block_Patterns_Registry|null
	 */
	 ...
	 *                                   content, description, viemtortWidth, categories, keywords.
	 ...
	 * @since 5.5.0
	 *
	 * @return MT_Block_Patterns_Registry The main instance.
	 */
...
function register_block_pattern( $pattern_name, $pattern_properties ) {
	return MT_Block_Patterns_Registry::get_instance()->register( $pattern_name, $pattern_properties );
}
...
function unregister_block_pattern( $pattern_name ) {
	return MT_Block_Patterns_Registry::get_instance()->unregister( $pattern_name );
}
