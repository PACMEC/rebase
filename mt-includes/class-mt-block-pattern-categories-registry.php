<?php
/**
 * Blocks API: MT_Block_Pattern_Categories_Registry class
 *
 * @package paCMec
 * @subpackage Blocks
 * @since 5.5.0
 ...
 */
final class MT_Block_Pattern_Categories_Registry {
	/**
	 ...
	 *
	 * @since 5.5.0
	 * @var MT_Block_Pattern_Categories_Registry|null
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return MT_Block_Pattern_Categories_Registry The main instance.
	 */
...
function register_block_pattern_category( $category_name, $category_properties ) {
	return MT_Block_Pattern_Categories_Registry::get_instance()->register( $category_name, $category_properties );
}
...
function unregister_block_pattern_category( $category_name ) {
	return MT_Block_Pattern_Categories_Registry::get_instance()->unregister( $category_name );
}
