 ...
 * @since 3.9.0
 */
function mt_underscore_audio_template() {
	$audio_types = mt_get_audio_extensions();
	?>
...
>
	...
	<source src="{{ data.model.src }}" type="{{ mt.media.view.settings.embedMimes[ data.model.src.split('.').pop() ] }}" />
	<# } #>
	...
	<source src="{{ data.model.<?php echo $type; ?> }}" type="{{ mt.media.view.settings.embedMimes[ '<?php echo $type; ?>' ] }}" />
	<# } #>
		<?php
	endforeach;
	?>
 ...
 * @since 3.9.0
 */
function mt_underscore_video_template() {
	$video_types = mt_get_video_extensions();
	?>
<#  var w_rule = '', classes = [],
		w, h, settings = mt.media.view.settings,
...
#>
<div style="{{ w_rule }}" class="mt-video">
<video controls
	class="mt-video-shortcode {{ classes.join( ' ' ) }}"
	<# if ( w ) { #>width="{{ w }}"<# } #>
	<# if ( h ) { #>height="{{ h }}"<# } #>
	<?php
	$props = array(
 ...
 * @since 3.5.0
 */
function mt_print_media_templates() {
	$class = 'media-modal mt-core-ui';
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php elseif ( is_multisite() && ! is_upload_space_available() ) : ?>
			<div class="upload-ui">
				...
				<?php
				/** This action is documented in mt-admin/includes/media.php */
	...
	<script type="text/html" id="tmpl-attachment-details-two-column">
		<div class="attachment-media-view {{ data.orientation }}">
			...
			<div class="thumbnail thumbnail-{{ data.type }}">
				...
				<# if ( 'audio' === data.type ) { #>
				<div class="mt-media-wrapper mt-audio">
					<audio style="visibility: hidden" controls class="mt-audio-shortcode" width="100%" preload="none">
				...
				<# } else if ( 'video' === data.type ) {
					...
					} else if ( mt.media.view.settings.contentWidth ) {
						w_rule = 'width: ' + mt.media.view.settings.contentWidth + 'px;';
					}
				#>
				<div style="{{ w_rule }}" class="mt-media-wrapper mt-video">
					<video controls="controls" class="mt-video-shortcode" preload="metadata"
	...
	<script type="text/html" id="tmpl-gallery-settings">
		...
		<span class="setting">
			...
			<select id="gallery-settings-link-to" class="link-to"
				...
				<option value="post" <# if ( ! mt.media.galleryDefaults.link || 'post' === mt.media.galleryDefaults.link ) {
					#>selected="selected"<# }
				#>>
					<?php esc_html_e( 'Attachment Page' ); ?>
				</option>
				<option value="file" <# if ( 'file' === mt.media.galleryDefaults.link ) { #>selected="selected"<# } #>>
					<?php esc_html_e( 'Media File' ); ?>
				</option>
				<option value="none" <# if ( 'none' === mt.media.galleryDefaults.link ) { #>selected="selected"<# } #>>
					<?php esc_html_e( 'None' ); ?>
				</option>
			</select>
		</span>
			...
			<select id="gallery-settings-columns" class="columns" name="columns"
				...
				<?php for ( $i = 1; $i <= 9; $i++ ) : ?>
					<option value="<?php echo esc_attr( $i ); ?>" <#
						if ( <?php echo $i; ?> == mt.media.galleryDefaults.columns ) { #>selected="selected"<# }
					#>>
						<?php echo esc_html( $i ); ?>
					</option>
				<?php endfor; ?>
			...
			<div class="embed-media-settings">
				<div class="column-settings">
					...
					<# if ( data.attachment ) { #>
						...
						<# } #>
							<div class="custom-size mt-clearfix<# if ( data.model.size !== 'custom' ) { #> hidden<# } #>">
	...
	<script type="text/html" id="tmpl-audio-details">
		<# var ext, html5types = {
			mp3: mt.media.view.settings.embedMimes.mp3,
			ogg: mt.media.view.settings.embedMimes.ogg
		}; #>

		<?php $audio_types = mt_get_audio_extensions(); ?>
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-audio-settings">
				<?php mt_underscore_audio_template(); ?>
	...
	<script type="text/html" id="tmpl-video-details">
		<# var ext, html5types = {
			mp4: mt.media.view.settings.embedMimes.mp4,
			ogv: mt.media.view.settings.embedMimes.ogv,
			webm: mt.media.view.settings.embedMimes.webm
		}; #>

		<?php $video_types = mt_get_video_extensions(); ?>
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-video-settings">
				<div class="mt-video-holder">
				<#
				...
				<?php mt_underscore_video_template(); ?>
				...
				<# _.each( data.attachments, function( attachment, index ) { #>
					<dl class="gallery-item">
						...
						<# if ( attachment.caption ) { #>
							<dd class="mt-caption-text gallery-caption">
