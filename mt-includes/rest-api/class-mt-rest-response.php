<?php
/**
 * REST API: MT_REST_Response class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class MT_REST_Response extends MT_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = mt_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a MT_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return MT_Error|null MT_Error or null on not an errored response.
	 */
