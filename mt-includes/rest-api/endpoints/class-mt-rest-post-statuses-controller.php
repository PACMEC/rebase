<?php
/**
 * REST API: MT_REST_Post_Statuses_Controller class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class MT_REST_Post_Statuses_Controller extends MT_REST_Controller {
	 ...
	 * @param MT_REST_Request $request Full details about the request.
	 * @return MT_REST_Response Post status data.
	 */
	public function prepare_item_for_response( $status, $request ) {
		...
		if ( 'publish' === $status->name ) {
			$response->add_link( 'archives', rest_url( 'mt/v2/posts' ) );
		} else {
			$response->add_link( 'archives', add_query_arg( 'status', $status->name, rest_url( 'mt/v2/posts' ) ) );
		}
