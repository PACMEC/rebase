<?php
/**
 * REST API: MT_REST_Settings_Controller class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class MT_REST_Settings_Controller extends MT_REST_Controller {
	 ...
	 *
	 * @param MT_REST_Request $request Full details about the request.
	 * @return array|MT_Error Array on success, or MT_Error object on failure.
	 */
	 ...
	 *
	 * @param MT_REST_Request $request Full details about the request.
	 * @return array|MT_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is_mt_error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
					return new MT_Error(
