<?php
/**
 * REST API: MT_REST_Post_Types_Controller class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class MT_REST_Post_Types_Controller extends MT_REST_Controller {
	...
	public function prepare_item_for_response( $post_type, $request ) {
		$taxonomies = mt_list_filter( get_object_taxonomies( $post_type->name, 'objects' ), array( 'show_in_rest' => true ) );
		$taxonomies = mt_list_pluck( $taxonomies, 'name' );
		 ...
		 * @param MT_Post_Type     $post_type The original post type object.
