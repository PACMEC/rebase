<?php
/**
 * Reusable blocks REST API: MT_REST_Blocks_Controller class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 5.0.0
 ...
 * edit and delete reusable blocks. Blocks are stored as posts with the mt_block
 * post type.
 *
 * @since 5.0.0
 *
 ...
 */
class MT_REST_Blocks_Controller extends MT_REST_Posts_Controller {
	 ...
	 * @since 5.0.0
	 *
	 * @param MT_Post $post Post object that backs the block.
