<?php
/**
 * REST API: MT_REST_Taxonomies_Controller class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class MT_REST_Taxonomies_Controller extends MT_REST_Controller {
	 ...
	 *
	 * @param MT_REST_Request $request Full details about the request.
	 * @return MT_REST_Response Response object on success, or MT_Error object on failure.
	 */
	 ...
	 * @since 4.7.0
	 *
	 * @param MT_Taxonomy     $taxonomy Taxonomy data.
	 * @param MT_REST_Request $request  Full details about the request.
	...
	public function prepare_item_for_response( $taxonomy, $request ) {
		...
		$response->add_links(
			array(
				...
				'https://api.w.org/items' => array(
					'href' => rest_url( sprintf( 'mt/v2/%s', $base ) ),
				),
			)
		);
		 ...
		 * @param MT_Taxonomy      $item     The original taxonomy object.
