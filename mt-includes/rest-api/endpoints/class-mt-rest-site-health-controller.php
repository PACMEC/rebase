<?php
/**
 * REST API: MT_REST_Site_Health_Controller class
 *
 * @package paCMec
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class MT_REST_Site_Health_Controller extends MT_REST_Controller {
	 ...
	 * @since 5.6.0
	 *
	 * @param MT_Site_Health $site_health An instance of the site health class.
	 */
	public function __construct( $site_health ) {
		$this->namespace = 'mt-site-health/v1';
	...
	/**
	 * Checks that the site can reach the paCMec.org API.
	 *
	 * @since 5.6.0
	 *
	 * @return array
	...
	public function get_directory_sizes() {
		...
		if ( isset( $all_sizes['total_size']['debug'] ) && 'not available' === $all_sizes['total_size']['debug'] ) {
			return new MT_Error( 'not_available', __( 'Directory sizes could not be returned.' ), array( 'status' => 500 ) );
		}
	 ...
	 *
	 * The {@see MT_Site_Health} class is defined in MT-Admin, while the REST API operates in a front-end context.
