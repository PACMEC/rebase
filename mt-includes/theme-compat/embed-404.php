...
?>
<div class="mt-embed">
	<p class="mt-embed-heading"><?php _e( 'Oops! That embed can&#8217;t be found.' ); ?></p>

	<div class="mt-embed-excerpt">
		<p>
			<?php
			printf(
	...
	<?php
	/** This filter is documented in mt-includes/theme-compat/embed-content.php */
