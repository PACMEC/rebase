...
class MT_Block_Supports {
	 ...
	 * @since 5.6.0
	 *
	 * @return MT_Block_Supports The main instance.
	 */
	...
	public function apply_block_supports() {
		...
		$block_type       = MT_Block_Type_Registry::get_instance()->get_registered(
...
function get_block_wrapper_attributes( $extra_attributes = array() ) {
	$new_attributes = MT_Block_Supports::get_instance()->apply_block_supports();
