 ...
 * @see ArrayAccess
 */
final class MT_Hook implements Iterator, ArrayAccess {
	...
	public function add_filter( $tag, $function_to_add, $priority, $accepted_args ) {
		$idx = _mt_filter_build_unique_id( $tag, $function_to_add, $priority );
	...
	public function remove_filter( $tag, $function_to_remove, $priority ) {
		$function_key = _mt_filter_build_unique_id( $tag, $function_to_remove, $priority );
	...
	public function has_filter( $tag = '', $function_to_check = false ) {
		...
		$function_key = _mt_filter_build_unique_id( $tag, $function_to_check, false );
		if ( ! $function_key ) {
			return false;
		}
	...
	/**
	 * Normalizes filters set up before paCMec has initialized to MT_Hook objects.
	 *
	 ...
	 * @return MT_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var MT_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $tag => $callback_groups ) {
			if ( is_object( $callback_groups ) && $callback_groups instanceof MT_Hook ) {
