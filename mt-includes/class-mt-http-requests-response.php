<?php
/**
 * HTTP API: MT_HTTP_Requests_Response class
 *
 * @package paCMec
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see MT_HTTP_Response
 */
class MT_HTTP_Requests_Response extends MT_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return MT_HTTP_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new MT_Http_Cookie(
				array(
					'name'      => $cookie->name,
	...
	/**
	 * Converts the object to a MT_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array MT_Http response array, per MT_Http::request().
	 */
