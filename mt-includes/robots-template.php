 ...
 * {@see 'mt_robots'} filter. The directives are then sanitized, and the
...
function mt_robots() {
	 ...
	 */
	$robots = apply_filters( 'mt_robots', array() );
 ...
 * {@see 'mt_robots'} filter.
 *
 * Typical usage is as a {@see 'mt_robots'} callback:
 *
 *     add_filter( 'mt_robots', 'mt_robots_noindex' );
 *
 * @since 5.7.0
 *
 * @see mt_robots_no_robots()
 *
 * @param array $robots Associative array of robots directives.
 * @return array Filtered robots directives.
 */
function mt_robots_noindex( array $robots ) {
	if ( ! get_option( 'blog_public' ) ) {
		return mt_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function mt_robots_noindex_embeds( array $robots ) {
	if ( is_embed() ) {
		return mt_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function mt_robots_noindex_search( array $robots ) {
	if ( is_search() ) {
		return mt_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function mt_robots_no_robots( array $robots ) {
	$robots['noindex'] = true;
 ...
 * @return array Filtered robots directives.
 */
function mt_robots_sensitive_page( array $robots ) {
	$robots['noindex']   = true;
 ...
 * @return array Filtered robots directives.
 */
function mt_robots_max_image_preview_large( array $robots ) {
	if ( get_option( 'blog_public' ) ) {
