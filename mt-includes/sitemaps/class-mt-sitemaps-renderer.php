<?php
/**
 * Sitemaps: MT_Sitemaps_Renderer class
 *
...
class MT_Sitemaps_Renderer {
	...
	/**
	 * MT_Sitemaps_Renderer constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_sitemap_stylesheet_url() {
		...
		$sitemap_url = home_url( '/mt-sitemap.xsl' );
		 ...
		 */
		return apply_filters( 'mt_sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		...
		$sitemap_url = home_url( '/mt-sitemap-index.xsl' );
		 ...
		 */
		return apply_filters( 'mt_sitemaps_stylesheet_index_url', $sitemap_url );
	}
	...
	public function render_index( $sitemaps ) {
		...
		if ( ! empty( $index_xml ) ) {
			...
			// phpcs:ignore paCMec.Security.EscapeOutput.OutputNotEscaped
			echo $index_xml;
		}
	}
	...
	private function check_for_simple_xml_availability() {
		if ( ! class_exists( 'SimpleXMLElement' ) ) {
			...
			mt_die(
				...
				esc_xml( __( 'paCMec &rsaquo; Error' ) ),
				array(
