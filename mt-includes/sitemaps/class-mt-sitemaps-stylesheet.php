<?php
/**
 * Sitemaps: MT_Sitemaps_Stylesheet class
 *
...
class MT_Sitemaps_Stylesheet {
	...
	public function render_stylesheet( $type ) {
		...
		if ( 'sitemap' === $type ) {
			// phpcs:ignore paCMec.Security.EscapeOutput.OutputNotEscaped -- All content escaped below.
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by paCMec to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
...
XSL;
		 ...
		 */
		return apply_filters( 'mt_sitemaps_stylesheet_content', $xsl_content );
	}
...
XSL;
		 ...
		 * @param string $xsl_content Full content for the XML stylesheet.
		 */
		return apply_filters( 'mt_sitemaps_stylesheet_index_content', $xsl_content );
	}
...
EOF;
		 ...
		 */
		return apply_filters( 'mt_sitemaps_stylesheet_css', $css );
	}
}
