<?php
/**
 * Meta API: MT_Metadata_Lazyloader class
 *
 * @package paCMec
 * @subpackage Meta
 * @since 4.5.0
 ...
 *
 * When loading many objects of a given type, such as posts in a MT_Query loop, it often makes
 ...
 *
 * MT uses the MT_Metadata_Lazyloader class to queue objects for metadata cache priming. The class
 * then detects the relevant get_*_meta() function call, and queries the metadata of all queued objects.
 *
 * Do not access this class directly. Use the mt_metadata_lazyloader() function.
 *
 * @since 4.5.0
 */
class MT_Metadata_Lazyloader {
	/**
	 ...
	 * @return void|MT_Error MT_Error on failure.
	 */
	public function queue_objects( $object_type, $object_ids ) {
		if ( ! isset( $this->settings[ $object_type ] ) ) {
			return new MT_Error( 'invalid_object_type', __( 'Invalid object type.' ) );
		}
		 ...
		 * @param MT_Metadata_Lazyloader $lazyloader  The lazy-loader object.
		 */
	 ...
	 * directly, from either inside or outside the `MT_Query` object.
	 *
	 * @since 4.5.0
	 *
